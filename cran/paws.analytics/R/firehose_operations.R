...
#' Creates a Kinesis Data Firehose delivery stream.
#'
#' See [https://paws-r-sdk.com/docs/create_delivery_stream/](https://paws-r-sdk.com/docs/create_delivery_stream/) for full documentation.
#'
...
#' Deletes a delivery stream and its data.
#'
#' See [https://paws-r-sdk.com/docs/delete_delivery_stream/](https://paws-r-sdk.com/docs/delete_delivery_stream/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_delivery_stream/](https://paws-r-sdk.com/docs/describe_delivery_stream/) for full documentation.
#'
#' @param DeliveryStreamName &#91;required&#93; The name of the delivery stream.
...
#' Lists your delivery streams in alphabetical order of their names.
#'
#' See [https://paws-r-sdk.com/docs/list_delivery_streams/](https://paws-r-sdk.com/docs/list_delivery_streams/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_tags_for_delivery_stream/](https://paws-r-sdk.com/docs/list_tags_for_delivery_stream/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_record_batch/](https://paws-r-sdk.com/docs/put_record_batch/) for full documentation.
#'
#' @param DeliveryStreamName &#91;required&#93; The name of the delivery stream.
...
#' Enables server-side encryption (SSE) for the delivery stream.
#'
#' See [https://paws-r-sdk.com/docs/start_delivery_stream_encryption/](https://paws-r-sdk.com/docs/start_delivery_stream_encryption/) for full documentation.
#'
...
#' Disables server-side encryption (SSE) for the delivery stream.
#'
#' See [https://paws-r-sdk.com/docs/stop_delivery_stream_encryption/](https://paws-r-sdk.com/docs/stop_delivery_stream_encryption/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/tag_delivery_stream/](https://paws-r-sdk.com/docs/tag_delivery_stream/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/untag_delivery_stream/](https://paws-r-sdk.com/docs/untag_delivery_stream/) for full documentation.
#'
#' @param DeliveryStreamName &#91;required&#93; The name of the delivery stream.
...
#' Updates the specified destination of the specified delivery stream.
#'
#' See [https://paws-r-sdk.com/docs/update_destination/](https://paws-r-sdk.com/docs/update_destination/) for full documentation.
#'
#' @param DeliveryStreamName &#91;required&#93; The name of the delivery stream.
