...
#'
#' See [https://paws-r-sdk.com/docs/associate_member/](https://paws-r-sdk.com/docs/associate_member/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_account_status/](https://paws-r-sdk.com/docs/batch_get_account_status/) for full documentation.
#'
...
#' Gets free trial status for multiple Amazon Web Services accounts.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_free_trial_info/](https://paws-r-sdk.com/docs/batch_get_free_trial_info/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_member_ec_2_deep_inspection_status/](https://paws-r-sdk.com/docs/batch_get_member_ec_2_deep_inspection_status/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_update_member_ec_2_deep_inspection_status/](https://paws-r-sdk.com/docs/batch_update_member_ec_2_deep_inspection_status/) for full documentation.
#'
...
#' Cancels the given findings report.
#'
#' See [https://paws-r-sdk.com/docs/cancel_findings_report/](https://paws-r-sdk.com/docs/cancel_findings_report/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_findings_report/](https://paws-r-sdk.com/docs/create_findings_report/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disable/](https://paws-r-sdk.com/docs/disable/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disable_delegated_admin_account/](https://paws-r-sdk.com/docs/disable_delegated_admin_account/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/enable/](https://paws-r-sdk.com/docs/enable/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/enable_delegated_admin_account/](https://paws-r-sdk.com/docs/enable_delegated_admin_account/) for full documentation.
#'
#' @param clientToken The idempotency token for the request.
...
#' Retrieves setting configurations for Inspector scans.
#'
#' See [https://paws-r-sdk.com/docs/get_configuration/](https://paws-r-sdk.com/docs/get_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_delegated_admin_account/](https://paws-r-sdk.com/docs/get_delegated_admin_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_ec_2_deep_inspection_configuration/](https://paws-r-sdk.com/docs/get_ec_2_deep_inspection_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#' Gets the status of a findings report.
#'
#' See [https://paws-r-sdk.com/docs/get_findings_report_status/](https://paws-r-sdk.com/docs/get_findings_report_status/) for full documentation.
#'
...
#' Lists the permissions an account has to configure Amazon Inspector.
#'
#' See [https://paws-r-sdk.com/docs/list_account_permissions/](https://paws-r-sdk.com/docs/list_account_permissions/) for full documentation.
#'
...
#' Lists Amazon Inspector coverage statistics for your environment.
#'
#' See [https://paws-r-sdk.com/docs/list_coverage_statistics/](https://paws-r-sdk.com/docs/list_coverage_statistics/) for full documentation.
#'
#' @param filterCriteria An object that contains details on the filters to apply to the coverage
#' data for your environment.
...
#'
#' See [https://paws-r-sdk.com/docs/list_delegated_admin_accounts/](https://paws-r-sdk.com/docs/list_delegated_admin_accounts/) for full documentation.
#'
#' @param maxResults The maximum number of results to return in the response.
#' @param nextToken A token to use for paginating results that are returned in the response.
#' Set the value of this parameter to null for the first request to a list
...
#'
#' See [https://paws-r-sdk.com/docs/list_finding_aggregations/](https://paws-r-sdk.com/docs/list_finding_aggregations/) for full documentation.
#'
...
#' Lists the Amazon Inspector usage totals over the last 30 days.
#'
#' See [https://paws-r-sdk.com/docs/list_usage_totals/](https://paws-r-sdk.com/docs/list_usage_totals/) for full documentation.
#'
...
#' Lists Amazon Inspector coverage details for a specific vulnerability.
#'
#' See [https://paws-r-sdk.com/docs/search_vulnerabilities/](https://paws-r-sdk.com/docs/search_vulnerabilities/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_ec_2_deep_inspection_configuration/](https://paws-r-sdk.com/docs/update_ec_2_deep_inspection_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_org_ec_2_deep_inspection_configuration/](https://paws-r-sdk.com/docs/update_org_ec_2_deep_inspection_configuration/) for full documentation.
#'
