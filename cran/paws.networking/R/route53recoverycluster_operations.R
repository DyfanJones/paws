...
#'
#' See [https://paws-r-sdk.com/docs/get_routing_control_state/](https://paws-r-sdk.com/docs/get_routing_control_state/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_routing_control_state/](https://paws-r-sdk.com/docs/update_routing_control_state/) for full documentation.
#'
#' @param RoutingControlArn &#91;required&#93; The Amazon Resource Name (ARN) for the routing control that you want to
...
#'
#' See [https://paws-r-sdk.com/docs/update_routing_control_states/](https://paws-r-sdk.com/docs/update_routing_control_states/) for full documentation.
#'
