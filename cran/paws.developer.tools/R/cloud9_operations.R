...
#'
#' See [https://paws-r-sdk.com/docs/create_environment_ec2/](https://paws-r-sdk.com/docs/create_environment_ec2/) for full documentation.
#'
...
#' Adds an environment member to an Cloud9 development environment.
#'
#' See [https://paws-r-sdk.com/docs/create_environment_membership/](https://paws-r-sdk.com/docs/create_environment_membership/) for full documentation.
#'
...
#' Deletes an environment member from a development environment.
#'
#' See [https://paws-r-sdk.com/docs/delete_environment_membership/](https://paws-r-sdk.com/docs/delete_environment_membership/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_environment_memberships/](https://paws-r-sdk.com/docs/describe_environment_memberships/) for full documentation.
#'
...
#' Gets status information for an Cloud9 development environment.
#'
#' See [https://paws-r-sdk.com/docs/describe_environment_status/](https://paws-r-sdk.com/docs/describe_environment_status/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_environment_membership/](https://paws-r-sdk.com/docs/update_environment_membership/) for full documentation.
#'
