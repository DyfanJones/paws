...
#' 
#' To get started, create a load balancer with one or more listeners using [`create_load_balancer`][elb_create_load_balancer]. Register your instances with the load balancer using [`register_instances_with_load_balancer`][elb_register_instances_with_load_balancer].
#' 
