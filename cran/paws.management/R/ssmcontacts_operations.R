...
#'
#' See [https://paws-r-sdk.com/docs/accept_page/](https://paws-r-sdk.com/docs/accept_page/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/activate_contact_channel/](https://paws-r-sdk.com/docs/activate_contact_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_contact_channel/](https://paws-r-sdk.com/docs/create_contact_channel/) for full documentation.
#'
...
#' Creates a rotation in an on-call schedule.
#'
#' See [https://paws-r-sdk.com/docs/create_rotation/](https://paws-r-sdk.com/docs/create_rotation/) for full documentation.
#'
...
#' Creates an override for a rotation in an on-call schedule.
#'
#' See [https://paws-r-sdk.com/docs/create_rotation_override/](https://paws-r-sdk.com/docs/create_rotation_override/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/deactivate_contact_channel/](https://paws-r-sdk.com/docs/deactivate_contact_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_contact_channel/](https://paws-r-sdk.com/docs/delete_contact_channel/) for full documentation.
#'
#' @param ContactChannelId &#91;required&#93; The Amazon Resource Name (ARN) of the contact channel.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/delete_rotation/](https://paws-r-sdk.com/docs/delete_rotation/) for full documentation.
#'
...
#' Deletes an existing override for an on-call rotation.
#'
#' See [https://paws-r-sdk.com/docs/delete_rotation_override/](https://paws-r-sdk.com/docs/delete_rotation_override/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_engagement/](https://paws-r-sdk.com/docs/describe_engagement/) for full documentation.
#'
...
#' Lists details of the engagement to a contact channel.
#'
#' See [https://paws-r-sdk.com/docs/describe_page/](https://paws-r-sdk.com/docs/describe_page/) for full documentation.
#'
...
#' List details about a specific contact channel.
#'
#' See [https://paws-r-sdk.com/docs/get_contact_channel/](https://paws-r-sdk.com/docs/get_contact_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_contact_policy/](https://paws-r-sdk.com/docs/get_contact_policy/) for full documentation.
#'
...
#' Retrieves information about an on-call rotation.
#'
#' See [https://paws-r-sdk.com/docs/get_rotation/](https://paws-r-sdk.com/docs/get_rotation/) for full documentation.
#'
...
#' Retrieves information about an override to an on-call rotation.
#'
#' See [https://paws-r-sdk.com/docs/get_rotation_override/](https://paws-r-sdk.com/docs/get_rotation_override/) for full documentation.
#'
...
#' Lists all contact channels for the specified contact.
#'
#' See [https://paws-r-sdk.com/docs/list_contact_channels/](https://paws-r-sdk.com/docs/list_contact_channels/) for full documentation.
#'
...
#' Lists all engagements that have happened in an incident.
#'
#' See [https://paws-r-sdk.com/docs/list_engagements/](https://paws-r-sdk.com/docs/list_engagements/) for full documentation.
#'
#' @param NextToken The pagination token to continue to the next page of results.
...
#'
#' See [https://paws-r-sdk.com/docs/list_page_receipts/](https://paws-r-sdk.com/docs/list_page_receipts/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_page_resolutions/](https://paws-r-sdk.com/docs/list_page_resolutions/) for full documentation.
#'
...
#' Lists the engagements to a contact's contact channels.
#'
#' See [https://paws-r-sdk.com/docs/list_pages_by_contact/](https://paws-r-sdk.com/docs/list_pages_by_contact/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_pages_by_engagement/](https://paws-r-sdk.com/docs/list_pages_by_engagement/) for full documentation.
#'
...
#' Returns a list of shifts based on rotation configuration parameters.
#'
#' See [https://paws-r-sdk.com/docs/list_preview_rotation_shifts/](https://paws-r-sdk.com/docs/list_preview_rotation_shifts/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_rotation_overrides/](https://paws-r-sdk.com/docs/list_rotation_overrides/) for full documentation.
#'
...
#' Returns a list of shifts generated by an existing rotation in the system.
#'
#' See [https://paws-r-sdk.com/docs/list_rotation_shifts/](https://paws-r-sdk.com/docs/list_rotation_shifts/) for full documentation.
#'
...
#' Retrieves a list of on-call rotations.
#'
#' See [https://paws-r-sdk.com/docs/list_rotations/](https://paws-r-sdk.com/docs/list_rotations/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_contact_policy/](https://paws-r-sdk.com/docs/put_contact_policy/) for full documentation.
#'
#' @param ContactArn &#91;required&#93; The Amazon Resource Name (ARN) of the contact or escalation plan.
...
#'
#' See [https://paws-r-sdk.com/docs/send_activation_code/](https://paws-r-sdk.com/docs/send_activation_code/) for full documentation.
#'
#' @param ContactChannelId &#91;required&#93; The Amazon Resource Name (ARN) of the contact channel.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/start_engagement/](https://paws-r-sdk.com/docs/start_engagement/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/stop_engagement/](https://paws-r-sdk.com/docs/stop_engagement/) for full documentation.
#'
#' @param EngagementId &#91;required&#93; The Amazon Resource Name (ARN) of the engagement.
...
#' Updates a contact's contact channel.
#'
#' See [https://paws-r-sdk.com/docs/update_contact_channel/](https://paws-r-sdk.com/docs/update_contact_channel/) for full documentation.
#'
...
#' Updates the information specified for an on-call rotation.
#'
#' See [https://paws-r-sdk.com/docs/update_rotation/](https://paws-r-sdk.com/docs/update_rotation/) for full documentation.
#'
