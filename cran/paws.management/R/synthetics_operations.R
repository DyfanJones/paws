...
#'
#' See [https://paws-r-sdk.com/docs/create_canary/](https://paws-r-sdk.com/docs/create_canary/) for full documentation.
#'
...
#' Permanently deletes the specified canary.
#'
#' See [https://paws-r-sdk.com/docs/delete_canary/](https://paws-r-sdk.com/docs/delete_canary/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_canaries/](https://paws-r-sdk.com/docs/describe_canaries/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_canaries_last_run/](https://paws-r-sdk.com/docs/describe_canaries_last_run/) for full documentation.
#'
#' @param NextToken A token that indicates that there is more data available. You can use
...
#'
#' See [https://paws-r-sdk.com/docs/describe_runtime_versions/](https://paws-r-sdk.com/docs/describe_runtime_versions/) for full documentation.
#'
#' @param NextToken A token that indicates that there is more data available. You can use
#' this token in a subsequent
...
#'
#' See [https://paws-r-sdk.com/docs/get_canary/](https://paws-r-sdk.com/docs/get_canary/) for full documentation.
#'
...
#' Retrieves a list of runs for a specified canary.
#'
#' See [https://paws-r-sdk.com/docs/get_canary_runs/](https://paws-r-sdk.com/docs/get_canary_runs/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_associated_groups/](https://paws-r-sdk.com/docs/list_associated_groups/) for full documentation.
#'
#' @param NextToken A token that indicates that there is more data available. You can use
#' this token in a subsequent operation to retrieve the next set of
#' results.
...
#'
#' See [https://paws-r-sdk.com/docs/list_group_resources/](https://paws-r-sdk.com/docs/list_group_resources/) for full documentation.
#'
#' @param NextToken A token that indicates that there is more data available. You can use
#' this token in a subsequent operation to retrieve the next set of
#' results.
...
#'
#' See [https://paws-r-sdk.com/docs/start_canary/](https://paws-r-sdk.com/docs/start_canary/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/stop_canary/](https://paws-r-sdk.com/docs/stop_canary/) for full documentation.
#'
...
#' Updates the configuration of a canary that has already been created.
#'
#' See [https://paws-r-sdk.com/docs/update_canary/](https://paws-r-sdk.com/docs/update_canary/) for full documentation.
#'
