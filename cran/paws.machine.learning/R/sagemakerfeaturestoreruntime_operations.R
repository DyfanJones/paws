...
#' Retrieves a batch of `Records` from a `FeatureGroup`.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_record/](https://paws-r-sdk.com/docs/batch_get_record/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_record/](https://paws-r-sdk.com/docs/delete_record/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_record/](https://paws-r-sdk.com/docs/get_record/) for full documentation.
#'
