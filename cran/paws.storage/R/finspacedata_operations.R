...
#'
#' See [https://paws-r-sdk.com/docs/associate_user_to_permission_group/](https://paws-r-sdk.com/docs/associate_user_to_permission_group/) for full documentation.
#'
...
#' Creates a new Changeset in a FinSpace Dataset.
#'
#' See [https://paws-r-sdk.com/docs/create_changeset/](https://paws-r-sdk.com/docs/create_changeset/) for full documentation.
#'
#' @param clientToken A token that ensures idempotency. This token expires in 10 minutes.
...
#' Creates a Dataview for a Dataset.
#'
#' See [https://paws-r-sdk.com/docs/create_data_view/](https://paws-r-sdk.com/docs/create_data_view/) for full documentation.
#'
#' @param clientToken A token that ensures idempotency. This token expires in 10 minutes.
...
#'
#' See [https://paws-r-sdk.com/docs/create_permission_group/](https://paws-r-sdk.com/docs/create_permission_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_permission_group/](https://paws-r-sdk.com/docs/delete_permission_group/) for full documentation.
#'
...
#' Removes a user account from a permission group.
#'
#' See [https://paws-r-sdk.com/docs/disassociate_user_from_permission_group/](https://paws-r-sdk.com/docs/disassociate_user_from_permission_group/) for full documentation.
#'
#' @param permissionGroupId &#91;required&#93; The unique identifier for the permission group.
#' @param userId &#91;required&#93; The unique identifier for the user.
#' @param clientToken A token that ensures idempotency. This token expires in 10 minutes.
...
#' Get information about a Changeset.
#'
#' See [https://paws-r-sdk.com/docs/get_changeset/](https://paws-r-sdk.com/docs/get_changeset/) for full documentation.
#'
...
#' Gets information about a Dataview.
#'
#' See [https://paws-r-sdk.com/docs/get_data_view/](https://paws-r-sdk.com/docs/get_data_view/) for full documentation.
#'
...
#' Returns information about a Dataset.
#'
#' See [https://paws-r-sdk.com/docs/get_dataset/](https://paws-r-sdk.com/docs/get_dataset/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_external_data_view_access_details/](https://paws-r-sdk.com/docs/get_external_data_view_access_details/) for full documentation.
#'
...
#' Retrieves the details of a specific permission group.
#'
#' See [https://paws-r-sdk.com/docs/get_permission_group/](https://paws-r-sdk.com/docs/get_permission_group/) for full documentation.
#'
#' @param permissionGroupId &#91;required&#93; The unique identifier for the permission group.
#'
#' @keywords internal
...
#' Request programmatic credentials to use with FinSpace SDK.
#'
#' See [https://paws-r-sdk.com/docs/get_programmatic_access_credentials/](https://paws-r-sdk.com/docs/get_programmatic_access_credentials/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_working_location/](https://paws-r-sdk.com/docs/get_working_location/) for full documentation.
#'
...
#' Lists the FinSpace Changesets for a Dataset.
#'
#' See [https://paws-r-sdk.com/docs/list_changesets/](https://paws-r-sdk.com/docs/list_changesets/) for full documentation.
#'
...
#' Lists all available Dataviews for a Dataset.
#'
#' See [https://paws-r-sdk.com/docs/list_data_views/](https://paws-r-sdk.com/docs/list_data_views/) for full documentation.
#'
...
#' Lists all available permission groups in FinSpace.
#'
#' See [https://paws-r-sdk.com/docs/list_permission_groups/](https://paws-r-sdk.com/docs/list_permission_groups/) for full documentation.
#'
#' @param nextToken A token that indicates where a results page should begin.
...
#'
#' See [https://paws-r-sdk.com/docs/list_permission_groups_by_user/](https://paws-r-sdk.com/docs/list_permission_groups_by_user/) for full documentation.
#'
#' @param userId &#91;required&#93; The unique identifier for the user.
#' @param nextToken A token that indicates where a results page should begin.
#' @param maxResults &#91;required&#93; The maximum number of results per page.
...
#' Lists details of all the users in a specific permission group.
#'
#' See [https://paws-r-sdk.com/docs/list_users_by_permission_group/](https://paws-r-sdk.com/docs/list_users_by_permission_group/) for full documentation.
#'
#' @param permissionGroupId &#91;required&#93; The unique identifier for the permission group.
#' @param nextToken A token that indicates where a results page should begin.
#' @param maxResults &#91;required&#93; The maximum number of results per page.
...
#' Updates a FinSpace Changeset.
#'
#' See [https://paws-r-sdk.com/docs/update_changeset/](https://paws-r-sdk.com/docs/update_changeset/) for full documentation.
#'
#' @param clientToken A token that ensures idempotency. This token expires in 10 minutes.
...
#'
#' See [https://paws-r-sdk.com/docs/update_permission_group/](https://paws-r-sdk.com/docs/update_permission_group/) for full documentation.
#'
