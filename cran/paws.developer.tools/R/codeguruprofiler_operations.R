...
#' Add up to 2 anomaly notifications channels for a profiling group.
#'
#' See [https://paws-r-sdk.com/docs/add_notification_channels/](https://paws-r-sdk.com/docs/add_notification_channels/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_frame_metric_data/](https://paws-r-sdk.com/docs/batch_get_frame_metric_data/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/configure_agent/](https://paws-r-sdk.com/docs/configure_agent/) for full documentation.
#'
...
#' Creates a profiling group.
#'
#' See [https://paws-r-sdk.com/docs/create_profiling_group/](https://paws-r-sdk.com/docs/create_profiling_group/) for full documentation.
#'
...
#' Deletes a profiling group.
#'
#' See [https://paws-r-sdk.com/docs/delete_profiling_group/](https://paws-r-sdk.com/docs/delete_profiling_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_profiling_group/](https://paws-r-sdk.com/docs/describe_profiling_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_findings_report_account_summary/](https://paws-r-sdk.com/docs/get_findings_report_account_summary/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_notification_configuration/](https://paws-r-sdk.com/docs/get_notification_configuration/) for full documentation.
#'
...
#' List the available reports for a given profiling group and time range.
#'
#' See [https://paws-r-sdk.com/docs/list_findings_reports/](https://paws-r-sdk.com/docs/list_findings_reports/) for full documentation.
#'
#' @param dailyReportsOnly A `Boolean` value indicating whether to only return reports from daily
#' profiles. If set to `True`, only analysis data from daily profiles is
#' returned. If set to `False`, analysis data is returned from smaller time
...
#'
#' See [https://paws-r-sdk.com/docs/list_profile_times/](https://paws-r-sdk.com/docs/list_profile_times/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_profiling_groups/](https://paws-r-sdk.com/docs/list_profiling_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/post_agent_profile/](https://paws-r-sdk.com/docs/post_agent_profile/) for full documentation.
#'
...
#' Updates a profiling group.
#'
#' See [https://paws-r-sdk.com/docs/update_profiling_group/](https://paws-r-sdk.com/docs/update_profiling_group/) for full documentation.
#'
