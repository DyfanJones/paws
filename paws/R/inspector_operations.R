...
#' @param reportType &#91;required&#93; Specifies the type of the assessment report that you want to generate. There are two types of assessment reports: a finding report and a full report. For more information, see [Assessment Reports](https://docs.aws.amazon.com/inspector/v1/userguide/inspector_reports.html).
#'
#' @return
#' A list with the following syntax:
#' ```
