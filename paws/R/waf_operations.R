...
#' 
#' Creates a `ByteMatchSet`. You then use [`update_byte_match_set`][waf_update_byte_match_set] to identify the part of a web request that you want AWS WAF to inspect, such as the values of the `User-Agent` header or the query string. For example, you can create a `ByteMatchSet` that matches any requests with `User-Agent` headers that contain the string `BadBot`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_byte_match_set`][waf_create_byte_match_set] request.
#' 
#' 2.  Submit a [`create_byte_match_set`][waf_create_byte_match_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_byte_match_set`][waf_update_byte_match_set] request.
#' 
#' 4.  Submit an [`update_byte_match_set`][waf_update_byte_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
...
#'
#' @aliases waf_create_byte_match_set
...
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_geo_match_set`][waf_create_geo_match_set] request.
#' 
#' 2.  Submit a [`create_geo_match_set`][waf_create_geo_match_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_geo_match_set`][waf_update_geo_match_set] request.
#' 
...
#'
#' @aliases waf_create_geo_match_set
...
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_ip_set`][waf_create_ip_set] request.
#' 
#' 2.  Submit a [`create_ip_set`][waf_create_ip_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][waf_update_ip_set] request.
#' 
#' 4.  Submit an [`update_ip_set`][waf_update_ip_set] request to specify the IP addresses that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 
#' 1.  Create and update the predicates that you want to include in the rule. For more information, see [`create_byte_match_set`][waf_create_byte_match_set], [`create_ip_set`][waf_create_ip_set], and [`create_sql_injection_match_set`][waf_create_sql_injection_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_rule`][waf_create_rule] request.
#' 
#' 3.  Submit a [`create_rate_based_rule`][waf_create_rate_based_rule] request.
#' 
#' 4.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][waf_update_rule] request.
#' 
#' 5.  Submit an [`update_rate_based_rule`][waf_update_rate_based_rule] request to specify the predicates that you want to include in the rule.
#' 
#' 6.  Create and update a `WebACL` that contains the `RateBasedRule`. For more information, see [`create_web_acl`][waf_create_web_acl].
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_rate_based_rule
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a RegexMatchSet. You then use [`update_regex_match_set`][waf_update_regex_match_set] to identify the part of a web request that you want AWS WAF to inspect, such as the values of the `User-Agent` header or the query string. For example, you can create a `RegexMatchSet` that contains a `RegexMatchTuple` that looks for any requests with `User-Agent` headers that match a `RegexPatternSet` with pattern `B[a@@]dB[o0]t`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_regex_match_set`][waf_create_regex_match_set] request.
#' 
#' 2.  Submit a [`create_regex_match_set`][waf_create_regex_match_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_match_set`][waf_update_regex_match_set] request.
#' 
#' 4.  Submit an [`update_regex_match_set`][waf_update_regex_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value, using a `RegexPatternSet`, that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_regex_match_set
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `RegexPatternSet`. You then use [`update_regex_pattern_set`][waf_update_regex_pattern_set] to specify the regular expression (regex) pattern that you want AWS WAF to search for, such as `B[a@@]dB[o0]t`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `RegexPatternSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_regex_pattern_set`][waf_create_regex_pattern_set] request.
#' 
#' 2.  Submit a [`create_regex_pattern_set`][waf_create_regex_pattern_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_pattern_set`][waf_update_regex_pattern_set] request.
#' 
#' 4.  Submit an [`update_regex_pattern_set`][waf_update_regex_pattern_set] request to specify the string that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_regex_pattern_set
...
#' 4.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][waf_update_rule] request.
#' 
#' 5.  Submit an [`update_rule`][waf_update_rule] request to specify the predicates that you want to include in the `Rule`.
#' 
#' 6.  Create and update a `WebACL` that contains the `Rule`. For more information, see [`create_web_acl`][waf_create_web_acl].
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `RuleGroup`. A rule group is a collection of predefined rules that you add to a web ACL. You use [`update_rule_group`][waf_update_rule_group] to add rules to the rule group.
#' 
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `SizeConstraintSet`. You then use [`update_size_constraint_set`][waf_update_size_constraint_set] to identify the part of a web request that you want AWS WAF to check for length, such as the length of the `User-Agent` header or the length of the query string. For example, you can create a `SizeConstraintSet` that matches any requests that have a query string that is longer than 100 bytes. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_size_constraint_set`][waf_create_size_constraint_set] request.
#' 
#' 2.  Submit a [`create_size_constraint_set`][waf_create_size_constraint_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_size_constraint_set`][waf_update_size_constraint_set] request.
#' 
#' 4.  Submit an [`update_size_constraint_set`][waf_update_size_constraint_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_size_constraint_set
...
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_sql_injection_match_set`][waf_create_sql_injection_match_set] request.
#' 
#' 2.  Submit a [`create_sql_injection_match_set`][waf_create_sql_injection_match_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_sql_injection_match_set`][waf_update_sql_injection_match_set] request.
#' 
#' 4.  Submit an [`update_sql_injection_match_set`][waf_update_sql_injection_match_set] request to specify the parts of web requests in which you want to allow, block, or count malicious SQL code.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_sql_injection_match_set
...
#' 
#' 1.  Create and update the `ByteMatchSet` objects and other predicates that you want to include in `Rules`. For more information, see [`create_byte_match_set`][waf_create_byte_match_set], [`update_byte_match_set`][waf_update_byte_match_set], [`create_ip_set`][waf_create_ip_set], [`update_ip_set`][waf_update_ip_set], [`create_sql_injection_match_set`][waf_create_sql_injection_match_set], and [`update_sql_injection_match_set`][waf_update_sql_injection_match_set].
#' 
#' 2.  Create and update the `Rules` that you want to include in the `WebACL`. For more information, see [`create_rule`][waf_create_rule] and [`update_rule`][waf_update_rule].
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_web_acl`][waf_create_web_acl] request.
#' 
#' 4.  Submit a [`create_web_acl`][waf_create_web_acl] request.
#' 
#' 5.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_web_acl`][waf_update_web_acl] request.
#' 
#' 6.  Submit an [`update_web_acl`][waf_update_web_acl] request to specify the `Rules` that you want to include in the `WebACL`, to specify the default action, and to associate the `WebACL` with a CloudFront distribution.
#' 
...
#'
#' @aliases waf_create_web_acl_migration_stack
...
#' 
#' 1.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_xss_match_set`][waf_create_xss_match_set] request.
#' 
#' 2.  Submit a [`create_xss_match_set`][waf_create_xss_match_set] request.
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_xss_match_set`][waf_update_xss_match_set] request.
#' 
#' 4.  Submit an [`update_xss_match_set`][waf_update_xss_match_set] request to specify the parts of web requests in which you want to allow, block, or count cross-site scripting attacks.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_create_xss_match_set
...
#' 
#' If you just want to remove a `ByteMatchSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Update the `ByteMatchSet` to remove filters, if any. For more information, see [`update_byte_match_set`][waf_update_byte_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_byte_match_set`][waf_delete_byte_match_set] request.
#' 
#' 3.  Submit a [`delete_byte_match_set`][waf_delete_byte_match_set] request.
#'
#' @usage
...
#'
#' @aliases waf_delete_byte_match_set
...
#' 
#' If you just want to remove a `GeoMatchSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete a `GeoMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `GeoMatchSet` to remove any countries. For more information, see [`update_geo_match_set`][waf_update_geo_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_geo_match_set`][waf_delete_geo_match_set] request.
#' 
...
#'
#' @aliases waf_delete_geo_match_set
...
#' 
#' If you just want to remove an `IPSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete an `IPSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `IPSet` to remove IP address ranges, if any. For more information, see [`update_ip_set`][waf_update_ip_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_ip_set`][waf_delete_ip_set] request.
#' 
...
#'
#' @aliases waf_delete_logging_configuration
...
#'
#' @aliases waf_delete_permission_policy
...
#' 
#' If you just want to remove a rule from a `WebACL`, use [`update_web_acl`][waf_update_web_acl].
#' 
#' To permanently delete a `RateBasedRule` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `RateBasedRule` to remove predicates, if any. For more information, see [`update_rate_based_rule`][waf_update_rate_based_rule].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rate_based_rule`][waf_delete_rate_based_rule] request.
#' 
#' 3.  Submit a [`delete_rate_based_rule`][waf_delete_rate_based_rule] request.
#'
#' @usage
...
#'
#' @aliases waf_delete_rate_based_rule
...
#' 
#' If you just want to remove a `RegexMatchSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Update the `RegexMatchSet` to remove filters, if any. For more information, see [`update_regex_match_set`][waf_update_regex_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_regex_match_set`][waf_delete_regex_match_set] request.
#' 
#' 3.  Submit a [`delete_regex_match_set`][waf_delete_regex_match_set] request.
#'
#' @usage
...
#'
#' @aliases waf_delete_regex_match_set
...
#'
#' @aliases waf_delete_regex_pattern_set
...
#' 
#' 1.  Update the `Rule` to remove predicates, if any. For more information, see [`update_rule`][waf_update_rule].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rule`][waf_delete_rule] request.
#' 
...
#' 
#' If you just want to remove a `RuleGroup` from a `WebACL`, use [`update_web_acl`][waf_update_web_acl].
#' 
#' To permanently delete a `RuleGroup` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `RuleGroup` to remove rules, if any. For more information, see [`update_rule_group`][waf_update_rule_group].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rule_group`][waf_delete_rule_group] request.
#' 
...
#' 
#' If you just want to remove a `SizeConstraintSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Update the `SizeConstraintSet` to remove filters, if any. For more information, see [`update_size_constraint_set`][waf_update_size_constraint_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_size_constraint_set`][waf_delete_size_constraint_set] request.
#' 
#' 3.  Submit a [`delete_size_constraint_set`][waf_delete_size_constraint_set] request.
#'
#' @usage
...
#'
#' @aliases waf_delete_size_constraint_set
...
#' 
#' If you just want to remove a `SqlInjectionMatchSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete a `SqlInjectionMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `SqlInjectionMatchSet` to remove filters, if any. For more information, see [`update_sql_injection_match_set`][waf_update_sql_injection_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_sql_injection_match_set`][waf_delete_sql_injection_match_set] request.
#' 
#' 3.  Submit a [`delete_sql_injection_match_set`][waf_delete_sql_injection_match_set] request.
#'
#' @usage
...
#'
#' @aliases waf_delete_sql_injection_match_set
...
#' 
#' 1.  Update the `WebACL` to remove `Rules`, if any. For more information, see [`update_web_acl`][waf_update_web_acl].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_web_acl`][waf_delete_web_acl] request.
#' 
...
#' 
#' If you just want to remove an `XssMatchSet` from a `Rule`, use [`update_rule`][waf_update_rule].
#' 
#' To permanently delete an `XssMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `XssMatchSet` to remove filters, if any. For more information, see [`update_xss_match_set`][waf_update_xss_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_xss_match_set`][waf_delete_xss_match_set] request.
#' 
...
#'
#' @aliases waf_delete_xss_match_set
...
#'
#' @aliases waf_get_byte_match_set
...
#' 
#' Each create, update, or delete request must use a unique change token. If your application submits a [`get_change_token`][waf_get_change_token] request and then submits a second [`get_change_token`][waf_get_change_token] request before submitting a create, update, or delete request, the second [`get_change_token`][waf_get_change_token] request returns the same value as the first [`get_change_token`][waf_get_change_token] request.
#' 
#' When you use a change token in a create, update, or delete request, the status of the change token changes to `PENDING`, which indicates that AWS WAF is propagating the change to all AWS WAF servers. Use [`get_change_token_status`][waf_get_change_token_status] to determine the status of your change token.
#'
#' @usage
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the status of a `ChangeToken` that you got by calling [`get_change_token`][waf_get_change_token]. `ChangeTokenStatus` is one of the following values:
#' 
#' -   `PROVISIONED`: You requested the change token by calling [`get_change_token`][waf_get_change_token], but you haven't used it yet in a call to create, update, or delete an AWS WAF object.
#' 
...
#'
#' @aliases waf_get_change_token_status
...
#'
#' @aliases waf_get_logging_configuration
...
#'
#' @aliases waf_get_permission_policy
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the RateBasedRule that is specified by the `RuleId` that you included in the [`get_rate_based_rule`][waf_get_rate_based_rule] request.
#'
#' @usage
...
#'
#' @aliases waf_get_rate_based_rule
...
#'
#' @aliases waf_get_rate_based_rule_managed_keys
...
#'
#' @aliases waf_get_regex_match_set
...
#'
#' @aliases waf_get_regex_pattern_set
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the Rule that is specified by the `RuleId` that you included in the [`get_rule`][waf_get_rule] request.
#'
#' @usage
#' waf_get_rule(RuleId)
#'
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the RuleGroup that is specified by the `RuleGroupId` that you included in the [`get_rule_group`][waf_get_rule_group] request.
#' 
#' To view the rules in a rule group, use [`list_activated_rules_in_rule_group`][waf_list_activated_rules_in_rule_group].
#'
#' @usage
...
#' 
#' [`get_sampled_requests`][waf_get_sampled_requests] returns a time range, which is usually the time range that you specified. However, if your resource (such as a CloudFront distribution) received 5,000 requests before the specified time range elapsed, [`get_sampled_requests`][waf_get_sampled_requests] returns an updated time range. This new time range indicates the actual period during which AWS WAF selected the requests in the sample.
#'
#' @usage
...
#'
#' @aliases waf_get_sampled_requests
...
#'
#' @aliases waf_get_size_constraint_set
...
#'
#' @aliases waf_get_sql_injection_match_set
...
#'
#' @aliases waf_list_activated_rules_in_rule_group
...
#'
#' @aliases waf_list_byte_match_sets
...
#'
#' @aliases waf_list_geo_match_sets
...
#'
#' @aliases waf_list_logging_configurations
...
#'
#' @aliases waf_list_rate_based_rules
...
#'
#' @aliases waf_list_regex_match_sets
...
#'
#' @aliases waf_list_regex_pattern_sets
...
#'
#' @aliases waf_list_size_constraint_sets
...
#'
#' @aliases waf_list_sql_injection_match_sets
...
#'
#' @aliases waf_list_subscribed_rule_groups
...
#'
#' @aliases waf_list_tags_for_resource
...
#'
#' @aliases waf_list_xss_match_sets
...
#' 
#' 2.  Associate that firehose to your web ACL using a [`put_logging_configuration`][waf_put_logging_configuration] request.
#' 
#' When you successfully enable logging using a [`put_logging_configuration`][waf_put_logging_configuration] request, AWS WAF will create a service linked role with the necessary permissions to write logs to the Amazon Kinesis Data Firehose. For more information, see [Logging Web ACL Traffic Information](https://docs.aws.amazon.com/waf/latest/developerguide/logging.html) in the *AWS WAF Developer Guide*.
#'
#' @usage
...
#'
#' @aliases waf_put_logging_configuration
...
#' 
#' The [`put_permission_policy`][waf_put_permission_policy] is subject to the following restrictions:
#' 
#' -   You can attach only one policy with each [`put_permission_policy`][waf_put_permission_policy] request.
#' 
...
#'
#' @aliases waf_put_permission_policy
...
#' To create and configure a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Create a `ByteMatchSet.` For more information, see [`create_byte_match_set`][waf_create_byte_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_byte_match_set`][waf_update_byte_match_set] request.
#' 
#' 3.  Submit an [`update_byte_match_set`][waf_update_byte_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_byte_match_set
...
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_geo_match_set`][waf_update_geo_match_set] request.
#' 
#' 3.  Submit an [`update_geo_match_set`][waf_update_geo_match_set] request to specify the country that you want AWS WAF to watch for.
#' 
...
#'
#' @aliases waf_update_geo_match_set
...
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][waf_update_ip_set] request.
#' 
#' 3.  Submit an [`update_ip_set`][waf_update_ip_set] request to specify the IP addresses that you want AWS WAF to watch for.
#' 
...
#'
#' @aliases waf_update_rate_based_rule
...
#' To create and configure a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Create a `RegexMatchSet.` For more information, see [`create_regex_match_set`][waf_create_regex_match_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_match_set`][waf_update_regex_match_set] request.
#' 
#' 3.  Submit an [`update_regex_match_set`][waf_update_regex_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the identifier of the `RegexPatternSet` that contain the regular expression patters you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_regex_match_set
...
#' To create and configure a `RegexPatternSet`, perform the following steps:
#' 
#' 1.  Create a `RegexPatternSet.` For more information, see [`create_regex_pattern_set`][waf_create_regex_pattern_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_pattern_set`][waf_update_regex_pattern_set] request.
#' 
#' 3.  Submit an [`update_regex_pattern_set`][waf_update_regex_pattern_set] request to specify the regular expression pattern that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_regex_pattern_set
...
#' 
#' 3.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][waf_update_rule] request.
#' 
#' 4.  Submit an [`update_rule`][waf_update_rule] request to add predicates to the `Rule`.
#' 
#' 5.  Create and update a `WebACL` that contains the `Rule`. See [`create_web_acl`][waf_create_web_acl].
#' 
...
#' 
#' 1.  Create and update the `Rules` that you want to include in the `RuleGroup`. See [`create_rule`][waf_create_rule].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule_group`][waf_update_rule_group] request.
#' 
#' 3.  Submit an [`update_rule_group`][waf_update_rule_group] request to add `Rules` to the `RuleGroup`.
#' 
#' 4.  Create and update a `WebACL` that contains the `RuleGroup`. See [`create_web_acl`][waf_create_web_acl].
#' 
...
#' To create and configure a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Create a `SizeConstraintSet.` For more information, see [`create_size_constraint_set`][waf_create_size_constraint_set].
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_size_constraint_set`][waf_update_size_constraint_set] request.
#' 
#' 3.  Submit an [`update_size_constraint_set`][waf_update_size_constraint_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_size_constraint_set
...
#' To create and configure a `SqlInjectionMatchSet`, perform the following steps:
#' 
#' 1.  Submit a [`create_sql_injection_match_set`][waf_create_sql_injection_match_set] request.
#' 
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][waf_update_ip_set] request.
#' 
#' 3.  Submit an [`update_sql_injection_match_set`][waf_update_sql_injection_match_set] request to specify the parts of web requests that you want AWS WAF to inspect for snippets of SQL code.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_sql_injection_match_set
...
#' To create and configure a `WebACL`, perform the following steps:
#' 
#' 1.  Create and update the predicates that you want to include in `Rules`. For more information, see [`create_byte_match_set`][waf_create_byte_match_set], [`update_byte_match_set`][waf_update_byte_match_set], [`create_ip_set`][waf_create_ip_set], [`update_ip_set`][waf_update_ip_set], [`create_sql_injection_match_set`][waf_create_sql_injection_match_set], and [`update_sql_injection_match_set`][waf_update_sql_injection_match_set].
#' 
#' 2.  Create and update the `Rules` that you want to include in the `WebACL`. For more information, see [`create_rule`][waf_create_rule] and [`update_rule`][waf_update_rule].
#' 
#' 3.  Create a `WebACL`. See [`create_web_acl`][waf_create_web_acl].
#' 
#' 4.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_web_acl`][waf_update_web_acl] request.
#' 
#' 5.  Submit an [`update_web_acl`][waf_update_web_acl] request to specify the `Rules` that you want to include in the `WebACL`, to specify the default action, and to associate the `WebACL` with a CloudFront distribution.
#' 
...
#' 
#'     If you already have a rule group associated with a web ACL and want to submit an [`update_web_acl`][waf_update_web_acl] request to exclude certain rules from that rule group, you must first remove the rule group from the web ACL, the re-insert it again, specifying the excluded rules. For details, see ActivatedRule$ExcludedRules .
#' 
#' Be aware that if you try to add a RATE_BASED rule to a web ACL without setting the rule type when first creating the rule, the [`update_web_acl`][waf_update_web_acl] request will fail because the request tries to add a REGULAR rule (the default rule type) with the specified ID, which does not exist.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 2.  Use [`get_change_token`][waf_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][waf_update_ip_set] request.
#' 
#' 3.  Submit an [`update_xss_match_set`][waf_update_xss_match_set] request to specify the parts of web requests that you want AWS WAF to inspect for cross-site scripting attacks.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @aliases waf_update_xss_match_set
