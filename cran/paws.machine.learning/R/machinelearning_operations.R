...
#'
#' See [https://paws-r-sdk.com/docs/create_batch_prediction/](https://paws-r-sdk.com/docs/create_batch_prediction/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_data_source_from_rds/](https://paws-r-sdk.com/docs/create_data_source_from_rds/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_data_source_from_redshift/](https://paws-r-sdk.com/docs/create_data_source_from_redshift/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_data_source_from_s3/](https://paws-r-sdk.com/docs/create_data_source_from_s3/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_evaluation/](https://paws-r-sdk.com/docs/create_evaluation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_ml_model/](https://paws-r-sdk.com/docs/create_ml_model/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_realtime_endpoint/](https://paws-r-sdk.com/docs/create_realtime_endpoint/) for full documentation.
#'
...
#' Assigns the DELETED status to a `BatchPrediction`, rendering it unusable.
#'
#' See [https://paws-r-sdk.com/docs/delete_batch_prediction/](https://paws-r-sdk.com/docs/delete_batch_prediction/) for full documentation.
#'
#' @param BatchPredictionId &#91;required&#93; A user-supplied ID that uniquely identifies the `BatchPrediction`.
#'
#' @keywords internal
...
#' Assigns the `DELETED` status to an `Evaluation`, rendering it unusable.
#'
#' See [https://paws-r-sdk.com/docs/delete_evaluation/](https://paws-r-sdk.com/docs/delete_evaluation/) for full documentation.
#'
...
#' Assigns the `DELETED` status to an `MLModel`, rendering it unusable.
#'
#' See [https://paws-r-sdk.com/docs/delete_ml_model/](https://paws-r-sdk.com/docs/delete_ml_model/) for full documentation.
#'
#' @param MLModelId &#91;required&#93; A user-supplied ID that uniquely identifies the `MLModel`.
#'
#' @keywords internal
...
#' Deletes a real time endpoint of an `MLModel`.
#'
#' See [https://paws-r-sdk.com/docs/delete_realtime_endpoint/](https://paws-r-sdk.com/docs/delete_realtime_endpoint/) for full documentation.
#'
#' @param MLModelId &#91;required&#93; The ID assigned to the `MLModel` during creation.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/describe_batch_predictions/](https://paws-r-sdk.com/docs/describe_batch_predictions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_data_sources/](https://paws-r-sdk.com/docs/describe_data_sources/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_evaluations/](https://paws-r-sdk.com/docs/describe_evaluations/) for full documentation.
#'
...
#' Returns a list of `MLModel` that match the search criteria in the request.
#'
#' See [https://paws-r-sdk.com/docs/describe_ml_models/](https://paws-r-sdk.com/docs/describe_ml_models/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_batch_prediction/](https://paws-r-sdk.com/docs/get_batch_prediction/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_data_source/](https://paws-r-sdk.com/docs/get_data_source/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_evaluation/](https://paws-r-sdk.com/docs/get_evaluation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_ml_model/](https://paws-r-sdk.com/docs/get_ml_model/) for full documentation.
#'
...
#' Generates a prediction for the observation using the specified `ML Model`.
#'
#' See [https://paws-r-sdk.com/docs/predict/](https://paws-r-sdk.com/docs/predict/) for full documentation.
#'
...
#' Updates the `BatchPredictionName` of a `BatchPrediction`.
#'
#' See [https://paws-r-sdk.com/docs/update_batch_prediction/](https://paws-r-sdk.com/docs/update_batch_prediction/) for full documentation.
#'
...
#' Updates the `EvaluationName` of an `Evaluation`.
#'
#' See [https://paws-r-sdk.com/docs/update_evaluation/](https://paws-r-sdk.com/docs/update_evaluation/) for full documentation.
#'
...
#' Updates the `MLModelName` and the `ScoreThreshold` of an `MLModel`.
#'
#' See [https://paws-r-sdk.com/docs/update_ml_model/](https://paws-r-sdk.com/docs/update_ml_model/) for full documentation.
#'
#' @param MLModelId &#91;required&#93; The ID assigned to the `MLModel` during creation.
#' @param MLModelName A user-supplied name or description of the `MLModel`.
