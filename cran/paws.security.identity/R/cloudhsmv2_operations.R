...
#' Copy an AWS CloudHSM cluster backup to a different region.
#'
#' See [https://paws-r-sdk.com/docs/copy_backup_to_region/](https://paws-r-sdk.com/docs/copy_backup_to_region/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/initialize_cluster/](https://paws-r-sdk.com/docs/initialize_cluster/) for full documentation.
#'
...
#' Modifies attributes for AWS CloudHSM backup.
#'
#' See [https://paws-r-sdk.com/docs/modify_backup_attributes/](https://paws-r-sdk.com/docs/modify_backup_attributes/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/restore_backup/](https://paws-r-sdk.com/docs/restore_backup/) for full documentation.
#'
