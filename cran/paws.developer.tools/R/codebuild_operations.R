...
#' Deletes one or more builds.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_builds/](https://paws-r-sdk.com/docs/batch_delete_builds/) for full documentation.
#'
...
#' Retrieves information about one or more batch builds.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_build_batches/](https://paws-r-sdk.com/docs/batch_get_build_batches/) for full documentation.
#'
...
#' Gets information about one or more builds.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_builds/](https://paws-r-sdk.com/docs/batch_get_builds/) for full documentation.
#'
...
#' Gets information about one or more build projects.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_projects/](https://paws-r-sdk.com/docs/batch_get_projects/) for full documentation.
#'
...
#' Returns an array of report groups.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_report_groups/](https://paws-r-sdk.com/docs/batch_get_report_groups/) for full documentation.
#'
...
#' Returns an array of reports.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_reports/](https://paws-r-sdk.com/docs/batch_get_reports/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_report_group/](https://paws-r-sdk.com/docs/create_report_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_webhook/](https://paws-r-sdk.com/docs/create_webhook/) for full documentation.
#'
...
#' Deletes a batch build.
#'
#' See [https://paws-r-sdk.com/docs/delete_build_batch/](https://paws-r-sdk.com/docs/delete_build_batch/) for full documentation.
#'
...
#' Deletes a report.
#'
#' See [https://paws-r-sdk.com/docs/delete_report/](https://paws-r-sdk.com/docs/delete_report/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_report_group/](https://paws-r-sdk.com/docs/delete_report_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_source_credentials/](https://paws-r-sdk.com/docs/delete_source_credentials/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_webhook/](https://paws-r-sdk.com/docs/delete_webhook/) for full documentation.
#'
#' @param projectName &#91;required&#93; The name of the CodeBuild project.
#'
#' @keywords internal
...
#' Retrieves one or more code coverage reports.
#'
#' See [https://paws-r-sdk.com/docs/describe_code_coverages/](https://paws-r-sdk.com/docs/describe_code_coverages/) for full documentation.
#'
...
#' Returns a list of details about test cases for a report.
#'
#' See [https://paws-r-sdk.com/docs/describe_test_cases/](https://paws-r-sdk.com/docs/describe_test_cases/) for full documentation.
#'
#' @param reportArn &#91;required&#93; The ARN of the report for which test cases are returned.
...
#'
#' See [https://paws-r-sdk.com/docs/get_report_group_trend/](https://paws-r-sdk.com/docs/get_report_group_trend/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/import_source_credentials/](https://paws-r-sdk.com/docs/import_source_credentials/) for full documentation.
#'
...
#' Resets the cache for a project.
#'
#' See [https://paws-r-sdk.com/docs/invalidate_project_cache/](https://paws-r-sdk.com/docs/invalidate_project_cache/) for full documentation.
#'
...
#' Retrieves the identifiers of your build batches in the current region.
#'
#' See [https://paws-r-sdk.com/docs/list_build_batches/](https://paws-r-sdk.com/docs/list_build_batches/) for full documentation.
#'
...
#' Retrieves the identifiers of the build batches for a specific project.
#'
#' See [https://paws-r-sdk.com/docs/list_build_batches_for_project/](https://paws-r-sdk.com/docs/list_build_batches_for_project/) for full documentation.
#'
...
#' Gets a list of build IDs, with each build ID representing a single build.
#'
#' See [https://paws-r-sdk.com/docs/list_builds/](https://paws-r-sdk.com/docs/list_builds/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_builds_for_project/](https://paws-r-sdk.com/docs/list_builds_for_project/) for full documentation.
#'
#' @param projectName &#91;required&#93; The name of the CodeBuild project.
...
#' Gets information about Docker images that are managed by CodeBuild.
#'
#' See [https://paws-r-sdk.com/docs/list_curated_environment_images/](https://paws-r-sdk.com/docs/list_curated_environment_images/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_report_groups/](https://paws-r-sdk.com/docs/list_report_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_reports/](https://paws-r-sdk.com/docs/list_reports/) for full documentation.
#'
...
#' Returns a list of ARNs for the reports that belong to a `ReportGroup`.
#'
#' See [https://paws-r-sdk.com/docs/list_reports_for_report_group/](https://paws-r-sdk.com/docs/list_reports_for_report_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_shared_projects/](https://paws-r-sdk.com/docs/list_shared_projects/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_shared_report_groups/](https://paws-r-sdk.com/docs/list_shared_report_groups/) for full documentation.
#'
...
#' Returns a list of `SourceCredentialsInfo` objects.
#'
#' See [https://paws-r-sdk.com/docs/list_source_credentials/](https://paws-r-sdk.com/docs/list_source_credentials/) for full documentation.
#'
#' @keywords internal
#'
...
#' Restarts a build.
#'
#' See [https://paws-r-sdk.com/docs/retry_build/](https://paws-r-sdk.com/docs/retry_build/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/retry_build_batch/](https://paws-r-sdk.com/docs/retry_build_batch/) for full documentation.
#'
...
#' Starts running a build.
#'
#' See [https://paws-r-sdk.com/docs/start_build/](https://paws-r-sdk.com/docs/start_build/) for full documentation.
#'
...
#' Starts a batch build for a project.
#'
#' See [https://paws-r-sdk.com/docs/start_build_batch/](https://paws-r-sdk.com/docs/start_build_batch/) for full documentation.
#'
...
#' Attempts to stop running a build.
#'
#' See [https://paws-r-sdk.com/docs/stop_build/](https://paws-r-sdk.com/docs/stop_build/) for full documentation.
#'
...
#' Stops a running batch build.
#'
#' See [https://paws-r-sdk.com/docs/stop_build_batch/](https://paws-r-sdk.com/docs/stop_build_batch/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_project_visibility/](https://paws-r-sdk.com/docs/update_project_visibility/) for full documentation.
#'
...
#' Updates a report group.
#'
#' See [https://paws-r-sdk.com/docs/update_report_group/](https://paws-r-sdk.com/docs/update_report_group/) for full documentation.
#'
...
#' Updates the webhook associated with an CodeBuild build project.
#'
#' See [https://paws-r-sdk.com/docs/update_webhook/](https://paws-r-sdk.com/docs/update_webhook/) for full documentation.
#'
#' @param projectName &#91;required&#93; The name of the CodeBuild project.
#' @param branchFilter A regular expression used to determine which repository branches are
#' built when a webhook is triggered. If the name of a branch matches the
