...
#' Associates one or more Scram Secrets with an Amazon MSK cluster.
#'
#' See [https://paws-r-sdk.com/docs/batch_associate_scram_secret/](https://paws-r-sdk.com/docs/batch_associate_scram_secret/) for full documentation.
#'
...
#' Creates a new MSK cluster.
#'
#' See [https://paws-r-sdk.com/docs/create_cluster_v2/](https://paws-r-sdk.com/docs/create_cluster_v2/) for full documentation.
#'
#' @param ClusterName &#91;required&#93; The name of the cluster.
...
#' Creates a new MSK configuration.
#'
#' See [https://paws-r-sdk.com/docs/create_configuration/](https://paws-r-sdk.com/docs/create_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_cluster_policy/](https://paws-r-sdk.com/docs/delete_cluster_policy/) for full documentation.
#'
...
#' Deletes an MSK Configuration.
#'
#' See [https://paws-r-sdk.com/docs/delete_configuration/](https://paws-r-sdk.com/docs/delete_configuration/) for full documentation.
#'
...
#' Returns a description of the MSK cluster whose Amazon Resource Name (ARN) is specified in the request.
#'
#' See [https://paws-r-sdk.com/docs/describe_cluster_v2/](https://paws-r-sdk.com/docs/describe_cluster_v2/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#'
#' @keywords internal
...
#' Returns a description of the cluster operation specified by the ARN.
#'
#' See [https://paws-r-sdk.com/docs/describe_cluster_operation/](https://paws-r-sdk.com/docs/describe_cluster_operation/) for full documentation.
#'
...
#' Returns a description of this MSK configuration.
#'
#' See [https://paws-r-sdk.com/docs/describe_configuration/](https://paws-r-sdk.com/docs/describe_configuration/) for full documentation.
#'
#' @param Arn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies an MSK
...
#' Returns a description of this revision of the configuration.
#'
#' See [https://paws-r-sdk.com/docs/describe_configuration_revision/](https://paws-r-sdk.com/docs/describe_configuration_revision/) for full documentation.
#'
#' @param Arn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies an MSK
#' configuration and all of its revisions.
...
#' Disassociates one or more Scram Secrets from an Amazon MSK cluster.
#'
#' See [https://paws-r-sdk.com/docs/batch_disassociate_scram_secret/](https://paws-r-sdk.com/docs/batch_disassociate_scram_secret/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster to be updated.
#' @param SecretArnList &#91;required&#93; List of AWS Secrets Manager secret ARNs.
#'
...
#' A list of brokers that a client application can use to bootstrap.
#'
#' See [https://paws-r-sdk.com/docs/get_bootstrap_brokers/](https://paws-r-sdk.com/docs/get_bootstrap_brokers/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#'
#' @keywords internal
...
#' Gets the Apache Kafka versions to which you can update the MSK cluster.
#'
#' See [https://paws-r-sdk.com/docs/get_compatible_kafka_versions/](https://paws-r-sdk.com/docs/get_compatible_kafka_versions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cluster_policy/](https://paws-r-sdk.com/docs/get_cluster_policy/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/list_cluster_operations/](https://paws-r-sdk.com/docs/list_cluster_operations/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
...
#' Returns a list of all the MSK clusters in the current Region.
#'
#' See [https://paws-r-sdk.com/docs/list_clusters_v2/](https://paws-r-sdk.com/docs/list_clusters_v2/) for full documentation.
#'
...
#' Returns a list of all the MSK configurations in this Region.
#'
#' See [https://paws-r-sdk.com/docs/list_configuration_revisions/](https://paws-r-sdk.com/docs/list_configuration_revisions/) for full documentation.
#'
#' @param Arn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies an MSK
#' configuration and all of its revisions.
#' @param MaxResults The maximum number of results to return in the response. If there are
...
#' Returns a list of all the MSK configurations in this Region.
#'
#' See [https://paws-r-sdk.com/docs/list_configurations/](https://paws-r-sdk.com/docs/list_configurations/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in the response. If there are
#' more results, the response includes a NextToken parameter.
#' @param NextToken The paginated results marker. When the result of the operation is
...
#' Returns a list of Apache Kafka versions.
#'
#' See [https://paws-r-sdk.com/docs/list_kafka_versions/](https://paws-r-sdk.com/docs/list_kafka_versions/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in the response. If there are
#' more results, the response includes a NextToken parameter.
#' @param NextToken The paginated results marker. When the result of the operation is
...
#' Returns a list of the broker nodes in the cluster.
#'
#' See [https://paws-r-sdk.com/docs/list_nodes/](https://paws-r-sdk.com/docs/list_nodes/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#' @param MaxResults The maximum number of results to return in the response. If there are
#' more results, the response includes a NextToken parameter.
...
#'
#' See [https://paws-r-sdk.com/docs/list_scram_secrets/](https://paws-r-sdk.com/docs/list_scram_secrets/) for full documentation.
#'
...
#' Returns a list of all the VPC connections in this Region.
#'
#' See [https://paws-r-sdk.com/docs/list_client_vpc_connections/](https://paws-r-sdk.com/docs/list_client_vpc_connections/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster.
#' @param MaxResults The maximum number of results to return in the response. If there are
#' more results, the response includes a NextToken parameter.
...
#' Returns empty response.
#'
#' See [https://paws-r-sdk.com/docs/reject_client_vpc_connection/](https://paws-r-sdk.com/docs/reject_client_vpc_connection/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster.
...
#'
#' See [https://paws-r-sdk.com/docs/put_cluster_policy/](https://paws-r-sdk.com/docs/put_cluster_policy/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster.
...
#' Reboots brokers.
#'
#' See [https://paws-r-sdk.com/docs/reboot_broker/](https://paws-r-sdk.com/docs/reboot_broker/) for full documentation.
#'
...
#' Updates the number of broker nodes in the cluster.
#'
#' See [https://paws-r-sdk.com/docs/update_broker_count/](https://paws-r-sdk.com/docs/update_broker_count/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
...
#' Updates EC2 instance type.
#'
#' See [https://paws-r-sdk.com/docs/update_broker_type/](https://paws-r-sdk.com/docs/update_broker_type/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
...
#' Updates the EBS storage associated with MSK brokers.
#'
#' See [https://paws-r-sdk.com/docs/update_broker_storage/](https://paws-r-sdk.com/docs/update_broker_storage/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#' @param CurrentVersion &#91;required&#93; The version of cluster to update from. A successful operation will then
#' generate a new version.
...
#' Updates an MSK configuration.
#'
#' See [https://paws-r-sdk.com/docs/update_configuration/](https://paws-r-sdk.com/docs/update_configuration/) for full documentation.
#'
...
#' Updates the cluster's connectivity configuration.
#'
#' See [https://paws-r-sdk.com/docs/update_connectivity/](https://paws-r-sdk.com/docs/update_connectivity/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_cluster_configuration/](https://paws-r-sdk.com/docs/update_cluster_configuration/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
...
#' Updates the Apache Kafka version for the cluster.
#'
#' See [https://paws-r-sdk.com/docs/update_cluster_kafka_version/](https://paws-r-sdk.com/docs/update_cluster_kafka_version/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster to be updated.
...
#'
#' See [https://paws-r-sdk.com/docs/update_monitoring/](https://paws-r-sdk.com/docs/update_monitoring/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#' @param CurrentVersion &#91;required&#93; The version of the MSK cluster to update. Cluster versions aren't simple
#' numbers. You can describe an MSK cluster to find its version. When this
...
#'
#' See [https://paws-r-sdk.com/docs/update_security/](https://paws-r-sdk.com/docs/update_security/) for full documentation.
#'
#' @param ClientAuthentication Includes all client authentication related information.
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) that uniquely identifies the cluster.
#' @param CurrentVersion &#91;required&#93; The version of the MSK cluster to update. Cluster versions aren't simple
...
#'
#' See [https://paws-r-sdk.com/docs/update_storage/](https://paws-r-sdk.com/docs/update_storage/) for full documentation.
#'
#' @param ClusterArn &#91;required&#93; The Amazon Resource Name (ARN) of the cluster to be updated.
#' @param CurrentVersion &#91;required&#93; The version of cluster to update from. A successful operation will then
#' generate a new version.
