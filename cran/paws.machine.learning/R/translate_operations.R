...
#'
#' See [https://paws-r-sdk.com/docs/create_parallel_data/](https://paws-r-sdk.com/docs/create_parallel_data/) for full documentation.
#'
...
#' Deletes a parallel data resource in Amazon Translate.
#'
#' See [https://paws-r-sdk.com/docs/delete_parallel_data/](https://paws-r-sdk.com/docs/delete_parallel_data/) for full documentation.
#'
...
#' A synchronous action that deletes a custom terminology.
#'
#' See [https://paws-r-sdk.com/docs/delete_terminology/](https://paws-r-sdk.com/docs/delete_terminology/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_text_translation_job/](https://paws-r-sdk.com/docs/describe_text_translation_job/) for full documentation.
#'
...
#' Provides information about a parallel data resource.
#'
#' See [https://paws-r-sdk.com/docs/get_parallel_data/](https://paws-r-sdk.com/docs/get_parallel_data/) for full documentation.
#'
...
#' Retrieves a custom terminology.
#'
#' See [https://paws-r-sdk.com/docs/get_terminology/](https://paws-r-sdk.com/docs/get_terminology/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/import_terminology/](https://paws-r-sdk.com/docs/import_terminology/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_languages/](https://paws-r-sdk.com/docs/list_languages/) for full documentation.
#'
...
#' Provides a list of your parallel data resources in Amazon Translate.
#'
#' See [https://paws-r-sdk.com/docs/list_parallel_data/](https://paws-r-sdk.com/docs/list_parallel_data/) for full documentation.
#'
...
#' Provides a list of custom terminologies associated with your account.
#'
#' See [https://paws-r-sdk.com/docs/list_terminologies/](https://paws-r-sdk.com/docs/list_terminologies/) for full documentation.
#'
...
#' Gets a list of the batch translation jobs that you have submitted.
#'
#' See [https://paws-r-sdk.com/docs/list_text_translation_jobs/](https://paws-r-sdk.com/docs/list_text_translation_jobs/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_text_translation_job/](https://paws-r-sdk.com/docs/start_text_translation_job/) for full documentation.
#'
...
#' Stops an asynchronous batch translation job that is in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_text_translation_job/](https://paws-r-sdk.com/docs/stop_text_translation_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/translate_document/](https://paws-r-sdk.com/docs/translate_document/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/translate_text/](https://paws-r-sdk.com/docs/translate_text/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_parallel_data/](https://paws-r-sdk.com/docs/update_parallel_data/) for full documentation.
#'
