...
#' Retrieves the raw content of an in-transit email message, in MIME format.
#'
#' See [https://paws-r-sdk.com/docs/get_raw_message_content/](https://paws-r-sdk.com/docs/get_raw_message_content/) for full documentation.
#'
...
#' Updates the raw content of an in-transit email message, in MIME format.
#'
#' See [https://paws-r-sdk.com/docs/put_raw_message_content/](https://paws-r-sdk.com/docs/put_raw_message_content/) for full documentation.
#'
