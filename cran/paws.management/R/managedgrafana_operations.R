...
#'
#' See [https://paws-r-sdk.com/docs/associate_license/](https://paws-r-sdk.com/docs/associate_license/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_workspace_api_key/](https://paws-r-sdk.com/docs/create_workspace_api_key/) for full documentation.
#'
...
#' Deletes a Grafana API key for the workspace.
#'
#' See [https://paws-r-sdk.com/docs/delete_workspace_api_key/](https://paws-r-sdk.com/docs/delete_workspace_api_key/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_workspace_authentication/](https://paws-r-sdk.com/docs/describe_workspace_authentication/) for full documentation.
#'
...
#' Gets the current configuration string for the given workspace.
#'
#' See [https://paws-r-sdk.com/docs/describe_workspace_configuration/](https://paws-r-sdk.com/docs/describe_workspace_configuration/) for full documentation.
#'
...
#' Removes the Grafana Enterprise license from a workspace.
#'
#' See [https://paws-r-sdk.com/docs/disassociate_license/](https://paws-r-sdk.com/docs/disassociate_license/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_permissions/](https://paws-r-sdk.com/docs/update_permissions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_workspace/](https://paws-r-sdk.com/docs/update_workspace/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_workspace_authentication/](https://paws-r-sdk.com/docs/update_workspace_authentication/) for full documentation.
#'
#' @param authenticationProviders &#91;required&#93; Specifies whether this workspace uses SAML 2.0, IAM Identity Center
#' (successor to Single Sign-On), or both to authenticate users for using
#' the Grafana console within a workspace. For more information, see [User
...
#' Updates the configuration string for the given workspace
#'
#' See [https://paws-r-sdk.com/docs/update_workspace_configuration/](https://paws-r-sdk.com/docs/update_workspace_configuration/) for full documentation.
#'
