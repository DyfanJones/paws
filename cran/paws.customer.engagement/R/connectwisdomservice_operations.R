...
#' Creates an Amazon Connect Wisdom assistant.
#'
#' See [https://paws-r-sdk.com/docs/create_assistant/](https://paws-r-sdk.com/docs/create_assistant/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_assistant_association/](https://paws-r-sdk.com/docs/create_assistant_association/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_content/](https://paws-r-sdk.com/docs/create_content/) for full documentation.
#'
#' @param clientToken A unique, case-sensitive identifier that you provide to ensure the
#' idempotency of the request. If not provided, the Amazon Web Services SDK
#' populates this field. For more information about idempotency, see
...
#' Creates a knowledge base.
#'
#' See [https://paws-r-sdk.com/docs/create_knowledge_base/](https://paws-r-sdk.com/docs/create_knowledge_base/) for full documentation.
#'
#' @param clientToken A unique, case-sensitive identifier that you provide to ensure the
#' idempotency of the request. If not provided, the Amazon Web Services SDK
#' populates this field. For more information about idempotency, see
...
#' Deletes an assistant.
#'
#' See [https://paws-r-sdk.com/docs/delete_assistant/](https://paws-r-sdk.com/docs/delete_assistant/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#'
...
#' Deletes an assistant association.
#'
#' See [https://paws-r-sdk.com/docs/delete_assistant_association/](https://paws-r-sdk.com/docs/delete_assistant_association/) for full documentation.
#'
...
#' Deletes the content.
#'
#' See [https://paws-r-sdk.com/docs/delete_content/](https://paws-r-sdk.com/docs/delete_content/) for full documentation.
#'
...
#' Deletes the knowledge base.
#'
#' See [https://paws-r-sdk.com/docs/delete_knowledge_base/](https://paws-r-sdk.com/docs/delete_knowledge_base/) for full documentation.
#'
...
#' Retrieves information about an assistant.
#'
#' See [https://paws-r-sdk.com/docs/get_assistant/](https://paws-r-sdk.com/docs/get_assistant/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#'
...
#' Retrieves information about an assistant association.
#'
#' See [https://paws-r-sdk.com/docs/get_assistant_association/](https://paws-r-sdk.com/docs/get_assistant_association/) for full documentation.
#'
#' @param assistantAssociationId &#91;required&#93; The identifier of the assistant association. Can be either the ID or the
#' ARN. URLs cannot contain the ARN.
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
...
#' Retrieves content, including a pre-signed URL to download the content.
#'
#' See [https://paws-r-sdk.com/docs/get_content/](https://paws-r-sdk.com/docs/get_content/) for full documentation.
#'
#' @param contentId &#91;required&#93; The identifier of the content. Can be either the ID or the ARN. URLs
#' cannot contain the ARN.
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
...
#' Retrieves summary information about the content.
#'
#' See [https://paws-r-sdk.com/docs/get_content_summary/](https://paws-r-sdk.com/docs/get_content_summary/) for full documentation.
#'
#' @param contentId &#91;required&#93; The identifier of the content. Can be either the ID or the ARN. URLs
#' cannot contain the ARN.
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
...
#' Retrieves information about the knowledge base.
#'
#' See [https://paws-r-sdk.com/docs/get_knowledge_base/](https://paws-r-sdk.com/docs/get_knowledge_base/) for full documentation.
#'
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_recommendations/](https://paws-r-sdk.com/docs/get_recommendations/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
...
#' Lists information about assistant associations.
#'
#' See [https://paws-r-sdk.com/docs/list_assistant_associations/](https://paws-r-sdk.com/docs/list_assistant_associations/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#' @param maxResults The maximum number of results to return per page.
...
#' Lists information about assistants.
#'
#' See [https://paws-r-sdk.com/docs/list_assistants/](https://paws-r-sdk.com/docs/list_assistants/) for full documentation.
#'
#' @param maxResults The maximum number of results to return per page.
#' @param nextToken The token for the next set of results. Use the value returned in the
#' previous response in the next request to retrieve the next set of
...
#' Lists the content.
#'
#' See [https://paws-r-sdk.com/docs/list_contents/](https://paws-r-sdk.com/docs/list_contents/) for full documentation.
#'
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#' @param maxResults The maximum number of results to return per page.
...
#' Lists the knowledge bases.
#'
#' See [https://paws-r-sdk.com/docs/list_knowledge_bases/](https://paws-r-sdk.com/docs/list_knowledge_bases/) for full documentation.
#'
#' @param maxResults The maximum number of results to return per page.
#' @param nextToken The token for the next set of results. Use the value returned in the
#' previous response in the next request to retrieve the next set of
...
#'
#' See [https://paws-r-sdk.com/docs/notify_recommendations_received/](https://paws-r-sdk.com/docs/notify_recommendations_received/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
...
#'
#' See [https://paws-r-sdk.com/docs/query_assistant/](https://paws-r-sdk.com/docs/query_assistant/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#' @param maxResults The maximum number of results to return per page.
...
#' Removes a URI template from a knowledge base.
#'
#' See [https://paws-r-sdk.com/docs/remove_knowledge_base_template_uri/](https://paws-r-sdk.com/docs/remove_knowledge_base_template_uri/) for full documentation.
#'
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/search_content/](https://paws-r-sdk.com/docs/search_content/) for full documentation.
#'
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#' @param maxResults The maximum number of results to return per page.
...
#' Searches for sessions.
#'
#' See [https://paws-r-sdk.com/docs/search_sessions/](https://paws-r-sdk.com/docs/search_sessions/) for full documentation.
#'
#' @param assistantId &#91;required&#93; The identifier of the Wisdom assistant. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
#' @param maxResults The maximum number of results to return per page.
...
#'
#' See [https://paws-r-sdk.com/docs/start_content_upload/](https://paws-r-sdk.com/docs/start_content_upload/) for full documentation.
#'
...
#' Updates information about the content.
#'
#' See [https://paws-r-sdk.com/docs/update_content/](https://paws-r-sdk.com/docs/update_content/) for full documentation.
#'
#' @param contentId &#91;required&#93; The identifier of the content. Can be either the ID or the ARN. URLs
#' cannot contain the ARN.
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN
...
#'
#' See [https://paws-r-sdk.com/docs/update_knowledge_base_template_uri/](https://paws-r-sdk.com/docs/update_knowledge_base_template_uri/) for full documentation.
#'
#' @param knowledgeBaseId &#91;required&#93; The identifier of the knowledge base. Can be either the ID or the ARN.
#' URLs cannot contain the ARN.
