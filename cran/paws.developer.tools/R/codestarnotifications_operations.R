...
#'
#' See [https://paws-r-sdk.com/docs/create_notification_rule/](https://paws-r-sdk.com/docs/create_notification_rule/) for full documentation.
#'
...
#' Deletes a notification rule for a resource.
#'
#' See [https://paws-r-sdk.com/docs/delete_notification_rule/](https://paws-r-sdk.com/docs/delete_notification_rule/) for full documentation.
#'
...
#' Deletes a specified target for notifications.
#'
#' See [https://paws-r-sdk.com/docs/delete_target/](https://paws-r-sdk.com/docs/delete_target/) for full documentation.
#'
...
#' Returns information about a specified notification rule.
#'
#' See [https://paws-r-sdk.com/docs/describe_notification_rule/](https://paws-r-sdk.com/docs/describe_notification_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_event_types/](https://paws-r-sdk.com/docs/list_event_types/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_notification_rules/](https://paws-r-sdk.com/docs/list_notification_rules/) for full documentation.
#'
#' @param Filters The filters to use to return information by service or resource type.
...
#'
#' See [https://paws-r-sdk.com/docs/list_targets/](https://paws-r-sdk.com/docs/list_targets/) for full documentation.
#'
#' @param Filters The filters to use to return information by service or resource type.
...
#'
#' See [https://paws-r-sdk.com/docs/update_notification_rule/](https://paws-r-sdk.com/docs/update_notification_rule/) for full documentation.
#'
#' @param Arn &#91;required&#93; The Amazon Resource Name (ARN) of the notification rule.
