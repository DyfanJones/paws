...
#' Creates a scaling plan.
#'
#' See [https://paws-r-sdk.com/docs/create_scaling_plan/](https://paws-r-sdk.com/docs/create_scaling_plan/) for full documentation.
#'
...
#' Deletes the specified scaling plan.
#'
#' See [https://paws-r-sdk.com/docs/delete_scaling_plan/](https://paws-r-sdk.com/docs/delete_scaling_plan/) for full documentation.
#'
...
#' Describes the scalable resources in the specified scaling plan.
#'
#' See [https://paws-r-sdk.com/docs/describe_scaling_plan_resources/](https://paws-r-sdk.com/docs/describe_scaling_plan_resources/) for full documentation.
#'
#' @param ScalingPlanName &#91;required&#93; The name of the scaling plan.
#' @param ScalingPlanVersion &#91;required&#93; The version number of the scaling plan. Currently, the only valid value
#' is `1`.
...
#' Describes one or more of your scaling plans.
#'
#' See [https://paws-r-sdk.com/docs/describe_scaling_plans/](https://paws-r-sdk.com/docs/describe_scaling_plans/) for full documentation.
#'
...
#' Retrieves the forecast data for a scalable resource.
#'
#' See [https://paws-r-sdk.com/docs/get_scaling_plan_resource_forecast_data/](https://paws-r-sdk.com/docs/get_scaling_plan_resource_forecast_data/) for full documentation.
#'
#' @param ScalingPlanName &#91;required&#93; The name of the scaling plan.
#' @param ScalingPlanVersion &#91;required&#93; The version number of the scaling plan. Currently, the only valid value
#' is `1`.
...
#' Updates the specified scaling plan.
#'
#' See [https://paws-r-sdk.com/docs/update_scaling_plan/](https://paws-r-sdk.com/docs/update_scaling_plan/) for full documentation.
#'
#' @param ScalingPlanName &#91;required&#93; The name of the scaling plan.
