...
#'
#' See [https://paws-r-sdk.com/docs/describe_entities_detection_v2_job/](https://paws-r-sdk.com/docs/describe_entities_detection_v2_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_icd10cm_inference_job/](https://paws-r-sdk.com/docs/describe_icd10cm_inference_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_phi_detection_job/](https://paws-r-sdk.com/docs/describe_phi_detection_job/) for full documentation.
#'
#' @param JobId &#91;required&#93; The identifier that Comprehend Medical; generated for the job. The
...
#'
#' See [https://paws-r-sdk.com/docs/describe_rx_norm_inference_job/](https://paws-r-sdk.com/docs/describe_rx_norm_inference_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_snomedct_inference_job/](https://paws-r-sdk.com/docs/describe_snomedct_inference_job/) for full documentation.
#'
#' @param JobId &#91;required&#93; The identifier that Amazon Comprehend Medical generated for the job. The
...
#'
#' See [https://paws-r-sdk.com/docs/detect_entities_v2/](https://paws-r-sdk.com/docs/detect_entities_v2/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/detect_phi/](https://paws-r-sdk.com/docs/detect_phi/) for full documentation.
#'
#' @param Text &#91;required&#93; A UTF-8 text string containing the clinical content being examined for
...
#'
#' See [https://paws-r-sdk.com/docs/infer_icd10cm/](https://paws-r-sdk.com/docs/infer_icd10cm/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/infer_rx_norm/](https://paws-r-sdk.com/docs/infer_rx_norm/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/infer_snomedct/](https://paws-r-sdk.com/docs/infer_snomedct/) for full documentation.
#'
...
#' Gets a list of medical entity detection jobs that you have submitted.
#'
#' See [https://paws-r-sdk.com/docs/list_entities_detection_v2_jobs/](https://paws-r-sdk.com/docs/list_entities_detection_v2_jobs/) for full documentation.
#'
...
#' Gets a list of InferICD10CM jobs that you have submitted.
#'
#' See [https://paws-r-sdk.com/docs/list_icd10cm_inference_jobs/](https://paws-r-sdk.com/docs/list_icd10cm_inference_jobs/) for full documentation.
#'
#' @param Filter Filters the jobs that are returned. You can filter jobs based on their
#' names, status, or the date and time that they were submitted. You can
#' only set one filter at a time.
...
#'
#' See [https://paws-r-sdk.com/docs/list_phi_detection_jobs/](https://paws-r-sdk.com/docs/list_phi_detection_jobs/) for full documentation.
#'
#' @param Filter Filters the jobs that are returned. You can filter jobs based on their
#' names, status, or the date and time that they were submitted. You can
#' only set one filter at a time.
...
#' Gets a list of InferRxNorm jobs that you have submitted.
#'
#' See [https://paws-r-sdk.com/docs/list_rx_norm_inference_jobs/](https://paws-r-sdk.com/docs/list_rx_norm_inference_jobs/) for full documentation.
#'
#' @param Filter Filters the jobs that are returned. You can filter jobs based on their
#' names, status, or the date and time that they were submitted. You can
#' only set one filter at a time.
...
#' Gets a list of InferSNOMEDCT jobs a user has submitted.
#'
#' See [https://paws-r-sdk.com/docs/list_snomedct_inference_jobs/](https://paws-r-sdk.com/docs/list_snomedct_inference_jobs/) for full documentation.
#'
#' @param Filter 
...
#'
#' See [https://paws-r-sdk.com/docs/start_entities_detection_v2_job/](https://paws-r-sdk.com/docs/start_entities_detection_v2_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_icd10cm_inference_job/](https://paws-r-sdk.com/docs/start_icd10cm_inference_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_phi_detection_job/](https://paws-r-sdk.com/docs/start_phi_detection_job/) for full documentation.
#'
#' @param InputDataConfig &#91;required&#93; Specifies the format and location of the input data for the job.
#' @param OutputDataConfig &#91;required&#93; Specifies where to send the output files.
#' @param DataAccessRoleArn &#91;required&#93; The Amazon Resource Name (ARN) of the AWS Identity and Access Management
...
#'
#' See [https://paws-r-sdk.com/docs/start_rx_norm_inference_job/](https://paws-r-sdk.com/docs/start_rx_norm_inference_job/) for full documentation.
#'
#' @param InputDataConfig &#91;required&#93; Specifies the format and location of the input data for the job.
#' @param OutputDataConfig &#91;required&#93; Specifies where to send the output files.
#' @param DataAccessRoleArn &#91;required&#93; The Amazon Resource Name (ARN) of the AWS Identity and Access Management
...
#'
#' See [https://paws-r-sdk.com/docs/start_snomedct_inference_job/](https://paws-r-sdk.com/docs/start_snomedct_inference_job/) for full documentation.
#'
...
#' Stops a medical entities detection job in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_entities_detection_v2_job/](https://paws-r-sdk.com/docs/stop_entities_detection_v2_job/) for full documentation.
#'
...
#' Stops an InferICD10CM inference job in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_icd10cm_inference_job/](https://paws-r-sdk.com/docs/stop_icd10cm_inference_job/) for full documentation.
#'
...
#' Stops a protected health information (PHI) detection job in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_phi_detection_job/](https://paws-r-sdk.com/docs/stop_phi_detection_job/) for full documentation.
#'
...
#' Stops an InferRxNorm inference job in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_rx_norm_inference_job/](https://paws-r-sdk.com/docs/stop_rx_norm_inference_job/) for full documentation.
#'
#' @param JobId &#91;required&#93; The identifier of the job.
#'
#' @keywords internal
...
#' Stops an InferSNOMEDCT inference job in progress.
#'
#' See [https://paws-r-sdk.com/docs/stop_snomedct_inference_job/](https://paws-r-sdk.com/docs/stop_snomedct_inference_job/) for full documentation.
#'
