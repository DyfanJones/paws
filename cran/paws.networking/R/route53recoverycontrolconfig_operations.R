...
#'
#' See [https://paws-r-sdk.com/docs/create_control_panel/](https://paws-r-sdk.com/docs/create_control_panel/) for full documentation.
#'
#' @param ClientToken A unique, case-sensitive string of up to 64 ASCII characters. To make an
#' idempotent API request with an action, specify a client token in the
#' request.
...
#' Creates a new routing control.
#'
#' See [https://paws-r-sdk.com/docs/create_routing_control/](https://paws-r-sdk.com/docs/create_routing_control/) for full documentation.
#'
#' @param ClientToken A unique, case-sensitive string of up to 64 ASCII characters. To make an
#' idempotent API request with an action, specify a client token in the
#' request.
...
#'
#' See [https://paws-r-sdk.com/docs/create_safety_rule/](https://paws-r-sdk.com/docs/create_safety_rule/) for full documentation.
#'
...
#' Deletes a control panel.
#'
#' See [https://paws-r-sdk.com/docs/delete_control_panel/](https://paws-r-sdk.com/docs/delete_control_panel/) for full documentation.
#'
...
#' Deletes a routing control.
#'
#' See [https://paws-r-sdk.com/docs/delete_routing_control/](https://paws-r-sdk.com/docs/delete_routing_control/) for full documentation.
#'
...
#' Deletes a safety rule.
#'
#' See [https://paws-r-sdk.com/docs/delete_safety_rule/](https://paws-r-sdk.com/docs/delete_safety_rule/) for full documentation.
#'
...
#' Displays details about a control panel.
#'
#' See [https://paws-r-sdk.com/docs/describe_control_panel/](https://paws-r-sdk.com/docs/describe_control_panel/) for full documentation.
#'
#' @param ControlPanelArn &#91;required&#93; The Amazon Resource Name (ARN) of the control panel.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/describe_routing_control/](https://paws-r-sdk.com/docs/describe_routing_control/) for full documentation.
#'
...
#' Returns information about a safety rule.
#'
#' See [https://paws-r-sdk.com/docs/describe_safety_rule/](https://paws-r-sdk.com/docs/describe_safety_rule/) for full documentation.
#'
#' @param SafetyRuleArn &#91;required&#93; The ARN of the safety rule.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/list_associated_route_53_health_checks/](https://paws-r-sdk.com/docs/list_associated_route_53_health_checks/) for full documentation.
#'
...
#' Returns an array of control panels in an account or in a cluster.
#'
#' See [https://paws-r-sdk.com/docs/list_control_panels/](https://paws-r-sdk.com/docs/list_control_panels/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_routing_controls/](https://paws-r-sdk.com/docs/list_routing_controls/) for full documentation.
#'
#' @param ControlPanelArn &#91;required&#93; The Amazon Resource Name (ARN) of the control panel.
#' @param MaxResults The number of objects that you want to return with this call.
#' @param NextToken The token that identifies which batch of results you want to see.
...
#'
#' See [https://paws-r-sdk.com/docs/list_safety_rules/](https://paws-r-sdk.com/docs/list_safety_rules/) for full documentation.
#'
#' @param ControlPanelArn &#91;required&#93; The Amazon Resource Name (ARN) of the control panel.
#' @param MaxResults The number of objects that you want to return with this call.
#' @param NextToken The token that identifies which batch of results you want to see.
...
#'
#' See [https://paws-r-sdk.com/docs/update_control_panel/](https://paws-r-sdk.com/docs/update_control_panel/) for full documentation.
#'
#' @param ControlPanelArn &#91;required&#93; The Amazon Resource Name (ARN) of the control panel.
#' @param ControlPanelName &#91;required&#93; The name of the control panel.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_routing_control/](https://paws-r-sdk.com/docs/update_routing_control/) for full documentation.
#'
#' @param RoutingControlArn &#91;required&#93; The Amazon Resource Name (ARN) of the routing control.
#' @param RoutingControlName &#91;required&#93; The name of the routing control.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_safety_rule/](https://paws-r-sdk.com/docs/update_safety_rule/) for full documentation.
#'
