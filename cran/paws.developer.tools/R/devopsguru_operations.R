...
#'
#' See [https://paws-r-sdk.com/docs/add_notification_channel/](https://paws-r-sdk.com/docs/add_notification_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_account_health/](https://paws-r-sdk.com/docs/describe_account_health/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_account_overview/](https://paws-r-sdk.com/docs/describe_account_overview/) for full documentation.
#'
...
#' Returns details about an anomaly that you specify using its ID.
#'
#' See [https://paws-r-sdk.com/docs/describe_anomaly/](https://paws-r-sdk.com/docs/describe_anomaly/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_event_sources_config/](https://paws-r-sdk.com/docs/describe_event_sources_config/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_feedback/](https://paws-r-sdk.com/docs/describe_feedback/) for full documentation.
#'
...
#' Returns details about an insight that you specify using its ID.
#'
#' See [https://paws-r-sdk.com/docs/describe_insight/](https://paws-r-sdk.com/docs/describe_insight/) for full documentation.
#'
#' @param Id &#91;required&#93; The ID of the insight.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_organization_health/](https://paws-r-sdk.com/docs/describe_organization_health/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_organization_overview/](https://paws-r-sdk.com/docs/describe_organization_overview/) for full documentation.
#'
#' @param FromTime &#91;required&#93; The start of the time range passed in. The start time granularity is at
#' the day level. The floor of the start time is used. Returned information
#' occurred after this day.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_organization_resource_collection_health/](https://paws-r-sdk.com/docs/describe_organization_resource_collection_health/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_resource_collection_health/](https://paws-r-sdk.com/docs/describe_resource_collection_health/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_service_integration/](https://paws-r-sdk.com/docs/describe_service_integration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cost_estimation/](https://paws-r-sdk.com/docs/get_cost_estimation/) for full documentation.
#'
#' @param NextToken The pagination token to use to retrieve the next page of results for
#' this operation. If this value is null, it retrieves the first page.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_resource_collection/](https://paws-r-sdk.com/docs/get_resource_collection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_anomalies_for_insight/](https://paws-r-sdk.com/docs/list_anomalies_for_insight/) for full documentation.
#'
...
#' Returns the list of log groups that contain log anomalies.
#'
#' See [https://paws-r-sdk.com/docs/list_anomalous_log_groups/](https://paws-r-sdk.com/docs/list_anomalous_log_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_events/](https://paws-r-sdk.com/docs/list_events/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_insights/](https://paws-r-sdk.com/docs/list_insights/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_monitored_resources/](https://paws-r-sdk.com/docs/list_monitored_resources/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_notification_channels/](https://paws-r-sdk.com/docs/list_notification_channels/) for full documentation.
#'
#' @param NextToken The pagination token to use to retrieve the next page of results for
#' this operation. If this value is null, it retrieves the first page.
#'
...
#' Returns a list of insights associated with the account or OU Id.
#'
#' See [https://paws-r-sdk.com/docs/list_organization_insights/](https://paws-r-sdk.com/docs/list_organization_insights/) for full documentation.
#'
...
#' Collects customer feedback about the specified insight.
#'
#' See [https://paws-r-sdk.com/docs/put_feedback/](https://paws-r-sdk.com/docs/put_feedback/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/remove_notification_channel/](https://paws-r-sdk.com/docs/remove_notification_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/search_insights/](https://paws-r-sdk.com/docs/search_insights/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/search_organization_insights/](https://paws-r-sdk.com/docs/search_organization_insights/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_cost_estimation/](https://paws-r-sdk.com/docs/start_cost_estimation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_event_sources_config/](https://paws-r-sdk.com/docs/update_event_sources_config/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_resource_collection/](https://paws-r-sdk.com/docs/update_resource_collection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_service_integration/](https://paws-r-sdk.com/docs/update_service_integration/) for full documentation.
#'
