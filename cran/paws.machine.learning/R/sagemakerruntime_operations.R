...
#'
#' See [https://paws-r-sdk.com/docs/invoke_endpoint/](https://paws-r-sdk.com/docs/invoke_endpoint/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/invoke_endpoint_async/](https://paws-r-sdk.com/docs/invoke_endpoint_async/) for full documentation.
#'
#' @param EndpointName &#91;required&#93; The name of the endpoint that you specified when you created the
#' endpoint using the
#' [`CreateEndpoint`](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_CreateEndpoint.html)
