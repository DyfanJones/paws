...
#'   imageTagMutability, imageTagMutabilityExclusionFilters,
...
#'   imageTagMutabilityExclusionFilters, repositoryPolicy, lifecyclePolicy,
#'   appliedFor, customRoleArn)
#'
...
#'
#' @aliases ecr_create_repository_creation_template
...
#'
#' @aliases ecr_delete_repository_creation_template
...
#'
#' @usage
#' ecr_delete_signing_configuration()
#'
...
#' @section Request syntax:
#' ```
#' svc$delete_signing_configuration()
#' ```
#'
#' @keywords internal
#'
...
#'
#' @aliases ecr_delete_signing_configuration
...
#'
#' @aliases ecr_deregister_pull_time_update_exclusion
...
#'
#' @aliases ecr_describe_image_signing_status
...
#'       lastArchivedAt = as.POSIXct(
#'         "2015-01-01"
#'       ),
#'       lastActivatedAt = as.POSIXct(
#'         "2015-01-01"
#'       )
#'     )
#'   ),
...
#'
#' @aliases ecr_describe_repository_creation_templates
...
#'
#' @aliases ecr_get_account_setting
...
#'
#' @aliases ecr_get_signing_configuration
...
#'
#' @aliases ecr_list_image_referrers
...
#' Lists all the image IDs for the specified repository.
#' 
#' You can filter images based on whether or not they are tagged by using the `tagStatus` filter and specifying either `TAGGED`, `UNTAGGED` or `ANY`. For example, you can filter your results to return only `UNTAGGED` images and then pipe that result to a [`batch_delete_image`][ecr_batch_delete_image] operation to delete them. Or, you can filter your results to return only `TAGGED` images to list all of the tags in your repository.
#'
#' @usage
...
#'
#' @aliases ecr_list_pull_time_update_exclusions
...
#'
#' @aliases ecr_put_account_setting
...
#' 
#' When configuring cross-account replication, the destination account must grant the source account permission to replicate. This permission is controlled using a registry permissions policy. For more information, see [`put_registry_policy`][ecr_put_registry_policy].
#'
#' @usage
...
#'
#' @usage
#' ecr_put_signing_configuration(signingConfiguration)
#'
...
#'
#' @aliases ecr_put_signing_configuration
...
#'
#' @aliases ecr_register_pull_time_update_exclusion
...
#'
#' @aliases ecr_update_image_storage_class
...
#'
#' @usage
#' ecr_update_pull_through_cache_rule(registryId, ecrRepositoryPrefix,
#'   credentialArn, customRoleArn)
#'
...
#' @section Request syntax:
#' ```
#' svc$update_pull_through_cache_rule(
#'   registryId = "string",
#'   ecrRepositoryPrefix = "string",
#'   credentialArn = "string",
#'   customRoleArn = "string"
...
#'
#' @aliases ecr_update_pull_through_cache_rule
...
#'
#' @aliases ecr_update_repository_creation_template
...
#'
#' @usage
#' ecr_validate_pull_through_cache_rule(ecrRepositoryPrefix, registryId)
#'
...
#' @section Request syntax:
#' ```
#' svc$validate_pull_through_cache_rule(
#'   ecrRepositoryPrefix = "string",
#'   registryId = "string"
#' )
#' ```
...
#'
#' @aliases ecr_validate_pull_through_cache_rule
