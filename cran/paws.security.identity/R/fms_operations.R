...
#'
#' See [https://paws-r-sdk.com/docs/associate_admin_account/](https://paws-r-sdk.com/docs/associate_admin_account/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/associate_third_party_firewall/](https://paws-r-sdk.com/docs/associate_third_party_firewall/) for full documentation.
#'
...
#' Associate resources to a Firewall Manager resource set.
#'
#' See [https://paws-r-sdk.com/docs/batch_associate_resource/](https://paws-r-sdk.com/docs/batch_associate_resource/) for full documentation.
#'
...
#' Disassociates resources from a Firewall Manager resource set.
#'
#' See [https://paws-r-sdk.com/docs/batch_disassociate_resource/](https://paws-r-sdk.com/docs/batch_disassociate_resource/) for full documentation.
#'
#' @param ResourceSetIdentifier &#91;required&#93; A unique identifier for the resource set, used in a request to refer to
#' the resource set.
...
#' Permanently deletes an Firewall Manager applications list.
#'
#' See [https://paws-r-sdk.com/docs/delete_apps_list/](https://paws-r-sdk.com/docs/delete_apps_list/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_notification_channel/](https://paws-r-sdk.com/docs/delete_notification_channel/) for full documentation.
#'
#' @keywords internal
#'
...
#' Permanently deletes an Firewall Manager protocols list.
#'
#' See [https://paws-r-sdk.com/docs/delete_protocols_list/](https://paws-r-sdk.com/docs/delete_protocols_list/) for full documentation.
#'
...
#' Deletes the specified ResourceSet.
#'
#' See [https://paws-r-sdk.com/docs/delete_resource_set/](https://paws-r-sdk.com/docs/delete_resource_set/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_admin_account/](https://paws-r-sdk.com/docs/disassociate_admin_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_third_party_firewall/](https://paws-r-sdk.com/docs/disassociate_third_party_firewall/) for full documentation.
#'
#' @param ThirdPartyFirewall &#91;required&#93; The name of the third-party firewall vendor.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_admin_account/](https://paws-r-sdk.com/docs/get_admin_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_admin_scope/](https://paws-r-sdk.com/docs/get_admin_scope/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_apps_list/](https://paws-r-sdk.com/docs/get_apps_list/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_compliance_detail/](https://paws-r-sdk.com/docs/get_compliance_detail/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_notification_channel/](https://paws-r-sdk.com/docs/get_notification_channel/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_protection_status/](https://paws-r-sdk.com/docs/get_protection_status/) for full documentation.
#'
...
#' Returns information about the specified Firewall Manager protocols list.
#'
#' See [https://paws-r-sdk.com/docs/get_protocols_list/](https://paws-r-sdk.com/docs/get_protocols_list/) for full documentation.
#'
...
#' Gets information about a specific resource set.
#'
#' See [https://paws-r-sdk.com/docs/get_resource_set/](https://paws-r-sdk.com/docs/get_resource_set/) for full documentation.
#'
#' @param Identifier &#91;required&#93; A unique identifier for the resource set, used in a request to refer to
#' the resource set.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_third_party_firewall_association_status/](https://paws-r-sdk.com/docs/get_third_party_firewall_association_status/) for full documentation.
#'
#' @param ThirdPartyFirewall &#91;required&#93; The name of the third-party firewall vendor.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_violation_details/](https://paws-r-sdk.com/docs/get_violation_details/) for full documentation.
#'
#' @param PolicyId &#91;required&#93; The ID of the Firewall Manager policy that you want the details for.
...
#'
#' See [https://paws-r-sdk.com/docs/list_admin_accounts_for_organization/](https://paws-r-sdk.com/docs/list_admin_accounts_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_admins_managing_account/](https://paws-r-sdk.com/docs/list_admins_managing_account/) for full documentation.
#'
#' @param NextToken When you request a list of objects with a `MaxResults` setting, if the
#' number of objects that are still available for retrieval exceeds the
#' maximum you requested, Firewall Manager returns a `NextToken` value in
...
#' Returns an array of `AppsListDataSummary` objects.
#'
#' See [https://paws-r-sdk.com/docs/list_apps_lists/](https://paws-r-sdk.com/docs/list_apps_lists/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_compliance_status/](https://paws-r-sdk.com/docs/list_compliance_status/) for full documentation.
#'
#' @param PolicyId &#91;required&#93; The ID of the Firewall Manager policy that you want the details for.
...
#'
#' See [https://paws-r-sdk.com/docs/list_member_accounts/](https://paws-r-sdk.com/docs/list_member_accounts/) for full documentation.
#'
...
#' Returns an array of `ProtocolsListDataSummary` objects.
#'
#' See [https://paws-r-sdk.com/docs/list_protocols_lists/](https://paws-r-sdk.com/docs/list_protocols_lists/) for full documentation.
#'
#' @param DefaultLists Specifies whether the lists to retrieve are default lists owned by
#' Firewall Manager.
#' @param NextToken If you specify a value for `MaxResults` in your list request, and you
...
#'
#' See [https://paws-r-sdk.com/docs/list_resource_set_resources/](https://paws-r-sdk.com/docs/list_resource_set_resources/) for full documentation.
#'
#' @param Identifier &#91;required&#93; A unique identifier for the resource set, used in a request to refer to
#' the resource set.
#' @param MaxResults The maximum number of objects that you want Firewall Manager to return
...
#' Returns an array of `ResourceSetSummary` objects.
#'
#' See [https://paws-r-sdk.com/docs/list_resource_sets/](https://paws-r-sdk.com/docs/list_resource_sets/) for full documentation.
#'
#' @param NextToken When you request a list of objects with a `MaxResults` setting, if the
#' number of objects that are still available for retrieval exceeds the
#' maximum you requested, Firewall Manager returns a `NextToken` value in
...
#'
#' See [https://paws-r-sdk.com/docs/list_third_party_firewall_firewall_policies/](https://paws-r-sdk.com/docs/list_third_party_firewall_firewall_policies/) for full documentation.
#'
#' @param ThirdPartyFirewall &#91;required&#93; The name of the third-party firewall vendor.
...
#'
#' See [https://paws-r-sdk.com/docs/put_admin_account/](https://paws-r-sdk.com/docs/put_admin_account/) for full documentation.
#'
...
#' Creates an Firewall Manager applications list.
#'
#' See [https://paws-r-sdk.com/docs/put_apps_list/](https://paws-r-sdk.com/docs/put_apps_list/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_notification_channel/](https://paws-r-sdk.com/docs/put_notification_channel/) for full documentation.
#'
...
#' Creates an Firewall Manager policy.
#'
#' See [https://paws-r-sdk.com/docs/put_policy/](https://paws-r-sdk.com/docs/put_policy/) for full documentation.
#'
...
#' Creates an Firewall Manager protocols list.
#'
#' See [https://paws-r-sdk.com/docs/put_protocols_list/](https://paws-r-sdk.com/docs/put_protocols_list/) for full documentation.
#'
...
#' Creates the resource set.
#'
#' See [https://paws-r-sdk.com/docs/put_resource_set/](https://paws-r-sdk.com/docs/put_resource_set/) for full documentation.
#'
