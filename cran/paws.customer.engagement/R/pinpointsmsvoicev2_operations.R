...
#' Associates the specified origination identity with a pool.
#'
#' See [https://paws-r-sdk.com/docs/associate_origination_identity/](https://paws-r-sdk.com/docs/associate_origination_identity/) for full documentation.
#'
...
#' Creates a new event destination in a configuration set.
#'
#' See [https://paws-r-sdk.com/docs/create_event_destination/](https://paws-r-sdk.com/docs/create_event_destination/) for full documentation.
#'
...
#' Creates a new opt-out list.
#'
#' See [https://paws-r-sdk.com/docs/create_opt_out_list/](https://paws-r-sdk.com/docs/create_opt_out_list/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_pool/](https://paws-r-sdk.com/docs/create_pool/) for full documentation.
#'
...
#' Deletes an existing default message type on a configuration set.
#'
#' See [https://paws-r-sdk.com/docs/delete_default_message_type/](https://paws-r-sdk.com/docs/delete_default_message_type/) for full documentation.
#'
...
#' Deletes an existing default sender ID on a configuration set.
#'
#' See [https://paws-r-sdk.com/docs/delete_default_sender_id/](https://paws-r-sdk.com/docs/delete_default_sender_id/) for full documentation.
#'
#' @param ConfigurationSetName &#91;required&#93; The name of the configuration set or the configuration set Amazon
...
#' Deletes an existing event destination.
#'
#' See [https://paws-r-sdk.com/docs/delete_event_destination/](https://paws-r-sdk.com/docs/delete_event_destination/) for full documentation.
#'
...
#' Deletes an existing keyword from an origination phone number or pool.
#'
#' See [https://paws-r-sdk.com/docs/delete_keyword/](https://paws-r-sdk.com/docs/delete_keyword/) for full documentation.
#'
#' @param OriginationIdentity &#91;required&#93; The origination identity to use such as a PhoneNumberId, PhoneNumberArn,
...
#'
#' See [https://paws-r-sdk.com/docs/delete_opt_out_list/](https://paws-r-sdk.com/docs/delete_opt_out_list/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_opted_out_number/](https://paws-r-sdk.com/docs/delete_opted_out_number/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_pool/](https://paws-r-sdk.com/docs/delete_pool/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_text_message_spend_limit_override/](https://paws-r-sdk.com/docs/delete_text_message_spend_limit_override/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_voice_message_spend_limit_override/](https://paws-r-sdk.com/docs/delete_voice_message_spend_limit_override/) for full documentation.
#'
#' @keywords internal
#'
...
#' Describes the specified configuration sets or all in your account.
#'
#' See [https://paws-r-sdk.com/docs/describe_configuration_sets/](https://paws-r-sdk.com/docs/describe_configuration_sets/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_keywords/](https://paws-r-sdk.com/docs/describe_keywords/) for full documentation.
#'
#' @param OriginationIdentity &#91;required&#93; The origination identity to use such as a PhoneNumberId, PhoneNumberArn,
#' SenderId or SenderIdArn. You can use
#' [`describe_phone_numbers`][pinpointsmsvoicev2_describe_phone_numbers] to
...
#'
#' See [https://paws-r-sdk.com/docs/describe_opt_out_lists/](https://paws-r-sdk.com/docs/describe_opt_out_lists/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_opted_out_numbers/](https://paws-r-sdk.com/docs/describe_opted_out_numbers/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_phone_numbers/](https://paws-r-sdk.com/docs/describe_phone_numbers/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_pools/](https://paws-r-sdk.com/docs/describe_pools/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_sender_ids/](https://paws-r-sdk.com/docs/describe_sender_ids/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_spend_limits/](https://paws-r-sdk.com/docs/describe_spend_limits/) for full documentation.
#'
#' @param NextToken The token to be used for the next set of paginated results. You don't
#' need to supply a value for this field in the initial request.
#' @param MaxResults The maximum number of results to return per each request.
...
#' Removes the specified origination identity from an existing pool.
#'
#' See [https://paws-r-sdk.com/docs/disassociate_origination_identity/](https://paws-r-sdk.com/docs/disassociate_origination_identity/) for full documentation.
#'
...
#' Lists all associated origination identities in your pool.
#'
#' See [https://paws-r-sdk.com/docs/list_pool_origination_identities/](https://paws-r-sdk.com/docs/list_pool_origination_identities/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_keyword/](https://paws-r-sdk.com/docs/put_keyword/) for full documentation.
#'
#' @param OriginationIdentity &#91;required&#93; The origination identity to use such as a PhoneNumberId, PhoneNumberArn,
#' SenderId or SenderIdArn. You can use
#' [`describe_phone_numbers`][pinpointsmsvoicev2_describe_phone_numbers]
...
#' Creates an opted out destination phone number in the opt-out list.
#'
#' See [https://paws-r-sdk.com/docs/put_opted_out_number/](https://paws-r-sdk.com/docs/put_opted_out_number/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/request_phone_number/](https://paws-r-sdk.com/docs/request_phone_number/) for full documentation.
#'
#' @param IsoCountryCode &#91;required&#93; The two-character code, in ISO 3166-1 alpha-2 format, for the country or
#' region.
#' @param MessageType &#91;required&#93; The type of message. Valid values are TRANSACTIONAL for messages that
...
#' Creates a new text message and sends it to a recipient's phone number.
#'
#' See [https://paws-r-sdk.com/docs/send_text_message/](https://paws-r-sdk.com/docs/send_text_message/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/send_voice_message/](https://paws-r-sdk.com/docs/send_voice_message/) for full documentation.
#'
#' @param DestinationPhoneNumber &#91;required&#93; The destination phone number in E.164 format.
...
#' Sets the default message type on a configuration set.
#'
#' See [https://paws-r-sdk.com/docs/set_default_message_type/](https://paws-r-sdk.com/docs/set_default_message_type/) for full documentation.
#'
...
#' Sets default sender ID on a configuration set.
#'
#' See [https://paws-r-sdk.com/docs/set_default_sender_id/](https://paws-r-sdk.com/docs/set_default_sender_id/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_text_message_spend_limit_override/](https://paws-r-sdk.com/docs/set_text_message_spend_limit_override/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_voice_message_spend_limit_override/](https://paws-r-sdk.com/docs/set_voice_message_spend_limit_override/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_event_destination/](https://paws-r-sdk.com/docs/update_event_destination/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_pool/](https://paws-r-sdk.com/docs/update_pool/) for full documentation.
#'
