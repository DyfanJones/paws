...
#' Adds an instance fleet to a running cluster.
#'
#' See [https://paws-r-sdk.com/docs/add_instance_fleet/](https://paws-r-sdk.com/docs/add_instance_fleet/) for full documentation.
#'
...
#' Adds one or more instance groups to a running cluster.
#'
#' See [https://paws-r-sdk.com/docs/add_instance_groups/](https://paws-r-sdk.com/docs/add_instance_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/add_job_flow_steps/](https://paws-r-sdk.com/docs/add_job_flow_steps/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/cancel_steps/](https://paws-r-sdk.com/docs/cancel_steps/) for full documentation.
#'
...
#' Creates a new Amazon EMR Studio.
#'
#' See [https://paws-r-sdk.com/docs/create_studio/](https://paws-r-sdk.com/docs/create_studio/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_studio_session_mapping/](https://paws-r-sdk.com/docs/create_studio_session_mapping/) for full documentation.
#'
...
#' Removes an Amazon EMR Studio from the Studio metadata store.
#'
#' See [https://paws-r-sdk.com/docs/delete_studio/](https://paws-r-sdk.com/docs/delete_studio/) for full documentation.
#'
...
#' Removes a user or group from an Amazon EMR Studio.
#'
#' See [https://paws-r-sdk.com/docs/delete_studio_session_mapping/](https://paws-r-sdk.com/docs/delete_studio_session_mapping/) for full documentation.
#'
#' @param StudioId &#91;required&#93; The ID of the Amazon EMR Studio.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_cluster/](https://paws-r-sdk.com/docs/describe_cluster/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_job_flows/](https://paws-r-sdk.com/docs/describe_job_flows/) for full documentation.
#'
...
#' Provides details of a notebook execution.
#'
#' See [https://paws-r-sdk.com/docs/describe_notebook_execution/](https://paws-r-sdk.com/docs/describe_notebook_execution/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_release_label/](https://paws-r-sdk.com/docs/describe_release_label/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_security_configuration/](https://paws-r-sdk.com/docs/describe_security_configuration/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the security configuration.
#'
#' @keywords internal
...
#' Provides more detail about the cluster step.
#'
#' See [https://paws-r-sdk.com/docs/describe_step/](https://paws-r-sdk.com/docs/describe_step/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_studio/](https://paws-r-sdk.com/docs/describe_studio/) for full documentation.
#'
...
#' Returns the auto-termination policy for an Amazon EMR cluster.
#'
#' See [https://paws-r-sdk.com/docs/get_auto_termination_policy/](https://paws-r-sdk.com/docs/get_auto_termination_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_block_public_access_configuration/](https://paws-r-sdk.com/docs/get_block_public_access_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cluster_session_credentials/](https://paws-r-sdk.com/docs/get_cluster_session_credentials/) for full documentation.
#'
#' @param ClusterId &#91;required&#93; The unique identifier of the cluster.
...
#' Fetches the attached managed scaling policy for an Amazon EMR cluster.
#'
#' See [https://paws-r-sdk.com/docs/get_managed_scaling_policy/](https://paws-r-sdk.com/docs/get_managed_scaling_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_studio_session_mapping/](https://paws-r-sdk.com/docs/get_studio_session_mapping/) for full documentation.
#'
#' @param StudioId &#91;required&#93; The ID of the Amazon EMR Studio.
...
#'
#' See [https://paws-r-sdk.com/docs/list_bootstrap_actions/](https://paws-r-sdk.com/docs/list_bootstrap_actions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_clusters/](https://paws-r-sdk.com/docs/list_clusters/) for full documentation.
#'
...
#' Lists all available details about the instance fleets in a cluster.
#'
#' See [https://paws-r-sdk.com/docs/list_instance_fleets/](https://paws-r-sdk.com/docs/list_instance_fleets/) for full documentation.
#'
#' @param ClusterId &#91;required&#93; The unique identifier of the cluster.
#' @param Marker The pagination token that indicates the next set of results to retrieve.
#'
...
#' Provides all available details about the instance groups in a cluster.
#'
#' See [https://paws-r-sdk.com/docs/list_instance_groups/](https://paws-r-sdk.com/docs/list_instance_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_notebook_executions/](https://paws-r-sdk.com/docs/list_notebook_executions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_release_labels/](https://paws-r-sdk.com/docs/list_release_labels/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_security_configurations/](https://paws-r-sdk.com/docs/list_security_configurations/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_steps/](https://paws-r-sdk.com/docs/list_steps/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_studio_session_mappings/](https://paws-r-sdk.com/docs/list_studio_session_mappings/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_studios/](https://paws-r-sdk.com/docs/list_studios/) for full documentation.
#'
#' @param Marker The pagination token that indicates the set of results to retrieve.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/modify_instance_fleet/](https://paws-r-sdk.com/docs/modify_instance_fleet/) for full documentation.
#'
#' @param ClusterId &#91;required&#93; The unique identifier of the cluster.
...
#'
#' See [https://paws-r-sdk.com/docs/modify_instance_groups/](https://paws-r-sdk.com/docs/modify_instance_groups/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_auto_scaling_policy/](https://paws-r-sdk.com/docs/put_auto_scaling_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_auto_termination_policy/](https://paws-r-sdk.com/docs/put_auto_termination_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_block_public_access_configuration/](https://paws-r-sdk.com/docs/put_block_public_access_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_managed_scaling_policy/](https://paws-r-sdk.com/docs/put_managed_scaling_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/remove_auto_scaling_policy/](https://paws-r-sdk.com/docs/remove_auto_scaling_policy/) for full documentation.
#'
#' @param ClusterId &#91;required&#93; Specifies the ID of a cluster. The instance group to which the automatic
#' scaling policy is applied is within this cluster.
...
#' Removes an auto-termination policy from an Amazon EMR cluster.
#'
#' See [https://paws-r-sdk.com/docs/remove_auto_termination_policy/](https://paws-r-sdk.com/docs/remove_auto_termination_policy/) for full documentation.
#'
...
#' Removes a managed scaling policy from a specified Amazon EMR cluster.
#'
#' See [https://paws-r-sdk.com/docs/remove_managed_scaling_policy/](https://paws-r-sdk.com/docs/remove_managed_scaling_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/run_job_flow/](https://paws-r-sdk.com/docs/run_job_flow/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_termination_protection/](https://paws-r-sdk.com/docs/set_termination_protection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_visible_to_all_users/](https://paws-r-sdk.com/docs/set_visible_to_all_users/) for full documentation.
#'
...
#' Starts a notebook execution.
#'
#' See [https://paws-r-sdk.com/docs/start_notebook_execution/](https://paws-r-sdk.com/docs/start_notebook_execution/) for full documentation.
#'
...
#' Stops a notebook execution.
#'
#' See [https://paws-r-sdk.com/docs/stop_notebook_execution/](https://paws-r-sdk.com/docs/stop_notebook_execution/) for full documentation.
#'
#' @param NotebookExecutionId &#91;required&#93; The unique identifier of the notebook execution.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/terminate_job_flows/](https://paws-r-sdk.com/docs/terminate_job_flows/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_studio/](https://paws-r-sdk.com/docs/update_studio/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_studio_session_mapping/](https://paws-r-sdk.com/docs/update_studio_session_mapping/) for full documentation.
#'
#' @param StudioId &#91;required&#93; The ID of the Amazon EMR Studio.
#' @param IdentityId The globally unique identifier (GUID) of the user or group. For more
#' information, see
