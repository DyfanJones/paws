...
#'
#' See [https://paws-r-sdk.com/docs/accept_invitation/](https://paws-r-sdk.com/docs/accept_invitation/) for full documentation.
#'
...
#' Retrieves information about one or more custom data identifiers.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_custom_data_identifiers/](https://paws-r-sdk.com/docs/batch_get_custom_data_identifiers/) for full documentation.
#'
...
#' Creates and defines the settings for an allow list.
#'
#' See [https://paws-r-sdk.com/docs/create_allow_list/](https://paws-r-sdk.com/docs/create_allow_list/) for full documentation.
#'
...
#' Creates and defines the settings for a classification job.
#'
#' See [https://paws-r-sdk.com/docs/create_classification_job/](https://paws-r-sdk.com/docs/create_classification_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_custom_data_identifier/](https://paws-r-sdk.com/docs/create_custom_data_identifier/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_findings_filter/](https://paws-r-sdk.com/docs/create_findings_filter/) for full documentation.
#'
...
#' Sends an Amazon Macie membership invitation to one or more accounts.
#'
#' See [https://paws-r-sdk.com/docs/create_invitations/](https://paws-r-sdk.com/docs/create_invitations/) for full documentation.
#'
...
#' Associates an account with an Amazon Macie administrator account.
#'
#' See [https://paws-r-sdk.com/docs/create_member/](https://paws-r-sdk.com/docs/create_member/) for full documentation.
#'
...
#' Creates sample findings.
#'
#' See [https://paws-r-sdk.com/docs/create_sample_findings/](https://paws-r-sdk.com/docs/create_sample_findings/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/decline_invitations/](https://paws-r-sdk.com/docs/decline_invitations/) for full documentation.
#'
#' @param accountIds &#91;required&#93; An array that lists Amazon Web Services account IDs, one for each
...
#' Deletes an allow list.
#'
#' See [https://paws-r-sdk.com/docs/delete_allow_list/](https://paws-r-sdk.com/docs/delete_allow_list/) for full documentation.
#'
...
#' Soft deletes a custom data identifier.
#'
#' See [https://paws-r-sdk.com/docs/delete_custom_data_identifier/](https://paws-r-sdk.com/docs/delete_custom_data_identifier/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#' Deletes a findings filter.
#'
#' See [https://paws-r-sdk.com/docs/delete_findings_filter/](https://paws-r-sdk.com/docs/delete_findings_filter/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_invitations/](https://paws-r-sdk.com/docs/delete_invitations/) for full documentation.
#'
#' @param accountIds &#91;required&#93; An array that lists Amazon Web Services account IDs, one for each
...
#'
#' See [https://paws-r-sdk.com/docs/delete_member/](https://paws-r-sdk.com/docs/delete_member/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_buckets/](https://paws-r-sdk.com/docs/describe_buckets/) for full documentation.
#'
...
#' Retrieves the status and settings for a classification job.
#'
#' See [https://paws-r-sdk.com/docs/describe_classification_job/](https://paws-r-sdk.com/docs/describe_classification_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_organization_configuration/](https://paws-r-sdk.com/docs/describe_organization_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disable_macie/](https://paws-r-sdk.com/docs/disable_macie/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disable_organization_admin_account/](https://paws-r-sdk.com/docs/disable_organization_admin_account/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_from_administrator_account/](https://paws-r-sdk.com/docs/disassociate_from_administrator_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_from_master_account/](https://paws-r-sdk.com/docs/disassociate_from_master_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_member/](https://paws-r-sdk.com/docs/disassociate_member/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/enable_macie/](https://paws-r-sdk.com/docs/enable_macie/) for full documentation.
#'
#' @param clientToken A unique, case-sensitive token that you provide to ensure the
#' idempotency of the request.
...
#'
#' See [https://paws-r-sdk.com/docs/enable_organization_admin_account/](https://paws-r-sdk.com/docs/enable_organization_admin_account/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_administrator_account/](https://paws-r-sdk.com/docs/get_administrator_account/) for full documentation.
#'
#' @keywords internal
#'
...
#' Retrieves the settings and status of an allow list.
#'
#' See [https://paws-r-sdk.com/docs/get_allow_list/](https://paws-r-sdk.com/docs/get_allow_list/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_automated_discovery_configuration/](https://paws-r-sdk.com/docs/get_automated_discovery_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_bucket_statistics/](https://paws-r-sdk.com/docs/get_bucket_statistics/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_classification_export_configuration/](https://paws-r-sdk.com/docs/get_classification_export_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#' Retrieves the classification scope settings for an account.
#'
#' See [https://paws-r-sdk.com/docs/get_classification_scope/](https://paws-r-sdk.com/docs/get_classification_scope/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#' Retrieves the criteria and other settings for a custom data identifier.
#'
#' See [https://paws-r-sdk.com/docs/get_custom_data_identifier/](https://paws-r-sdk.com/docs/get_custom_data_identifier/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#' Retrieves (queries) aggregated statistical data about findings.
#'
#' See [https://paws-r-sdk.com/docs/get_finding_statistics/](https://paws-r-sdk.com/docs/get_finding_statistics/) for full documentation.
#'
...
#' Retrieves the details of one or more findings.
#'
#' See [https://paws-r-sdk.com/docs/get_findings/](https://paws-r-sdk.com/docs/get_findings/) for full documentation.
#'
...
#' Retrieves the criteria and other settings for a findings filter.
#'
#' See [https://paws-r-sdk.com/docs/get_findings_filter/](https://paws-r-sdk.com/docs/get_findings_filter/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_findings_publication_configuration/](https://paws-r-sdk.com/docs/get_findings_publication_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_invitations_count/](https://paws-r-sdk.com/docs/get_invitations_count/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_macie_session/](https://paws-r-sdk.com/docs/get_macie_session/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_master_account/](https://paws-r-sdk.com/docs/get_master_account/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_member/](https://paws-r-sdk.com/docs/get_member/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_resource_profile/](https://paws-r-sdk.com/docs/get_resource_profile/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_reveal_configuration/](https://paws-r-sdk.com/docs/get_reveal_configuration/) for full documentation.
#'
#' @keywords internal
#'
...
#' Retrieves occurrences of sensitive data reported by a finding.
#'
#' See [https://paws-r-sdk.com/docs/get_sensitive_data_occurrences/](https://paws-r-sdk.com/docs/get_sensitive_data_occurrences/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_sensitive_data_occurrences_availability/](https://paws-r-sdk.com/docs/get_sensitive_data_occurrences_availability/) for full documentation.
#'
#' @param findingId &#91;required&#93; The unique identifier for the finding.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_sensitivity_inspection_template/](https://paws-r-sdk.com/docs/get_sensitivity_inspection_template/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_usage_statistics/](https://paws-r-sdk.com/docs/get_usage_statistics/) for full documentation.
#'
...
#' Retrieves (queries) aggregated usage data for an account.
#'
#' See [https://paws-r-sdk.com/docs/get_usage_totals/](https://paws-r-sdk.com/docs/get_usage_totals/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_allow_lists/](https://paws-r-sdk.com/docs/list_allow_lists/) for full documentation.
#'
...
#' Retrieves a subset of information about one or more classification jobs.
#'
#' See [https://paws-r-sdk.com/docs/list_classification_jobs/](https://paws-r-sdk.com/docs/list_classification_jobs/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_classification_scopes/](https://paws-r-sdk.com/docs/list_classification_scopes/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_custom_data_identifiers/](https://paws-r-sdk.com/docs/list_custom_data_identifiers/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of the response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
#' paginated response.
...
#' Retrieves a subset of information about one or more findings.
#'
#' See [https://paws-r-sdk.com/docs/list_findings/](https://paws-r-sdk.com/docs/list_findings/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_findings_filters/](https://paws-r-sdk.com/docs/list_findings_filters/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/list_invitations/](https://paws-r-sdk.com/docs/list_invitations/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/list_managed_data_identifiers/](https://paws-r-sdk.com/docs/list_managed_data_identifiers/) for full documentation.
#'
#' @param nextToken The nextToken string that specifies which page of results to return in a
#' paginated response.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_members/](https://paws-r-sdk.com/docs/list_members/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/list_organization_admin_accounts/](https://paws-r-sdk.com/docs/list_organization_admin_accounts/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/list_resource_profile_artifacts/](https://paws-r-sdk.com/docs/list_resource_profile_artifacts/) for full documentation.
#'
#' @param nextToken The nextToken string that specifies which page of results to return in a
#' paginated response.
#' @param resourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the S3 bucket that the request applies
...
#'
#' See [https://paws-r-sdk.com/docs/list_resource_profile_detections/](https://paws-r-sdk.com/docs/list_resource_profile_detections/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/list_sensitivity_inspection_templates/](https://paws-r-sdk.com/docs/list_sensitivity_inspection_templates/) for full documentation.
#'
#' @param maxResults The maximum number of items to include in each page of a paginated
#' response.
#' @param nextToken The nextToken string that specifies which page of results to return in a
...
#'
#' See [https://paws-r-sdk.com/docs/put_classification_export_configuration/](https://paws-r-sdk.com/docs/put_classification_export_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_findings_publication_configuration/](https://paws-r-sdk.com/docs/put_findings_publication_configuration/) for full documentation.
#'
#' @param clientToken A unique, case-sensitive token that you provide to ensure the
#' idempotency of the request.
...
#'
#' See [https://paws-r-sdk.com/docs/search_resources/](https://paws-r-sdk.com/docs/search_resources/) for full documentation.
#'
...
#' Tests a custom data identifier.
#'
#' See [https://paws-r-sdk.com/docs/test_custom_data_identifier/](https://paws-r-sdk.com/docs/test_custom_data_identifier/) for full documentation.
#'
#' @param ignoreWords An array that lists specific character sequences (*ignore words*) to
#' exclude from the results. If the text matched by the regular expression
#' contains any string in this array, Amazon Macie ignores it. The array
...
#' Updates the settings for an allow list.
#'
#' See [https://paws-r-sdk.com/docs/update_allow_list/](https://paws-r-sdk.com/docs/update_allow_list/) for full documentation.
#'
#' @param criteria &#91;required&#93; The criteria that specify the text or text pattern to ignore. The
#' criteria can be the location and name of an S3 object that lists
...
#' Enables or disables automated sensitive data discovery for an account.
#'
#' See [https://paws-r-sdk.com/docs/update_automated_discovery_configuration/](https://paws-r-sdk.com/docs/update_automated_discovery_configuration/) for full documentation.
#'
...
#' Changes the status of a classification job.
#'
#' See [https://paws-r-sdk.com/docs/update_classification_job/](https://paws-r-sdk.com/docs/update_classification_job/) for full documentation.
#'
#' @param jobId &#91;required&#93; The unique identifier for the classification job.
...
#' Updates the classification scope settings for an account.
#'
#' See [https://paws-r-sdk.com/docs/update_classification_scope/](https://paws-r-sdk.com/docs/update_classification_scope/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
...
#' Updates the criteria and other settings for a findings filter.
#'
#' See [https://paws-r-sdk.com/docs/update_findings_filter/](https://paws-r-sdk.com/docs/update_findings_filter/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_macie_session/](https://paws-r-sdk.com/docs/update_macie_session/) for full documentation.
#'
#' @param findingPublishingFrequency Specifies how often to publish updates to policy findings for the
#' account. This includes publishing updates to Security Hub and Amazon
#' EventBridge (formerly Amazon CloudWatch Events).
...
#'
#' See [https://paws-r-sdk.com/docs/update_member_session/](https://paws-r-sdk.com/docs/update_member_session/) for full documentation.
#'
#' @param id &#91;required&#93; The unique identifier for the Amazon Macie resource that the request
#' applies to.
...
#'
#' See [https://paws-r-sdk.com/docs/update_organization_configuration/](https://paws-r-sdk.com/docs/update_organization_configuration/) for full documentation.
#'
...
#' Updates the sensitivity score for an S3 bucket.
#'
#' See [https://paws-r-sdk.com/docs/update_resource_profile/](https://paws-r-sdk.com/docs/update_resource_profile/) for full documentation.
#'
#' @param resourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the S3 bucket that the request applies
#' to.
...
#' Updates the sensitivity scoring settings for an S3 bucket.
#'
#' See [https://paws-r-sdk.com/docs/update_resource_profile_detections/](https://paws-r-sdk.com/docs/update_resource_profile_detections/) for full documentation.
#'
#' @param resourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the S3 bucket that the request applies
#' to.
...
#'
#' See [https://paws-r-sdk.com/docs/update_reveal_configuration/](https://paws-r-sdk.com/docs/update_reveal_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_sensitivity_inspection_template/](https://paws-r-sdk.com/docs/update_sensitivity_inspection_template/) for full documentation.
#'
