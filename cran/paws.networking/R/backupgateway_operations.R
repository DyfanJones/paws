...
#'
#' See [https://paws-r-sdk.com/docs/associate_gateway_to_server/](https://paws-r-sdk.com/docs/associate_gateway_to_server/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_gateway/](https://paws-r-sdk.com/docs/create_gateway/) for full documentation.
#'
...
#' Deletes a hypervisor.
#'
#' See [https://paws-r-sdk.com/docs/delete_hypervisor/](https://paws-r-sdk.com/docs/delete_hypervisor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_gateway_from_server/](https://paws-r-sdk.com/docs/disassociate_gateway_from_server/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_bandwidth_rate_limit_schedule/](https://paws-r-sdk.com/docs/get_bandwidth_rate_limit_schedule/) for full documentation.
#'
#' @param GatewayArn &#91;required&#93; The Amazon Resource Name (ARN) of the gateway. Use the
...
#'
#' See [https://paws-r-sdk.com/docs/get_gateway/](https://paws-r-sdk.com/docs/get_gateway/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_hypervisor/](https://paws-r-sdk.com/docs/get_hypervisor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_hypervisor_property_mappings/](https://paws-r-sdk.com/docs/get_hypervisor_property_mappings/) for full documentation.
#'
#' @param HypervisorArn &#91;required&#93; The Amazon Resource Name (ARN) of the hypervisor.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_virtual_machine/](https://paws-r-sdk.com/docs/get_virtual_machine/) for full documentation.
#'
...
#' Connect to a hypervisor by importing its configuration.
#'
#' See [https://paws-r-sdk.com/docs/import_hypervisor_configuration/](https://paws-r-sdk.com/docs/import_hypervisor_configuration/) for full documentation.
#'
...
#' Lists your hypervisors.
#'
#' See [https://paws-r-sdk.com/docs/list_hypervisors/](https://paws-r-sdk.com/docs/list_hypervisors/) for full documentation.
#'
...
#' Lists your virtual machines.
#'
#' See [https://paws-r-sdk.com/docs/list_virtual_machines/](https://paws-r-sdk.com/docs/list_virtual_machines/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_bandwidth_rate_limit_schedule/](https://paws-r-sdk.com/docs/put_bandwidth_rate_limit_schedule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_hypervisor_property_mappings/](https://paws-r-sdk.com/docs/put_hypervisor_property_mappings/) for full documentation.
#'
#' @param HypervisorArn &#91;required&#93; The Amazon Resource Name (ARN) of the hypervisor.
...
#' Set the maintenance start time for a gateway.
#'
#' See [https://paws-r-sdk.com/docs/put_maintenance_start_time/](https://paws-r-sdk.com/docs/put_maintenance_start_time/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_virtual_machines_metadata_sync/](https://paws-r-sdk.com/docs/start_virtual_machines_metadata_sync/) for full documentation.
#'
#' @param HypervisorArn &#91;required&#93; The Amazon Resource Name (ARN) of the hypervisor.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/test_hypervisor_configuration/](https://paws-r-sdk.com/docs/test_hypervisor_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_hypervisor/](https://paws-r-sdk.com/docs/update_hypervisor/) for full documentation.
#'
