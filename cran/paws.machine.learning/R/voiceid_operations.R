...
#'
#' See [https://paws-r-sdk.com/docs/associate_fraudster/](https://paws-r-sdk.com/docs/associate_fraudster/) for full documentation.
#'
...
#' Creates a watchlist that fraudsters can be a part of.
#'
#' See [https://paws-r-sdk.com/docs/create_watchlist/](https://paws-r-sdk.com/docs/create_watchlist/) for full documentation.
#'
#' @param ClientToken A unique, case-sensitive identifier that you provide to ensure the
#' idempotency of the request. If not provided, the Amazon Web Services SDK
#' populates this field. For more information about idempotency, see
...
#'
#' See [https://paws-r-sdk.com/docs/delete_fraudster/](https://paws-r-sdk.com/docs/delete_fraudster/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the fraudster.
...
#' Deletes the specified speaker from Voice ID.
#'
#' See [https://paws-r-sdk.com/docs/delete_speaker/](https://paws-r-sdk.com/docs/delete_speaker/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_watchlist/](https://paws-r-sdk.com/docs/delete_watchlist/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the watchlist.
...
#' Describes the specified fraudster.
#'
#' See [https://paws-r-sdk.com/docs/describe_fraudster/](https://paws-r-sdk.com/docs/describe_fraudster/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the fraudster.
...
#' Describes the specified fraudster registration job.
#'
#' See [https://paws-r-sdk.com/docs/describe_fraudster_registration_job/](https://paws-r-sdk.com/docs/describe_fraudster_registration_job/) for full documentation.
#'
...
#' Describes the specified speaker.
#'
#' See [https://paws-r-sdk.com/docs/describe_speaker/](https://paws-r-sdk.com/docs/describe_speaker/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the speaker.
...
#' Describes the specified speaker enrollment job.
#'
#' See [https://paws-r-sdk.com/docs/describe_speaker_enrollment_job/](https://paws-r-sdk.com/docs/describe_speaker_enrollment_job/) for full documentation.
#'
...
#' Describes the specified watchlist.
#'
#' See [https://paws-r-sdk.com/docs/describe_watchlist/](https://paws-r-sdk.com/docs/describe_watchlist/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the watchlist.
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_fraudster/](https://paws-r-sdk.com/docs/disassociate_fraudster/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the fraudster.
...
#'
#' See [https://paws-r-sdk.com/docs/evaluate_session/](https://paws-r-sdk.com/docs/evaluate_session/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_fraudster_registration_jobs/](https://paws-r-sdk.com/docs/list_fraudster_registration_jobs/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the fraudster registration
#' Jobs.
...
#' Lists all fraudsters in a specified watchlist or domain.
#'
#' See [https://paws-r-sdk.com/docs/list_fraudsters/](https://paws-r-sdk.com/docs/list_fraudsters/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_speaker_enrollment_jobs/](https://paws-r-sdk.com/docs/list_speaker_enrollment_jobs/) for full documentation.
#'
...
#' Lists all speakers in a specified domain.
#'
#' See [https://paws-r-sdk.com/docs/list_speakers/](https://paws-r-sdk.com/docs/list_speakers/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain.
#' @param MaxResults The maximum number of results that are returned per call. You can use
#' `NextToken` to obtain more pages of results. The default is 100; the
...
#' Lists all watchlists in a specified domain.
#'
#' See [https://paws-r-sdk.com/docs/list_watchlists/](https://paws-r-sdk.com/docs/list_watchlists/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain.
#' @param MaxResults The maximum number of results that are returned per call. You can use
#' `NextToken` to obtain more pages of results. The default is 100; the
...
#'
#' See [https://paws-r-sdk.com/docs/opt_out_speaker/](https://paws-r-sdk.com/docs/opt_out_speaker/) for full documentation.
#'
#' @param DomainId &#91;required&#93; The identifier of the domain that contains the speaker.
...
#' Starts a new batch fraudster registration job using provided details.
#'
#' See [https://paws-r-sdk.com/docs/start_fraudster_registration_job/](https://paws-r-sdk.com/docs/start_fraudster_registration_job/) for full documentation.
#'
#' @param ClientToken A unique, case-sensitive identifier that you provide to ensure the
#' idempotency of the request. If not provided, the Amazon Web Services SDK
#' populates this field. For more information about idempotency, see
...
#' Starts a new batch speaker enrollment job using specified details.
#'
#' See [https://paws-r-sdk.com/docs/start_speaker_enrollment_job/](https://paws-r-sdk.com/docs/start_speaker_enrollment_job/) for full documentation.
#'
#' @param ClientToken A unique, case-sensitive identifier that you provide to ensure the
#' idempotency of the request. If not provided, the Amazon Web Services SDK
#' populates this field. For more information about idempotency, see
...
#'
#' See [https://paws-r-sdk.com/docs/update_watchlist/](https://paws-r-sdk.com/docs/update_watchlist/) for full documentation.
#'
