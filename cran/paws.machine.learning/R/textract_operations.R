...
#' Analyzes an input document for relationships between detected items.
#'
#' See [https://paws-r-sdk.com/docs/analyze_document/](https://paws-r-sdk.com/docs/analyze_document/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/analyze_expense/](https://paws-r-sdk.com/docs/analyze_expense/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/analyze_id/](https://paws-r-sdk.com/docs/analyze_id/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/detect_document_text/](https://paws-r-sdk.com/docs/detect_document_text/) for full documentation.
#'
#' @param Document &#91;required&#93; The input document as base64-encoded bytes or an Amazon S3 object. If
#' you use the AWS CLI to call Amazon Textract operations, you can't pass
...
#'
#' See [https://paws-r-sdk.com/docs/get_document_analysis/](https://paws-r-sdk.com/docs/get_document_analysis/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_document_text_detection/](https://paws-r-sdk.com/docs/get_document_text_detection/) for full documentation.
#'
#' @param JobId &#91;required&#93; A unique identifier for the text detection job. The `JobId` is returned
#' from
...
#'
#' See [https://paws-r-sdk.com/docs/get_expense_analysis/](https://paws-r-sdk.com/docs/get_expense_analysis/) for full documentation.
#'
#' @param JobId &#91;required&#93; A unique identifier for the text detection job. The `JobId` is returned
...
#'
#' See [https://paws-r-sdk.com/docs/get_lending_analysis/](https://paws-r-sdk.com/docs/get_lending_analysis/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_lending_analysis_summary/](https://paws-r-sdk.com/docs/get_lending_analysis_summary/) for full documentation.
#'
#' @param JobId &#91;required&#93; A unique identifier for the lending or text-detection job. The `JobId`
...
#'
#' See [https://paws-r-sdk.com/docs/start_document_analysis/](https://paws-r-sdk.com/docs/start_document_analysis/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_document_text_detection/](https://paws-r-sdk.com/docs/start_document_text_detection/) for full documentation.
#'
#' @param DocumentLocation &#91;required&#93; The location of the document to be processed.
...
#'
#' See [https://paws-r-sdk.com/docs/start_expense_analysis/](https://paws-r-sdk.com/docs/start_expense_analysis/) for full documentation.
#'
#' @param DocumentLocation &#91;required&#93; The location of the document to be processed.
#' @param ClientRequestToken The idempotent token that's used to identify the start request. If you
#' use the same token with multiple
...
#'
#' See [https://paws-r-sdk.com/docs/start_lending_analysis/](https://paws-r-sdk.com/docs/start_lending_analysis/) for full documentation.
#'
