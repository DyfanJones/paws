...
#'
#' @aliases docdbelastic_apply_pending_maintenance_action
...
#'
#' @usage
#' docdbelastic_copy_cluster_snapshot(copyTags, kmsKeyId, snapshotArn,
#'   tags, targetSnapshotName)
#'
...
#'
#' @aliases docdbelastic_copy_cluster_snapshot
...
#'   backupRetentionPeriod, clientToken, clusterName, kmsKeyId,
#'   preferredBackupWindow, preferredMaintenanceWindow, shardCapacity,
#'   shardCount, shardInstanceCount, subnetIds, tags, vpcSecurityGroupIds)
#'
...
#'
#' @aliases docdbelastic_get_pending_maintenance_action
...
#'
#' @aliases docdbelastic_list_pending_maintenance_actions
...
#'
#' @aliases docdbelastic_start_cluster
...
#'
#' @aliases docdbelastic_stop_cluster
