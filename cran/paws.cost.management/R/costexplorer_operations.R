...
#'
#' See [https://paws-r-sdk.com/docs/create_anomaly_monitor/](https://paws-r-sdk.com/docs/create_anomaly_monitor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_anomaly_subscription/](https://paws-r-sdk.com/docs/create_anomaly_subscription/) for full documentation.
#'
...
#' Creates a new Cost Category with the requested name and rules.
#'
#' See [https://paws-r-sdk.com/docs/create_cost_category_definition/](https://paws-r-sdk.com/docs/create_cost_category_definition/) for full documentation.
#'
#' @param Name &#91;required&#93; 
...
#' Deletes a cost anomaly monitor.
#'
#' See [https://paws-r-sdk.com/docs/delete_anomaly_monitor/](https://paws-r-sdk.com/docs/delete_anomaly_monitor/) for full documentation.
#'
...
#' Deletes a cost anomaly subscription.
#'
#' See [https://paws-r-sdk.com/docs/delete_anomaly_subscription/](https://paws-r-sdk.com/docs/delete_anomaly_subscription/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_cost_category_definition/](https://paws-r-sdk.com/docs/delete_cost_category_definition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_cost_category_definition/](https://paws-r-sdk.com/docs/describe_cost_category_definition/) for full documentation.
#'
#' @param CostCategoryArn &#91;required&#93; The unique identifier for your Cost Category.
...
#'
#' See [https://paws-r-sdk.com/docs/get_anomalies/](https://paws-r-sdk.com/docs/get_anomalies/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_anomaly_monitors/](https://paws-r-sdk.com/docs/get_anomaly_monitors/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_anomaly_subscriptions/](https://paws-r-sdk.com/docs/get_anomaly_subscriptions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cost_and_usage/](https://paws-r-sdk.com/docs/get_cost_and_usage/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cost_and_usage_with_resources/](https://paws-r-sdk.com/docs/get_cost_and_usage_with_resources/) for full documentation.
#'
...
#' Retrieves an array of Cost Category names and values incurred cost.
#'
#' See [https://paws-r-sdk.com/docs/get_cost_categories/](https://paws-r-sdk.com/docs/get_cost_categories/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_cost_forecast/](https://paws-r-sdk.com/docs/get_cost_forecast/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_dimension_values/](https://paws-r-sdk.com/docs/get_dimension_values/) for full documentation.
#'
#' @param SearchString The value that you want to search the filter values for.
...
#'
#' See [https://paws-r-sdk.com/docs/get_reservation_coverage/](https://paws-r-sdk.com/docs/get_reservation_coverage/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_reservation_purchase_recommendation/](https://paws-r-sdk.com/docs/get_reservation_purchase_recommendation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_reservation_utilization/](https://paws-r-sdk.com/docs/get_reservation_utilization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_rightsizing_recommendation/](https://paws-r-sdk.com/docs/get_rightsizing_recommendation/) for full documentation.
#'
#' @param Filter 
...
#'
#' See [https://paws-r-sdk.com/docs/get_savings_plans_coverage/](https://paws-r-sdk.com/docs/get_savings_plans_coverage/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_savings_plans_purchase_recommendation/](https://paws-r-sdk.com/docs/get_savings_plans_purchase_recommendation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_savings_plans_utilization/](https://paws-r-sdk.com/docs/get_savings_plans_utilization/) for full documentation.
#'
#' @param TimePeriod &#91;required&#93; The time period that you want the usage and costs for. The `Start` date
#' must be within 13 months. The `End` date must be after the `Start` date,
#' and before the current date. Future dates can't be used as an `End`
...
#'
#' See [https://paws-r-sdk.com/docs/get_savings_plans_utilization_details/](https://paws-r-sdk.com/docs/get_savings_plans_utilization_details/) for full documentation.
#'
#' @param TimePeriod &#91;required&#93; The time period that you want the usage and costs for. The `Start` date
#' must be within 13 months. The `End` date must be after the `Start` date,
#' and before the current date. Future dates can't be used as an `End`
...
#'
#' See [https://paws-r-sdk.com/docs/get_usage_forecast/](https://paws-r-sdk.com/docs/get_usage_forecast/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_cost_allocation_tags/](https://paws-r-sdk.com/docs/list_cost_allocation_tags/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_cost_category_definitions/](https://paws-r-sdk.com/docs/list_cost_category_definitions/) for full documentation.
#'
#' @param EffectiveOn The date when the Cost Category was effective.
#' @param NextToken The token to retrieve the next set of results. Amazon Web Services
#' provides the token when the response from a previous call has more
...
#'
#' See [https://paws-r-sdk.com/docs/list_savings_plans_purchase_recommendation_generation/](https://paws-r-sdk.com/docs/list_savings_plans_purchase_recommendation_generation/) for full documentation.
#'
...
#' Modifies the feedback property of a given cost anomaly.
#'
#' See [https://paws-r-sdk.com/docs/provide_anomaly_feedback/](https://paws-r-sdk.com/docs/provide_anomaly_feedback/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_savings_plans_purchase_recommendation_generation/](https://paws-r-sdk.com/docs/start_savings_plans_purchase_recommendation_generation/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_anomaly_monitor/](https://paws-r-sdk.com/docs/update_anomaly_monitor/) for full documentation.
#'
...
#' Updates an existing cost anomaly monitor subscription.
#'
#' See [https://paws-r-sdk.com/docs/update_anomaly_subscription/](https://paws-r-sdk.com/docs/update_anomaly_subscription/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_cost_allocation_tags_status/](https://paws-r-sdk.com/docs/update_cost_allocation_tags_status/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_cost_category_definition/](https://paws-r-sdk.com/docs/update_cost_category_definition/) for full documentation.
#'
#' @param CostCategoryArn &#91;required&#93; The unique identifier for your Cost Category.
#' @param EffectiveStart The Cost Category's effective start date. It can only be a billing start
#' date (first day of the month). If the date isn't provided, it's the
