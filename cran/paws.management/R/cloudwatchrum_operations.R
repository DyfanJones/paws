...
#'
#' See [https://paws-r-sdk.com/docs/batch_create_rum_metric_definitions/](https://paws-r-sdk.com/docs/batch_create_rum_metric_definitions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_rum_metric_definitions/](https://paws-r-sdk.com/docs/batch_delete_rum_metric_definitions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_rum_metric_definitions/](https://paws-r-sdk.com/docs/batch_get_rum_metric_definitions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_app_monitor/](https://paws-r-sdk.com/docs/create_app_monitor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_app_monitor/](https://paws-r-sdk.com/docs/delete_app_monitor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_rum_metrics_destination/](https://paws-r-sdk.com/docs/delete_rum_metrics_destination/) for full documentation.
#'
...
#' Retrieves the complete configuration information for one app monitor.
#'
#' See [https://paws-r-sdk.com/docs/get_app_monitor/](https://paws-r-sdk.com/docs/get_app_monitor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_app_monitor_data/](https://paws-r-sdk.com/docs/get_app_monitor_data/) for full documentation.
#'
...
#' Returns a list of the Amazon CloudWatch RUM app monitors in the account.
#'
#' See [https://paws-r-sdk.com/docs/list_app_monitors/](https://paws-r-sdk.com/docs/list_app_monitors/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in one operation. The default is
#' 50. The maximum that you can specify is 100.
#' @param NextToken Use the token returned by the previous operation to request the next
...
#'
#' See [https://paws-r-sdk.com/docs/list_rum_metrics_destinations/](https://paws-r-sdk.com/docs/list_rum_metrics_destinations/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_rum_events/](https://paws-r-sdk.com/docs/put_rum_events/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_rum_metrics_destination/](https://paws-r-sdk.com/docs/put_rum_metrics_destination/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_app_monitor/](https://paws-r-sdk.com/docs/update_app_monitor/) for full documentation.
#'
#' @param AppMonitorConfiguration A structure that contains much of the configuration data for the app
#' monitor. If you are using Amazon Cognito for authorization, you must
#' include this structure in your request, and it must include the ID of
...
#'
#' See [https://paws-r-sdk.com/docs/update_rum_metric_definition/](https://paws-r-sdk.com/docs/update_rum_metric_definition/) for full documentation.
#'
