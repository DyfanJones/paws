...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/create_hapg/](https://paws-r-sdk.com/docs/create_hapg/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/create_hsm/](https://paws-r-sdk.com/docs/create_hsm/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/create_luna_client/](https://paws-r-sdk.com/docs/create_luna_client/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/delete_hapg/](https://paws-r-sdk.com/docs/delete_hapg/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/delete_hsm/](https://paws-r-sdk.com/docs/delete_hsm/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/delete_luna_client/](https://paws-r-sdk.com/docs/delete_luna_client/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/describe_hapg/](https://paws-r-sdk.com/docs/describe_hapg/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/describe_hsm/](https://paws-r-sdk.com/docs/describe_hsm/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/describe_luna_client/](https://paws-r-sdk.com/docs/describe_luna_client/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/get_config/](https://paws-r-sdk.com/docs/get_config/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/list_available_zones/](https://paws-r-sdk.com/docs/list_available_zones/) for full documentation.
#'
#' @keywords internal
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/list_hapgs/](https://paws-r-sdk.com/docs/list_hapgs/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/list_hsms/](https://paws-r-sdk.com/docs/list_hsms/) for full documentation.
#'
#' @param NextToken The `NextToken` value from a previous call to
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/list_luna_clients/](https://paws-r-sdk.com/docs/list_luna_clients/) for full documentation.
#'
#' @param NextToken The `NextToken` value from a previous call to
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/modify_hapg/](https://paws-r-sdk.com/docs/modify_hapg/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/modify_hsm/](https://paws-r-sdk.com/docs/modify_hsm/) for full documentation.
#'
...
#' This is documentation for **AWS CloudHSM Classic**. For more information, see [AWS CloudHSM Classic FAQs](https://aws.amazon.com/cloudhsm/faqs/), the AWS CloudHSM Classic User Guide, and the [AWS CloudHSM Classic API Reference](https://docs.aws.amazon.com/cloudhsm/classic/APIReference/).
#'
#' See [https://paws-r-sdk.com/docs/modify_luna_client/](https://paws-r-sdk.com/docs/modify_luna_client/) for full documentation.
#'
#' @param ClientArn &#91;required&#93; The ARN of the client.
