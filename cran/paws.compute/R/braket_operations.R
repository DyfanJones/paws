...
#' Cancels the specified task.
#'
#' See [https://paws-r-sdk.com/docs/cancel_quantum_task/](https://paws-r-sdk.com/docs/cancel_quantum_task/) for full documentation.
#'
...
#' Creates a quantum task.
#'
#' See [https://paws-r-sdk.com/docs/create_quantum_task/](https://paws-r-sdk.com/docs/create_quantum_task/) for full documentation.
#'
...
#' Retrieves the specified quantum task.
#'
#' See [https://paws-r-sdk.com/docs/get_quantum_task/](https://paws-r-sdk.com/docs/get_quantum_task/) for full documentation.
#'
...
#' Searches for devices using the specified filters.
#'
#' See [https://paws-r-sdk.com/docs/search_devices/](https://paws-r-sdk.com/docs/search_devices/) for full documentation.
#'
...
#' Searches for Amazon Braket jobs that match the specified filter values.
#'
#' See [https://paws-r-sdk.com/docs/search_jobs/](https://paws-r-sdk.com/docs/search_jobs/) for full documentation.
#'
...
#' Searches for tasks that match the specified filter values.
#'
#' See [https://paws-r-sdk.com/docs/search_quantum_tasks/](https://paws-r-sdk.com/docs/search_quantum_tasks/) for full documentation.
#'
