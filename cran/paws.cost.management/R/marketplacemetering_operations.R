...
#'
#' See [https://paws-r-sdk.com/docs/batch_meter_usage/](https://paws-r-sdk.com/docs/batch_meter_usage/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/meter_usage/](https://paws-r-sdk.com/docs/meter_usage/) for full documentation.
#'
#' @param ProductCode &#91;required&#93; Product code is used to uniquely identify a product in AWS Marketplace.
#' The product code should be the same as the one used during the
#' publishing of a new product.
...
#'
#' See [https://paws-r-sdk.com/docs/register_usage/](https://paws-r-sdk.com/docs/register_usage/) for full documentation.
#'
#' @param ProductCode &#91;required&#93; Product code is used to uniquely identify a product in AWS Marketplace.
#' The product code should be the same as the one used during the
#' publishing of a new product.
...
#'
#' See [https://paws-r-sdk.com/docs/resolve_customer/](https://paws-r-sdk.com/docs/resolve_customer/) for full documentation.
#'
