...
#'
#' See [https://paws-r-sdk.com/docs/associate_attribute_group/](https://paws-r-sdk.com/docs/associate_attribute_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/associate_resource/](https://paws-r-sdk.com/docs/associate_resource/) for full documentation.
#'
#' @param application &#91;required&#93; The name, ID, or ARN of the application.
...
#'
#' See [https://paws-r-sdk.com/docs/create_attribute_group/](https://paws-r-sdk.com/docs/create_attribute_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_attribute_group/](https://paws-r-sdk.com/docs/delete_attribute_group/) for full documentation.
#'
#' @param attributeGroup &#91;required&#93; The name, ID, or ARN of the attribute group that holds the attributes to
#' describe the application.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_attribute_group/](https://paws-r-sdk.com/docs/disassociate_attribute_group/) for full documentation.
#'
#' @param application &#91;required&#93; The name, ID, or ARN of the application.
#' @param attributeGroup &#91;required&#93; The name, ID, or ARN of the attribute group that holds the attributes to
#' describe the application.
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_resource/](https://paws-r-sdk.com/docs/disassociate_resource/) for full documentation.
#'
...
#' Gets the resource associated with the application.
#'
#' See [https://paws-r-sdk.com/docs/get_associated_resource/](https://paws-r-sdk.com/docs/get_associated_resource/) for full documentation.
#'
#' @param application &#91;required&#93; The name, ID, or ARN of the application.
...
#'
#' See [https://paws-r-sdk.com/docs/get_attribute_group/](https://paws-r-sdk.com/docs/get_attribute_group/) for full documentation.
#'
#' @param attributeGroup &#91;required&#93; The name, ID, or ARN of the attribute group that holds the attributes to
#' describe the application.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_associated_attribute_groups/](https://paws-r-sdk.com/docs/list_associated_attribute_groups/) for full documentation.
#'
#' @param application &#91;required&#93; The name or ID of the application.
#' @param nextToken The token to use to get the next page of results after a previous API
#' call.
...
#'
#' See [https://paws-r-sdk.com/docs/list_associated_resources/](https://paws-r-sdk.com/docs/list_associated_resources/) for full documentation.
#'
#' @param application &#91;required&#93; The name, ID, or ARN of the application.
#' @param nextToken The token to use to get the next page of results after a previous API
#' call.
...
#'
#' See [https://paws-r-sdk.com/docs/list_attribute_groups/](https://paws-r-sdk.com/docs/list_attribute_groups/) for full documentation.
#'
#' @param nextToken The token to use to get the next page of results after a previous API
#' call.
#' @param maxResults The upper bound of the number of results to return (cannot exceed 25).
...
#'
#' See [https://paws-r-sdk.com/docs/list_attribute_groups_for_application/](https://paws-r-sdk.com/docs/list_attribute_groups_for_application/) for full documentation.
#'
#' @param application &#91;required&#93; The name or ID of the application.
...
#' Associates a `TagKey` configuration to an account.
#'
#' See [https://paws-r-sdk.com/docs/put_configuration/](https://paws-r-sdk.com/docs/put_configuration/) for full documentation.
#'
...
#' Syncs the resource with current AppRegistry records.
#'
#' See [https://paws-r-sdk.com/docs/sync_resource/](https://paws-r-sdk.com/docs/sync_resource/) for full documentation.
#'
#' @param resourceType &#91;required&#93; The type of resource of which the application will be associated.
...
#' Updates an existing attribute group with new details.
#'
#' See [https://paws-r-sdk.com/docs/update_attribute_group/](https://paws-r-sdk.com/docs/update_attribute_group/) for full documentation.
#'
#' @param attributeGroup &#91;required&#93; The name, ID, or ARN of the attribute group that holds the attributes to
#' describe the application.
