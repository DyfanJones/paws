...
#' Creates a Data Store that can ingest and export FHIR formatted data.
#'
#' See [https://paws-r-sdk.com/docs/create_fhir_datastore/](https://paws-r-sdk.com/docs/create_fhir_datastore/) for full documentation.
#'
...
#' Deletes a Data Store.
#'
#' See [https://paws-r-sdk.com/docs/delete_fhir_datastore/](https://paws-r-sdk.com/docs/delete_fhir_datastore/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_fhir_datastore/](https://paws-r-sdk.com/docs/describe_fhir_datastore/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_fhir_export_job/](https://paws-r-sdk.com/docs/describe_fhir_export_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_fhir_import_job/](https://paws-r-sdk.com/docs/describe_fhir_import_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_fhir_datastores/](https://paws-r-sdk.com/docs/list_fhir_datastores/) for full documentation.
#'
...
#' Lists all FHIR export jobs associated with an account and their statuses.
#'
#' See [https://paws-r-sdk.com/docs/list_fhir_export_jobs/](https://paws-r-sdk.com/docs/list_fhir_export_jobs/) for full documentation.
#'
...
#' Lists all FHIR import jobs associated with an account and their statuses.
#'
#' See [https://paws-r-sdk.com/docs/list_fhir_import_jobs/](https://paws-r-sdk.com/docs/list_fhir_import_jobs/) for full documentation.
#'
...
#' Begins a FHIR export job.
#'
#' See [https://paws-r-sdk.com/docs/start_fhir_export_job/](https://paws-r-sdk.com/docs/start_fhir_export_job/) for full documentation.
#'
...
#' Begins a FHIR Import job.
#'
#' See [https://paws-r-sdk.com/docs/start_fhir_import_job/](https://paws-r-sdk.com/docs/start_fhir_import_job/) for full documentation.
#'
