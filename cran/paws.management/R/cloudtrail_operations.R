...
#'
#' See [https://paws-r-sdk.com/docs/cancel_query/](https://paws-r-sdk.com/docs/cancel_query/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_channel/](https://paws-r-sdk.com/docs/create_channel/) for full documentation.
#'
...
#' Creates a new event data store.
#'
#' See [https://paws-r-sdk.com/docs/create_event_data_store/](https://paws-r-sdk.com/docs/create_event_data_store/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_trail/](https://paws-r-sdk.com/docs/create_trail/) for full documentation.
#'
...
#' Deletes a channel.
#'
#' See [https://paws-r-sdk.com/docs/delete_channel/](https://paws-r-sdk.com/docs/delete_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_event_data_store/](https://paws-r-sdk.com/docs/delete_event_data_store/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_trail/](https://paws-r-sdk.com/docs/delete_trail/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/deregister_organization_delegated_admin/](https://paws-r-sdk.com/docs/deregister_organization_delegated_admin/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_query/](https://paws-r-sdk.com/docs/describe_query/) for full documentation.
#'
#' @param EventDataStore The ARN (or the ID suffix of the ARN) of an event data store on which
...
#'
#' See [https://paws-r-sdk.com/docs/describe_trails/](https://paws-r-sdk.com/docs/describe_trails/) for full documentation.
#'
...
#' Returns information about a specific channel.
#'
#' See [https://paws-r-sdk.com/docs/get_channel/](https://paws-r-sdk.com/docs/get_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_event_data_store/](https://paws-r-sdk.com/docs/get_event_data_store/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_event_selectors/](https://paws-r-sdk.com/docs/get_event_selectors/) for full documentation.
#'
...
#' Returns information about a specific import.
#'
#' See [https://paws-r-sdk.com/docs/get_import/](https://paws-r-sdk.com/docs/get_import/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_insight_selectors/](https://paws-r-sdk.com/docs/get_insight_selectors/) for full documentation.
#'
#' @param TrailName &#91;required&#93; Specifies the name of the trail or trail ARN. If you specify a trail
#' name, the string must meet the following requirements:
#' 
...
#' Returns settings information for a specified trail.
#'
#' See [https://paws-r-sdk.com/docs/get_trail/](https://paws-r-sdk.com/docs/get_trail/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_trail_status/](https://paws-r-sdk.com/docs/get_trail_status/) for full documentation.
#'
...
#' Lists the channels in the current account, and their source names.
#'
#' See [https://paws-r-sdk.com/docs/list_channels/](https://paws-r-sdk.com/docs/list_channels/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_event_data_stores/](https://paws-r-sdk.com/docs/list_event_data_stores/) for full documentation.
#'
...
#' Returns a list of failures for the specified import.
#'
#' See [https://paws-r-sdk.com/docs/list_import_failures/](https://paws-r-sdk.com/docs/list_import_failures/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_queries/](https://paws-r-sdk.com/docs/list_queries/) for full documentation.
#'
...
#' Lists trails that are in the current account.
#'
#' See [https://paws-r-sdk.com/docs/list_trails/](https://paws-r-sdk.com/docs/list_trails/) for full documentation.
#'
#' @param NextToken The token to use to get the next page of results after a previous API
#' call. This token must be passed in with the same parameters that were
#' specified in the original call. For example, if the original call
...
#'
#' See [https://paws-r-sdk.com/docs/lookup_events/](https://paws-r-sdk.com/docs/lookup_events/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_event_selectors/](https://paws-r-sdk.com/docs/put_event_selectors/) for full documentation.
#'
#' @param TrailName &#91;required&#93; Specifies the name of the trail or trail ARN. If you specify a trail
#' name, the string must meet the following requirements:
#' 
...
#'
#' See [https://paws-r-sdk.com/docs/put_insight_selectors/](https://paws-r-sdk.com/docs/put_insight_selectors/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/register_organization_delegated_admin/](https://paws-r-sdk.com/docs/register_organization_delegated_admin/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/restore_event_data_store/](https://paws-r-sdk.com/docs/restore_event_data_store/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_event_data_store_ingestion/](https://paws-r-sdk.com/docs/start_event_data_store_ingestion/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_logging/](https://paws-r-sdk.com/docs/start_logging/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/stop_event_data_store_ingestion/](https://paws-r-sdk.com/docs/stop_event_data_store_ingestion/) for full documentation.
#'
#' @param EventDataStore &#91;required&#93; The ARN (or ID suffix of the ARN) of the event data store for which you
...
#' Stops a specified import.
#'
#' See [https://paws-r-sdk.com/docs/stop_import/](https://paws-r-sdk.com/docs/stop_import/) for full documentation.
#'
#' @param ImportId &#91;required&#93; The ID of the import.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/stop_logging/](https://paws-r-sdk.com/docs/stop_logging/) for full documentation.
#'
#' @param Name &#91;required&#93; Specifies the name or the CloudTrail ARN of the trail for which
...
#' Updates a channel specified by a required channel ARN or UUID.
#'
#' See [https://paws-r-sdk.com/docs/update_channel/](https://paws-r-sdk.com/docs/update_channel/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_event_data_store/](https://paws-r-sdk.com/docs/update_event_data_store/) for full documentation.
#'
#' @param EventDataStore &#91;required&#93; The ARN (or the ID suffix of the ARN) of the event data store that you
#' want to update.
...
#'
#' See [https://paws-r-sdk.com/docs/update_trail/](https://paws-r-sdk.com/docs/update_trail/) for full documentation.
#'
