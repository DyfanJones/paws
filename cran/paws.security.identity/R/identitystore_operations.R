...
#' Retrieves `GroupId` in an identity store.
#'
#' See [https://paws-r-sdk.com/docs/get_group_id/](https://paws-r-sdk.com/docs/get_group_id/) for full documentation.
#'
#' @param IdentityStoreId &#91;required&#93; The globally unique identifier for the identity store.
...
#' Retrieves the `MembershipId` in an identity store.
#'
#' See [https://paws-r-sdk.com/docs/get_group_membership_id/](https://paws-r-sdk.com/docs/get_group_membership_id/) for full documentation.
#'
#' @param IdentityStoreId &#91;required&#93; The globally unique identifier for the identity store.
#' @param GroupId &#91;required&#93; The identifier for a group in the identity store.
#' @param MemberId &#91;required&#93; An object that contains the identifier of a group member. Setting the
...
#' Retrieves the `UserId` in an identity store.
#'
#' See [https://paws-r-sdk.com/docs/get_user_id/](https://paws-r-sdk.com/docs/get_user_id/) for full documentation.
#'
#' @param IdentityStoreId &#91;required&#93; The globally unique identifier for the identity store.
#' @param AlternateIdentifier &#91;required&#93; A unique identifier for a user or group that is not the primary
#' identifier. This value can be an identifier from an external identity
...
#'
#' See [https://paws-r-sdk.com/docs/is_member_in_groups/](https://paws-r-sdk.com/docs/is_member_in_groups/) for full documentation.
#'
#' @param IdentityStoreId &#91;required&#93; The globally unique identifier for the identity store.
...
#'
#' See [https://paws-r-sdk.com/docs/list_group_memberships_for_member/](https://paws-r-sdk.com/docs/list_group_memberships_for_member/) for full documentation.
#'
#' @param IdentityStoreId &#91;required&#93; The globally unique identifier for the identity store.
#' @param MemberId &#91;required&#93; An object that contains the identifier of a group member. Setting the
#' `UserID` field to the specific identifier for a user indicates that the
