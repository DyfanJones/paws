...
#'
#' See [https://paws-r-sdk.com/docs/create_host/](https://paws-r-sdk.com/docs/create_host/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_host/](https://paws-r-sdk.com/docs/delete_host/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_host/](https://paws-r-sdk.com/docs/get_host/) for full documentation.
#'
...
#' Lists the hosts associated with your account.
#'
#' See [https://paws-r-sdk.com/docs/list_hosts/](https://paws-r-sdk.com/docs/list_hosts/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in a single call. To retrieve
#' the remaining results, make another call with the returned `nextToken`
#' value.
...
#' Updates a specified host with the provided configurations.
#'
#' See [https://paws-r-sdk.com/docs/update_host/](https://paws-r-sdk.com/docs/update_host/) for full documentation.
#'
