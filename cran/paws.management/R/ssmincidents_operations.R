...
#'
#' See [https://paws-r-sdk.com/docs/create_replication_set/](https://paws-r-sdk.com/docs/create_replication_set/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_response_plan/](https://paws-r-sdk.com/docs/create_response_plan/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_timeline_event/](https://paws-r-sdk.com/docs/create_timeline_event/) for full documentation.
#'
...
#' Delete an incident record from Incident Manager.
#'
#' See [https://paws-r-sdk.com/docs/delete_incident_record/](https://paws-r-sdk.com/docs/delete_incident_record/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_replication_set/](https://paws-r-sdk.com/docs/delete_replication_set/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_response_plan/](https://paws-r-sdk.com/docs/delete_response_plan/) for full documentation.
#'
...
#' Deletes a timeline event from an incident.
#'
#' See [https://paws-r-sdk.com/docs/delete_timeline_event/](https://paws-r-sdk.com/docs/delete_timeline_event/) for full documentation.
#'
...
#' Returns the details for the specified incident record.
#'
#' See [https://paws-r-sdk.com/docs/get_incident_record/](https://paws-r-sdk.com/docs/get_incident_record/) for full documentation.
#'
...
#' Retrieve your Incident Manager replication set.
#'
#' See [https://paws-r-sdk.com/docs/get_replication_set/](https://paws-r-sdk.com/docs/get_replication_set/) for full documentation.
#'
...
#' Retrieves the details of the specified response plan.
#'
#' See [https://paws-r-sdk.com/docs/get_response_plan/](https://paws-r-sdk.com/docs/get_response_plan/) for full documentation.
#'
#' @param arn &#91;required&#93; The Amazon Resource Name (ARN) of the response plan.
#'
#' @keywords internal
...
#' Retrieves a timeline event based on its ID and incident record.
#'
#' See [https://paws-r-sdk.com/docs/get_timeline_event/](https://paws-r-sdk.com/docs/get_timeline_event/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_incident_records/](https://paws-r-sdk.com/docs/list_incident_records/) for full documentation.
#'
...
#' List all related items for an incident record.
#'
#' See [https://paws-r-sdk.com/docs/list_related_items/](https://paws-r-sdk.com/docs/list_related_items/) for full documentation.
#'
...
#' Lists details about the replication set configured in your account.
#'
#' See [https://paws-r-sdk.com/docs/list_replication_sets/](https://paws-r-sdk.com/docs/list_replication_sets/) for full documentation.
#'
#' @param maxResults The maximum number of results per page.
#' @param nextToken The pagination token to continue to the next page of results.
#'
...
#' Lists all response plans in your account.
#'
#' See [https://paws-r-sdk.com/docs/list_response_plans/](https://paws-r-sdk.com/docs/list_response_plans/) for full documentation.
#'
...
#' Lists timeline events for the specified incident record.
#'
#' See [https://paws-r-sdk.com/docs/list_timeline_events/](https://paws-r-sdk.com/docs/list_timeline_events/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_incident/](https://paws-r-sdk.com/docs/start_incident/) for full documentation.
#'
#' @param clientToken A token ensuring that the operation is called only once with the
#' specified details.
...
#'
#' See [https://paws-r-sdk.com/docs/update_deletion_protection/](https://paws-r-sdk.com/docs/update_deletion_protection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_incident_record/](https://paws-r-sdk.com/docs/update_incident_record/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_related_items/](https://paws-r-sdk.com/docs/update_related_items/) for full documentation.
#'
#' @param clientToken A token that ensures that a client calls the operation only once with
#' the specified details.
...
#' Add or delete Regions from your replication set.
#'
#' See [https://paws-r-sdk.com/docs/update_replication_set/](https://paws-r-sdk.com/docs/update_replication_set/) for full documentation.
#'
...
#' Updates the specified response plan.
#'
#' See [https://paws-r-sdk.com/docs/update_response_plan/](https://paws-r-sdk.com/docs/update_response_plan/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_timeline_event/](https://paws-r-sdk.com/docs/update_timeline_event/) for full documentation.
#'
#' @param clientToken A token that ensures that a client calls the operation only once with
#' the specified details.
