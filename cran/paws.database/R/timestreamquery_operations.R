...
#'
#' See [https://paws-r-sdk.com/docs/create_scheduled_query/](https://paws-r-sdk.com/docs/create_scheduled_query/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_scheduled_query/](https://paws-r-sdk.com/docs/delete_scheduled_query/) for full documentation.
#'
...
#' Provides detailed information about a scheduled query.
#'
#' See [https://paws-r-sdk.com/docs/describe_scheduled_query/](https://paws-r-sdk.com/docs/describe_scheduled_query/) for full documentation.
#'
#' @param ScheduledQueryArn &#91;required&#93; The ARN of the scheduled query.
#'
#' @keywords internal
...
#' You can use this API to run a scheduled query manually.
#'
#' See [https://paws-r-sdk.com/docs/execute_scheduled_query/](https://paws-r-sdk.com/docs/execute_scheduled_query/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_scheduled_queries/](https://paws-r-sdk.com/docs/list_scheduled_queries/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/prepare_query/](https://paws-r-sdk.com/docs/prepare_query/) for full documentation.
#'
...
#' Update a scheduled query.
#'
#' See [https://paws-r-sdk.com/docs/update_scheduled_query/](https://paws-r-sdk.com/docs/update_scheduled_query/) for full documentation.
#'
