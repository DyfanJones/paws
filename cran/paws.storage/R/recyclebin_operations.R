...
#'
#' See [https://paws-r-sdk.com/docs/lock_rule/](https://paws-r-sdk.com/docs/lock_rule/) for full documentation.
#'
#' @param Identifier &#91;required&#93; The unique ID of the retention rule.
...
#'
#' See [https://paws-r-sdk.com/docs/unlock_rule/](https://paws-r-sdk.com/docs/unlock_rule/) for full documentation.
#'
#' @param Identifier &#91;required&#93; The unique ID of the retention rule.
#'
#' @keywords internal
