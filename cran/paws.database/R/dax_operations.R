...
#' Removes one or more nodes from a DAX cluster.
#'
#' See [https://paws-r-sdk.com/docs/decrease_replication_factor/](https://paws-r-sdk.com/docs/decrease_replication_factor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_default_parameters/](https://paws-r-sdk.com/docs/describe_default_parameters/) for full documentation.
#'
#' @param MaxResults The maximum number of results to include in the response. If more
#' results exist than the specified `MaxResults` value, a token is included
#' in the response so that the remaining results can be retrieved.
...
#' Adds one or more nodes to a DAX cluster.
#'
#' See [https://paws-r-sdk.com/docs/increase_replication_factor/](https://paws-r-sdk.com/docs/increase_replication_factor/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/reboot_node/](https://paws-r-sdk.com/docs/reboot_node/) for full documentation.
#'
