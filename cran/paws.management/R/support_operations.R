...
#' Adds one or more attachments to an attachment set.
#'
#' See [https://paws-r-sdk.com/docs/add_attachments_to_set/](https://paws-r-sdk.com/docs/add_attachments_to_set/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/add_communication_to_case/](https://paws-r-sdk.com/docs/add_communication_to_case/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_case/](https://paws-r-sdk.com/docs/create_case/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_attachment/](https://paws-r-sdk.com/docs/describe_attachment/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_cases/](https://paws-r-sdk.com/docs/describe_cases/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_communications/](https://paws-r-sdk.com/docs/describe_communications/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_create_case_options/](https://paws-r-sdk.com/docs/describe_create_case_options/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_severity_levels/](https://paws-r-sdk.com/docs/describe_severity_levels/) for full documentation.
#'
#' @param language The language in which Amazon Web Services Support handles the case.
#' Amazon Web Services Support currently supports Chinese (“zh”), English
#' ("en"), Japanese ("ja") and Korean (“ko”). You must specify the ISO
...
#'
#' See [https://paws-r-sdk.com/docs/describe_supported_languages/](https://paws-r-sdk.com/docs/describe_supported_languages/) for full documentation.
#'
#' @param issueType &#91;required&#93; The type of issue for the case. You can specify `customer-service` or
#' `technical`.
#' @param serviceCode &#91;required&#93; The code for the Amazon Web Services service. You can use the
...
#'
#' See [https://paws-r-sdk.com/docs/describe_trusted_advisor_check_refresh_statuses/](https://paws-r-sdk.com/docs/describe_trusted_advisor_check_refresh_statuses/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_trusted_advisor_check_result/](https://paws-r-sdk.com/docs/describe_trusted_advisor_check_result/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_trusted_advisor_check_summaries/](https://paws-r-sdk.com/docs/describe_trusted_advisor_check_summaries/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_trusted_advisor_checks/](https://paws-r-sdk.com/docs/describe_trusted_advisor_checks/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/refresh_trusted_advisor_check/](https://paws-r-sdk.com/docs/refresh_trusted_advisor_check/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/resolve_case/](https://paws-r-sdk.com/docs/resolve_case/) for full documentation.
#'
#' @param caseId The support case ID requested or returned in the call. The case ID is an
#' alphanumeric string formatted as shown in this example:
#' case-*12345678910-2013-c4c1d2bf33c5cf47*
