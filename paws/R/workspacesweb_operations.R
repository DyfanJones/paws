...
#' @param browserPolicy A JSON string containing Chrome Enterprise policies that will be applied to all streaming sessions.
#' @param clientToken A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request.
#' 
#' If you do not specify a client token, one is automatically generated by the Amazon Web Services SDK.
#' @param webContentFilteringPolicy The policy that specifies which URLs end users are allowed to access or which URLs or domain categories they are restricted from accessing for enhanced security.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param tags The tags to add to the data protection settings resource. A tag is a key-value pair.
...
#' @param inlineRedactionConfiguration The inline redaction configuration of the data protection settings that will be applied to all sessions.
#' @param clientToken A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. Idempotency ensures that an API request completes only once. With an idempotent request, if the original request completes successfully, subsequent retries with the same client token returns the result from the original successful request.
#' 
#' If you do not specify a client token, one is automatically generated by the Amazon Web Services SDK.
#'
...
#' @param identityProviderDetails &#91;required&#93; The identity provider details. The following list describes the provider detail keys for each identity provider type.
#' 
...
#' 
#' If you do not specify a client token, one is automatically generated by the Amazon Web Services SDK.
#' @param tags The tags to add to the identity provider resource. A tag is a key-value pair.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param subnetIds &#91;required&#93; The subnets in which network interfaces are created to connect streaming instances to your VPC. At least two of these subnets must be in different availability zones.
#' @param securityGroupIds &#91;required&#93; One or more security groups used to control access from streaming instances to your VPC.
...
#'
#' @param displayName The name of the web portal. This is not visible to users who log into the web portal.
...
#' 
#' `Standard` web portals are authenticated directly through your identity provider. You need to call [`create_identity_provider`][workspacesweb_create_identity_provider] to integrate your identity provider with your web portal. User and group access to your web portal is controlled through your identity provider.
#' 
...
#' @param portalCustomDomain The custom domain of the web portal that users access in order to start streaming sessions.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param copyAllowed &#91;required&#93; Specifies whether the user can copy text from the streaming session to the local device.
#' @param pasteAllowed &#91;required&#93; Specifies whether the user can paste text from the local device to the streaming session.
#' @param downloadAllowed &#91;required&#93; Specifies whether the user can download files from the streaming session to the local device.
#' @param uploadAllowed &#91;required&#93; Specifies whether the user can upload files from the local device to the streaming session.
...
#' @param toolbarConfiguration The configuration of the toolbar. This allows administrators to select the toolbar type and visual mode, set maximum display resolution for sessions, and choose which items are visible to end users during their sessions. If administrators do not modify these settings, end users retain control over their toolbar preferences.
#' @param brandingConfigurationInput The branding configuration input that customizes the appearance of the web portal for end users. This includes a custom logo, favicon, localized strings, color theme, and optionally a wallpaper and terms of service.
#' @param webAuthnAllowed Specifies whether the user can use WebAuthn redirection for passwordless login to websites within the streaming session.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param identityProviderDetails The details of the identity provider. The following list describes the provider detail keys for each identity provider type.
#' 
#' -   For Google and Login with Amazon:
#' 
#'     -   `client_id`
...
#' @param subnetIds The subnets in which network interfaces are created to connect streaming instances to your VPC. At least two of these subnets must be in different availability zones.
...
#'
#' @param userSettingsArn &#91;required&#93; The ARN of the user settings.
#' @param copyAllowed Specifies whether the user can copy text from the streaming session to the local device.
#' @param pasteAllowed Specifies whether the user can paste text from the local device to the streaming session.
#' @param downloadAllowed Specifies whether the user can download files from the streaming session to the local device.
#' @param uploadAllowed Specifies whether the user can upload files from the local device to the streaming session.
