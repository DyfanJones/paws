...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_traces/](https://paws-r-sdk.com/docs/batch_get_traces/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_sampling_rule/](https://paws-r-sdk.com/docs/create_sampling_rule/) for full documentation.
#'
...
#' Deletes a sampling rule.
#'
#' See [https://paws-r-sdk.com/docs/delete_sampling_rule/](https://paws-r-sdk.com/docs/delete_sampling_rule/) for full documentation.
#'
...
#' Retrieves the current encryption configuration for X-Ray data.
#'
#' See [https://paws-r-sdk.com/docs/get_encryption_config/](https://paws-r-sdk.com/docs/get_encryption_config/) for full documentation.
#'
#' @keywords internal
#'
...
#' Retrieves all active group details.
#'
#' See [https://paws-r-sdk.com/docs/get_groups/](https://paws-r-sdk.com/docs/get_groups/) for full documentation.
#'
#' @param NextToken Pagination token.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_insight/](https://paws-r-sdk.com/docs/get_insight/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_insight_events/](https://paws-r-sdk.com/docs/get_insight_events/) for full documentation.
#'
#' @param InsightId &#91;required&#93; The insight's unique identifier. Use the GetInsightSummaries action to
#' retrieve an InsightId.
...
#'
#' See [https://paws-r-sdk.com/docs/get_insight_impact_graph/](https://paws-r-sdk.com/docs/get_insight_impact_graph/) for full documentation.
#'
#' @param InsightId &#91;required&#93; The insight's unique identifier. Use the GetInsightSummaries action to
#' retrieve an InsightId.
...
#'
#' See [https://paws-r-sdk.com/docs/get_insight_summaries/](https://paws-r-sdk.com/docs/get_insight_summaries/) for full documentation.
#'
...
#' Retrieves all sampling rules.
#'
#' See [https://paws-r-sdk.com/docs/get_sampling_rules/](https://paws-r-sdk.com/docs/get_sampling_rules/) for full documentation.
#'
#' @param NextToken Pagination token.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_sampling_statistic_summaries/](https://paws-r-sdk.com/docs/get_sampling_statistic_summaries/) for full documentation.
#'
#' @param NextToken Pagination token.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_sampling_targets/](https://paws-r-sdk.com/docs/get_sampling_targets/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_service_graph/](https://paws-r-sdk.com/docs/get_service_graph/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_time_series_service_statistics/](https://paws-r-sdk.com/docs/get_time_series_service_statistics/) for full documentation.
#'
...
#' Retrieves a service graph for one or more specific trace IDs.
#'
#' See [https://paws-r-sdk.com/docs/get_trace_graph/](https://paws-r-sdk.com/docs/get_trace_graph/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_trace_summaries/](https://paws-r-sdk.com/docs/get_trace_summaries/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_resource_policies/](https://paws-r-sdk.com/docs/list_resource_policies/) for full documentation.
#'
...
#' Updates the encryption configuration for X-Ray data.
#'
#' See [https://paws-r-sdk.com/docs/put_encryption_config/](https://paws-r-sdk.com/docs/put_encryption_config/) for full documentation.
#'
...
#' Used by the Amazon Web Services X-Ray daemon to upload telemetry.
#'
#' See [https://paws-r-sdk.com/docs/put_telemetry_records/](https://paws-r-sdk.com/docs/put_telemetry_records/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_trace_segments/](https://paws-r-sdk.com/docs/put_trace_segments/) for full documentation.
#'
...
#' Modifies a sampling rule's configuration.
#'
#' See [https://paws-r-sdk.com/docs/update_sampling_rule/](https://paws-r-sdk.com/docs/update_sampling_rule/) for full documentation.
#'
