...
#' @param PullRequestComment A toggle that specifies whether to enable or disable pull request comments for the sync configuration to be created.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param NextToken The token that was returned from the previous [`list_connections`][codeconnections_list_connections] call, which can be used to return the next set of connections in the list.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param MaxResults The maximum number of results to return in a single call. To retrieve the remaining results, make another call with the returned `nextToken` value.
#' @param NextToken The token that was returned from the previous [`list_hosts`][codeconnections_list_hosts] call, which can be used to return the next set of hosts in the list.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param PublishDeploymentStatus Whether to enable or disable publishing of deployment status to source providers.
#' @param TriggerResourceUpdateOn When to trigger Git sync to begin the stack update.
#' @param PullRequestComment TA toggle that specifies whether to enable or disable pull request comments for the sync configuration to be updated.
#'
#' @return
#' A list with the following syntax:
#' ```
