...
#'
#' See [https://paws-r-sdk.com/docs/assume_role/](https://paws-r-sdk.com/docs/assume_role/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/assume_role_with_saml/](https://paws-r-sdk.com/docs/assume_role_with_saml/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/assume_role_with_web_identity/](https://paws-r-sdk.com/docs/assume_role_with_web_identity/) for full documentation.
#'
#' @param RoleArn &#91;required&#93; The Amazon Resource Name (ARN) of the role that the caller is assuming.
...
#'
#' See [https://paws-r-sdk.com/docs/decode_authorization_message/](https://paws-r-sdk.com/docs/decode_authorization_message/) for full documentation.
#'
...
#' Returns the account identifier for the specified access key ID.
#'
#' See [https://paws-r-sdk.com/docs/get_access_key_info/](https://paws-r-sdk.com/docs/get_access_key_info/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_caller_identity/](https://paws-r-sdk.com/docs/get_caller_identity/) for full documentation.
#'
#' @keywords internal
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_session_token/](https://paws-r-sdk.com/docs/get_session_token/) for full documentation.
#'
