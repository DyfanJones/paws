...
#'
#' See [https://paws-r-sdk.com/docs/bulk_publish/](https://paws-r-sdk.com/docs/bulk_publish/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_identity_pool_usage/](https://paws-r-sdk.com/docs/describe_identity_pool_usage/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
#' Cognito. GUID generation is unique within a region.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_identity_usage/](https://paws-r-sdk.com/docs/describe_identity_usage/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
#' Cognito. GUID generation is unique within a region.
...
#' Get the status of the last BulkPublish operation for an identity pool.
#'
#' See [https://paws-r-sdk.com/docs/get_bulk_publish_details/](https://paws-r-sdk.com/docs/get_bulk_publish_details/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
#' Cognito. GUID generation is unique within a region.
...
#'
#' See [https://paws-r-sdk.com/docs/get_cognito_events/](https://paws-r-sdk.com/docs/get_cognito_events/) for full documentation.
#'
...
#' Gets the configuration settings of an identity pool.
#'
#' See [https://paws-r-sdk.com/docs/get_identity_pool_configuration/](https://paws-r-sdk.com/docs/get_identity_pool_configuration/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
...
#' Gets a list of identity pools registered with Cognito.
#'
#' See [https://paws-r-sdk.com/docs/list_identity_pool_usage/](https://paws-r-sdk.com/docs/list_identity_pool_usage/) for full documentation.
#'
#' @param NextToken A pagination token for obtaining the next page of results.
#' @param MaxResults The maximum number of results to be returned.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_records/](https://paws-r-sdk.com/docs/list_records/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
#' Cognito. GUID generation is unique within a region.
...
#' Registers a device to receive push sync notifications.
#'
#' See [https://paws-r-sdk.com/docs/register_device/](https://paws-r-sdk.com/docs/register_device/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
...
#'
#' See [https://paws-r-sdk.com/docs/set_cognito_events/](https://paws-r-sdk.com/docs/set_cognito_events/) for full documentation.
#'
...
#' Sets the necessary configuration for push sync.
#'
#' See [https://paws-r-sdk.com/docs/set_identity_pool_configuration/](https://paws-r-sdk.com/docs/set_identity_pool_configuration/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
...
#'
#' See [https://paws-r-sdk.com/docs/subscribe_to_dataset/](https://paws-r-sdk.com/docs/subscribe_to_dataset/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
...
#'
#' See [https://paws-r-sdk.com/docs/unsubscribe_from_dataset/](https://paws-r-sdk.com/docs/unsubscribe_from_dataset/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
...
#'
#' See [https://paws-r-sdk.com/docs/update_records/](https://paws-r-sdk.com/docs/update_records/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; A name-spaced GUID (for example,
#' us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon
#' Cognito. GUID generation is unique within a region.
