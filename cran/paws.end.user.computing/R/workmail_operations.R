...
#' Adds a member (user or group) to the resource's set of delegates.
#'
#' See [https://paws-r-sdk.com/docs/associate_delegate_to_resource/](https://paws-r-sdk.com/docs/associate_delegate_to_resource/) for full documentation.
#'
...
#' Adds a member (user or group) to the group's set.
#'
#' See [https://paws-r-sdk.com/docs/associate_member_to_group/](https://paws-r-sdk.com/docs/associate_member_to_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/assume_impersonation_role/](https://paws-r-sdk.com/docs/assume_impersonation_role/) for full documentation.
#'
...
#' Cancels a mailbox export job.
#'
#' See [https://paws-r-sdk.com/docs/cancel_mailbox_export_job/](https://paws-r-sdk.com/docs/cancel_mailbox_export_job/) for full documentation.
#'
...
#' Adds an alias to the set of a given member (user or group) of WorkMail.
#'
#' See [https://paws-r-sdk.com/docs/create_alias/](https://paws-r-sdk.com/docs/create_alias/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_availability_configuration/](https://paws-r-sdk.com/docs/create_availability_configuration/) for full documentation.
#'
...
#' Creates an impersonation role for the given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/create_impersonation_role/](https://paws-r-sdk.com/docs/create_impersonation_role/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_mobile_device_access_rule/](https://paws-r-sdk.com/docs/create_mobile_device_access_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_organization/](https://paws-r-sdk.com/docs/create_organization/) for full documentation.
#'
...
#' Deletes an access control rule for the specified WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/delete_access_control_rule/](https://paws-r-sdk.com/docs/delete_access_control_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_alias/](https://paws-r-sdk.com/docs/delete_alias/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_availability_configuration/](https://paws-r-sdk.com/docs/delete_availability_configuration/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The WorkMail organization for which the `AvailabilityConfiguration` will
#' be deleted.
...
#' Deletes the email monitoring configuration for a specified organization.
#'
#' See [https://paws-r-sdk.com/docs/delete_email_monitoring_configuration/](https://paws-r-sdk.com/docs/delete_email_monitoring_configuration/) for full documentation.
#'
...
#' Deletes an impersonation role for the given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/delete_impersonation_role/](https://paws-r-sdk.com/docs/delete_impersonation_role/) for full documentation.
#'
...
#' Deletes permissions granted to a member (user or group).
#'
#' See [https://paws-r-sdk.com/docs/delete_mailbox_permissions/](https://paws-r-sdk.com/docs/delete_mailbox_permissions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_mobile_device_access_override/](https://paws-r-sdk.com/docs/delete_mobile_device_access_override/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_mobile_device_access_rule/](https://paws-r-sdk.com/docs/delete_mobile_device_access_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_organization/](https://paws-r-sdk.com/docs/delete_organization/) for full documentation.
#'
#' @param ClientToken The idempotency token associated with the request.
#' @param OrganizationId &#91;required&#93; The organization ID.
...
#' Deletes the specified retention policy from the specified organization.
#'
#' See [https://paws-r-sdk.com/docs/delete_retention_policy/](https://paws-r-sdk.com/docs/delete_retention_policy/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The organization ID.
...
#'
#' See [https://paws-r-sdk.com/docs/deregister_from_work_mail/](https://paws-r-sdk.com/docs/deregister_from_work_mail/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/deregister_mail_domain/](https://paws-r-sdk.com/docs/deregister_mail_domain/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_email_monitoring_configuration/](https://paws-r-sdk.com/docs/describe_email_monitoring_configuration/) for full documentation.
#'
...
#' Lists the settings in a DMARC policy for a specified organization.
#'
#' See [https://paws-r-sdk.com/docs/describe_inbound_dmarc_settings/](https://paws-r-sdk.com/docs/describe_inbound_dmarc_settings/) for full documentation.
#'
...
#' Describes the current status of a mailbox export job.
#'
#' See [https://paws-r-sdk.com/docs/describe_mailbox_export_job/](https://paws-r-sdk.com/docs/describe_mailbox_export_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_organization/](https://paws-r-sdk.com/docs/describe_organization/) for full documentation.
#'
...
#' Returns the data available for the resource.
#'
#' See [https://paws-r-sdk.com/docs/describe_resource/](https://paws-r-sdk.com/docs/describe_resource/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier associated with the organization for which the resource
#' is described.
...
#' Removes a member from the resource's set of delegates.
#'
#' See [https://paws-r-sdk.com/docs/disassociate_delegate_from_resource/](https://paws-r-sdk.com/docs/disassociate_delegate_from_resource/) for full documentation.
#'
...
#' Removes a member from a group.
#'
#' See [https://paws-r-sdk.com/docs/disassociate_member_from_group/](https://paws-r-sdk.com/docs/disassociate_member_from_group/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier for the organization under which the group exists.
...
#'
#' See [https://paws-r-sdk.com/docs/get_access_control_effect/](https://paws-r-sdk.com/docs/get_access_control_effect/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier for the organization.
...
#' Gets the default retention policy details for the specified organization.
#'
#' See [https://paws-r-sdk.com/docs/get_default_retention_policy/](https://paws-r-sdk.com/docs/get_default_retention_policy/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The organization ID.
#'
#' @keywords internal
...
#' Gets the impersonation role details for the given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/get_impersonation_role/](https://paws-r-sdk.com/docs/get_impersonation_role/) for full documentation.
#'
...
#' Tests whether the given impersonation role can impersonate a target user.
#'
#' See [https://paws-r-sdk.com/docs/get_impersonation_role_effect/](https://paws-r-sdk.com/docs/get_impersonation_role_effect/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_mail_domain/](https://paws-r-sdk.com/docs/get_mail_domain/) for full documentation.
#'
...
#' Requests a user's mailbox details for a specified organization and user.
#'
#' See [https://paws-r-sdk.com/docs/get_mailbox_details/](https://paws-r-sdk.com/docs/get_mailbox_details/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_mobile_device_access_effect/](https://paws-r-sdk.com/docs/get_mobile_device_access_effect/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_mobile_device_access_override/](https://paws-r-sdk.com/docs/get_mobile_device_access_override/) for full documentation.
#'
...
#' Lists the access control rules for the specified organization.
#'
#' See [https://paws-r-sdk.com/docs/list_access_control_rules/](https://paws-r-sdk.com/docs/list_access_control_rules/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier for the organization.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/list_availability_configurations/](https://paws-r-sdk.com/docs/list_availability_configurations/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_group_members/](https://paws-r-sdk.com/docs/list_group_members/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier for the organization under which the group exists.
...
#' Lists all the impersonation roles for the given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/list_impersonation_roles/](https://paws-r-sdk.com/docs/list_impersonation_roles/) for full documentation.
#'
...
#' Lists the mail domains in a given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/list_mail_domains/](https://paws-r-sdk.com/docs/list_mail_domains/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_mailbox_export_jobs/](https://paws-r-sdk.com/docs/list_mailbox_export_jobs/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The organization ID.
...
#'
#' See [https://paws-r-sdk.com/docs/list_mailbox_permissions/](https://paws-r-sdk.com/docs/list_mailbox_permissions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_mobile_device_access_overrides/](https://paws-r-sdk.com/docs/list_mobile_device_access_overrides/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_mobile_device_access_rules/](https://paws-r-sdk.com/docs/list_mobile_device_access_rules/) for full documentation.
#'
...
#' Returns summaries of the customer's organizations.
#'
#' See [https://paws-r-sdk.com/docs/list_organizations/](https://paws-r-sdk.com/docs/list_organizations/) for full documentation.
#'
#' @param NextToken The token to use to retrieve the next page of results. The first call
#' does not contain any tokens.
#' @param MaxResults The maximum number of results to return in a single call.
...
#'
#' See [https://paws-r-sdk.com/docs/list_resource_delegates/](https://paws-r-sdk.com/docs/list_resource_delegates/) for full documentation.
#'
...
#' Returns summaries of the organization's resources.
#'
#' See [https://paws-r-sdk.com/docs/list_resources/](https://paws-r-sdk.com/docs/list_resources/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_access_control_rule/](https://paws-r-sdk.com/docs/put_access_control_rule/) for full documentation.
#'
#' @param Name &#91;required&#93; The rule name.
...
#'
#' See [https://paws-r-sdk.com/docs/put_email_monitoring_configuration/](https://paws-r-sdk.com/docs/put_email_monitoring_configuration/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The ID of the organization for which the email monitoring configuration
#' is set.
...
#' Enables or disables a DMARC policy for a given organization.
#'
#' See [https://paws-r-sdk.com/docs/put_inbound_dmarc_settings/](https://paws-r-sdk.com/docs/put_inbound_dmarc_settings/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_mailbox_permissions/](https://paws-r-sdk.com/docs/put_mailbox_permissions/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The identifier of the organization under which the user, group, or
#' resource exists.
...
#'
#' See [https://paws-r-sdk.com/docs/put_mobile_device_access_override/](https://paws-r-sdk.com/docs/put_mobile_device_access_override/) for full documentation.
#'
...
#' Puts a retention policy to the specified organization.
#'
#' See [https://paws-r-sdk.com/docs/put_retention_policy/](https://paws-r-sdk.com/docs/put_retention_policy/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The organization ID.
...
#'
#' See [https://paws-r-sdk.com/docs/register_mail_domain/](https://paws-r-sdk.com/docs/register_mail_domain/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/register_to_work_mail/](https://paws-r-sdk.com/docs/register_to_work_mail/) for full documentation.
#'
...
#' Allows the administrator to reset the password for a user.
#'
#' See [https://paws-r-sdk.com/docs/reset_password/](https://paws-r-sdk.com/docs/reset_password/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_mailbox_export_job/](https://paws-r-sdk.com/docs/start_mailbox_export_job/) for full documentation.
#'
#' @param ClientToken &#91;required&#93; The idempotency token for the client request.
...
#'
#' See [https://paws-r-sdk.com/docs/test_availability_configuration/](https://paws-r-sdk.com/docs/test_availability_configuration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_availability_configuration/](https://paws-r-sdk.com/docs/update_availability_configuration/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The WorkMail organization for which the `AvailabilityConfiguration` will
#' be updated.
...
#'
#' See [https://paws-r-sdk.com/docs/update_default_mail_domain/](https://paws-r-sdk.com/docs/update_default_mail_domain/) for full documentation.
#'
#' @param OrganizationId &#91;required&#93; The WorkMail organization for which to list domains.
...
#' Updates an impersonation role for the given WorkMail organization.
#'
#' See [https://paws-r-sdk.com/docs/update_impersonation_role/](https://paws-r-sdk.com/docs/update_impersonation_role/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_mailbox_quota/](https://paws-r-sdk.com/docs/update_mailbox_quota/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_mobile_device_access_rule/](https://paws-r-sdk.com/docs/update_mobile_device_access_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_primary_email_address/](https://paws-r-sdk.com/docs/update_primary_email_address/) for full documentation.
#'
