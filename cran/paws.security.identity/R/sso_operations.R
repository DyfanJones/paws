...
#'
#' See [https://paws-r-sdk.com/docs/get_role_credentials/](https://paws-r-sdk.com/docs/get_role_credentials/) for full documentation.
#'
...
#' Lists all roles that are assigned to the user for a given AWS account.
#'
#' See [https://paws-r-sdk.com/docs/list_account_roles/](https://paws-r-sdk.com/docs/list_account_roles/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/logout/](https://paws-r-sdk.com/docs/logout/) for full documentation.
#'
#' @param accessToken &#91;required&#93; The token issued by the `CreateToken` API call. For more information,
#' see
#' [CreateToken](https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html)
