...
#'
#' See [https://paws-r-sdk.com/docs/associate_repository/](https://paws-r-sdk.com/docs/associate_repository/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_code_review/](https://paws-r-sdk.com/docs/create_code_review/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_code_review/](https://paws-r-sdk.com/docs/describe_code_review/) for full documentation.
#'
...
#' Describes the customer feedback for a CodeGuru Reviewer recommendation.
#'
#' See [https://paws-r-sdk.com/docs/describe_recommendation_feedback/](https://paws-r-sdk.com/docs/describe_recommendation_feedback/) for full documentation.
#'
#' @param CodeReviewArn &#91;required&#93; The Amazon Resource Name (ARN) of the
#' [CodeReview](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReview.html)
#' object.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_repository_association/](https://paws-r-sdk.com/docs/describe_repository_association/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_repository/](https://paws-r-sdk.com/docs/disassociate_repository/) for full documentation.
#'
#' @param AssociationArn &#91;required&#93; The Amazon Resource Name (ARN) of the
#' [RepositoryAssociation](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_RepositoryAssociation.html)
#' object. You can retrieve this ARN by calling
...
#'
#' See [https://paws-r-sdk.com/docs/list_code_reviews/](https://paws-r-sdk.com/docs/list_code_reviews/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_recommendation_feedback/](https://paws-r-sdk.com/docs/list_recommendation_feedback/) for full documentation.
#'
#' @param NextToken If `nextToken` is returned, there are more results available. The value
#' of `nextToken` is a unique pagination token for each page. Make the call
#' again using the returned token to retrieve the next page. Keep all other
...
#'
#' See [https://paws-r-sdk.com/docs/list_repository_associations/](https://paws-r-sdk.com/docs/list_repository_associations/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_recommendation_feedback/](https://paws-r-sdk.com/docs/put_recommendation_feedback/) for full documentation.
#'
#' @param CodeReviewArn &#91;required&#93; The Amazon Resource Name (ARN) of the
#' [CodeReview](https://docs.aws.amazon.com/codeguru/latest/reviewer-api/API_CodeReview.html)
#' object.
