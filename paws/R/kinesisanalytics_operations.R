...
#' 
#' You can add a streaming source either when you create an application or you can use this operation to add a streaming source after you create an application. For more information, see [`create_application`][kinesisanalytics_create_application].
#' 
#' Any configuration update, including adding a streaming source using this operation, results in a new version of the application. You can use the [`describe_application`][kinesisanalytics_describe_application] operation to find the current application version.
#' 
...
#' 
#' If the application is running, Amazon Kinesis Analytics immediately removes the in-application table that you created using the [`add_application_reference_data_source`][kinesisanalytics_add_application_reference_data_source] operation.
#' 
...
#' 
#' If you want to retrieve a list of all applications in your account, use the [`list_applications`][kinesisanalytics_list_applications] operation.
#' 
#' This operation requires permissions to perform the `kinesisanalytics:DescribeApplication` action. You can use [`describe_application`][kinesisanalytics_describe_application] to get the current application versionId, which you need to call other operations such as `Update`.
#'
#' @usage
...
#' 
#' If you want detailed information about a specific application, use [`describe_application`][kinesisanalytics_describe_application].
#' 
...
#' 
#' The application status must be `READY` for you to start an application. You can get the application status in the console or using the [`describe_application`][kinesisanalytics_describe_application] operation.
#' 
#' After you start the application, you can stop the application from processing the input by calling the [`stop_application`][kinesisanalytics_stop_application] operation.
#' 
...
#' This documentation is for version 1 of the Amazon Kinesis Data Analytics API, which only supports SQL applications. Version 2 of the API supports SQL and Java applications. For more information about version 2, see Amazon Kinesis Data Analytics API V2 Documentation.
#' 
#' Stops the application from processing input data. You can stop an application only if it is in the running state. You can use the [`describe_application`][kinesisanalytics_describe_application] operation to find the application state. After the application is stopped, Amazon Kinesis Analytics stops reading data from the input, the application stops processing data, and there is no output written to the destination.
#' 
