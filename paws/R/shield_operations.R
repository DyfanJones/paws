...
#' 
#' To use the services of the SRT and make an [`associate_drt_log_bucket`][shield_associate_drt_log_bucket] request, you must be subscribed to the [Business Support plan](https://aws.amazon.com/premiumsupport/plans/business/) or the [Enterprise Support plan](https://aws.amazon.com/premiumsupport/plans/enterprise/).
#'
#' @usage
...
#' 
#' You can associate only one `RoleArn` with your subscription. If you submit an [`associate_drt_role`][shield_associate_drt_role] request for an account that already has an associated role, the new `RoleArn` will replace the existing `RoleArn`.
#' 
#' Prior to making the [`associate_drt_role`][shield_associate_drt_role] request, you must attach the `AWSShieldDRTAccessPolicy` managed policy to the role that you'll specify in the request. You can access this policy in the IAM console at AWSShieldDRTAccessPolicy. For more information see [Adding and removing IAM identity permissions](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_manage-attach-detach.html). The role must also trust the service principal `drt.shield.amazonaws.com`. For more information, see [IAM JSON policy elements: Principal](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_principal.html).
#' 
#' The SRT will have access only to your WAF and Shield resources. By submitting this request, you authorize the SRT to inspect your WAF and Shield configuration and create and update WAF rules and web ACLs on your behalf. The SRT takes these actions only if explicitly authorized by you.
#' 
#' You must have the `iam:PassRole` permission to make an [`associate_drt_role`][shield_associate_drt_role] request. For more information, see [Granting a user permissions to pass a role to an Amazon Web Services service](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_passrole.html).
#' 
#' To use the services of the SRT and make an [`associate_drt_role`][shield_associate_drt_role] request, you must be subscribed to the [Business Support plan](https://aws.amazon.com/premiumsupport/plans/business/) or the [Enterprise Support plan](https://aws.amazon.com/premiumsupport/plans/enterprise/).
#'
#' @usage
...
#' 
#' After you have initialized proactive engagement using this call, to disable or enable proactive engagement, use the calls [`disable_proactive_engagement`][shield_disable_proactive_engagement] and [`enable_proactive_engagement`][shield_enable_proactive_engagement].
#' 
...
#' 
#' The contacts that you provide in the request replace any contacts that were already defined. If you already have contacts defined and want to use them, retrieve the list using [`describe_emergency_contact_settings`][shield_describe_emergency_contact_settings] and then provide it to this call.
#'
#' @usage
...
#' 
#' When you initially create a subscription, your subscription is set to be automatically renewed at the end of the existing subscription period. You can change this by submitting an [`update_subscription`][shield_update_subscription] request.
#'
#' @usage
...
#' 
#' Don't use this action to make changes to automatic mitigation settings when it's already enabled for a resource. Instead, use [`update_application_layer_automatic_response`][shield_update_application_layer_automatic_response].
#' 
