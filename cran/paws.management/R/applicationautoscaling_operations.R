...
#'
#' See [https://paws-r-sdk.com/docs/delete_scaling_policy/](https://paws-r-sdk.com/docs/delete_scaling_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/deregister_scalable_target/](https://paws-r-sdk.com/docs/deregister_scalable_target/) for full documentation.
#'
#' @param ServiceNamespace &#91;required&#93; The namespace of the Amazon Web Services service that provides the
#' resource. For a resource provided by your own application or service,
#' use `custom-resource` instead.
...
#' Gets information about the scalable targets in the specified namespace.
#'
#' See [https://paws-r-sdk.com/docs/describe_scalable_targets/](https://paws-r-sdk.com/docs/describe_scalable_targets/) for full documentation.
#'
#' @param ServiceNamespace &#91;required&#93; The namespace of the Amazon Web Services service that provides the
#' resource. For a resource provided by your own application or service,
#' use `custom-resource` instead.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_scaling_policies/](https://paws-r-sdk.com/docs/describe_scaling_policies/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_scheduled_action/](https://paws-r-sdk.com/docs/put_scheduled_action/) for full documentation.
#'
#' @param ServiceNamespace &#91;required&#93; The namespace of the Amazon Web Services service that provides the
#' resource. For a resource provided by your own application or service,
#' use `custom-resource` instead.
...
#'
#' See [https://paws-r-sdk.com/docs/register_scalable_target/](https://paws-r-sdk.com/docs/register_scalable_target/) for full documentation.
#'
#' @param ServiceNamespace &#91;required&#93; The namespace of the Amazon Web Services service that provides the
#' resource. For a resource provided by your own application or service,
#' use `custom-resource` instead.
