...
#'
#' See [https://paws-r-sdk.com/docs/create_lifecycle_policy/](https://paws-r-sdk.com/docs/create_lifecycle_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_lifecycle_policies/](https://paws-r-sdk.com/docs/get_lifecycle_policies/) for full documentation.
#'
...
#' Updates the specified lifecycle policy.
#'
#' See [https://paws-r-sdk.com/docs/update_lifecycle_policy/](https://paws-r-sdk.com/docs/update_lifecycle_policy/) for full documentation.
#'
#' @param PolicyId &#91;required&#93; The identifier of the lifecycle policy.
