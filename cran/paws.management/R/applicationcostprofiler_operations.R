...
#'
#' See [https://paws-r-sdk.com/docs/delete_report_definition/](https://paws-r-sdk.com/docs/delete_report_definition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_report_definition/](https://paws-r-sdk.com/docs/get_report_definition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/import_application_usage/](https://paws-r-sdk.com/docs/import_application_usage/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_report_definitions/](https://paws-r-sdk.com/docs/list_report_definitions/) for full documentation.
#'
...
#' Creates the report definition for a report in Application Cost Profiler.
#'
#' See [https://paws-r-sdk.com/docs/put_report_definition/](https://paws-r-sdk.com/docs/put_report_definition/) for full documentation.
#'
...
#' Updates existing report in AWS Application Cost Profiler.
#'
#' See [https://paws-r-sdk.com/docs/update_report_definition/](https://paws-r-sdk.com/docs/update_report_definition/) for full documentation.
#'
