...
#' Deletes one or more versions of a recipe at a time.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_recipe_version/](https://paws-r-sdk.com/docs/batch_delete_recipe_version/) for full documentation.
#'
...
#' Creates a new job to analyze a dataset and create its data profile.
#'
#' See [https://paws-r-sdk.com/docs/create_profile_job/](https://paws-r-sdk.com/docs/create_profile_job/) for full documentation.
#'
...
#' Creates a new DataBrew recipe.
#'
#' See [https://paws-r-sdk.com/docs/create_recipe/](https://paws-r-sdk.com/docs/create_recipe/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_recipe_job/](https://paws-r-sdk.com/docs/create_recipe_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_ruleset/](https://paws-r-sdk.com/docs/create_ruleset/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_schedule/](https://paws-r-sdk.com/docs/create_schedule/) for full documentation.
#'
...
#' Deletes a single version of a DataBrew recipe.
#'
#' See [https://paws-r-sdk.com/docs/delete_recipe_version/](https://paws-r-sdk.com/docs/delete_recipe_version/) for full documentation.
#'
...
#' Deletes a ruleset.
#'
#' See [https://paws-r-sdk.com/docs/delete_ruleset/](https://paws-r-sdk.com/docs/delete_ruleset/) for full documentation.
#'
...
#' Deletes the specified DataBrew schedule.
#'
#' See [https://paws-r-sdk.com/docs/delete_schedule/](https://paws-r-sdk.com/docs/delete_schedule/) for full documentation.
#'
...
#' Represents one run of a DataBrew job.
#'
#' See [https://paws-r-sdk.com/docs/describe_job_run/](https://paws-r-sdk.com/docs/describe_job_run/) for full documentation.
#'
...
#' Retrieves detailed information about the ruleset.
#'
#' See [https://paws-r-sdk.com/docs/describe_ruleset/](https://paws-r-sdk.com/docs/describe_ruleset/) for full documentation.
#'
...
#' Returns the definition of a specific DataBrew schedule.
#'
#' See [https://paws-r-sdk.com/docs/describe_schedule/](https://paws-r-sdk.com/docs/describe_schedule/) for full documentation.
#'
...
#' Lists all of the previous runs of a particular DataBrew job.
#'
#' See [https://paws-r-sdk.com/docs/list_job_runs/](https://paws-r-sdk.com/docs/list_job_runs/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_recipe_versions/](https://paws-r-sdk.com/docs/list_recipe_versions/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in this request.
#' @param NextToken The token returned by a previous call to retrieve the next set of
#' results.
...
#'
#' See [https://paws-r-sdk.com/docs/list_rulesets/](https://paws-r-sdk.com/docs/list_rulesets/) for full documentation.
#'
...
#' Lists the DataBrew schedules that are defined.
#'
#' See [https://paws-r-sdk.com/docs/list_schedules/](https://paws-r-sdk.com/docs/list_schedules/) for full documentation.
#'
...
#' Publishes a new version of a DataBrew recipe.
#'
#' See [https://paws-r-sdk.com/docs/publish_recipe/](https://paws-r-sdk.com/docs/publish_recipe/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/send_project_session_action/](https://paws-r-sdk.com/docs/send_project_session_action/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_project_session/](https://paws-r-sdk.com/docs/start_project_session/) for full documentation.
#'
...
#' Stops a particular run of a job.
#'
#' See [https://paws-r-sdk.com/docs/stop_job_run/](https://paws-r-sdk.com/docs/stop_job_run/) for full documentation.
#'
...
#' Modifies the definition of an existing DataBrew dataset.
#'
#' See [https://paws-r-sdk.com/docs/update_dataset/](https://paws-r-sdk.com/docs/update_dataset/) for full documentation.
#'
...
#' Modifies the definition of an existing profile job.
#'
#' See [https://paws-r-sdk.com/docs/update_profile_job/](https://paws-r-sdk.com/docs/update_profile_job/) for full documentation.
#'
#' @param Configuration Configuration for profile jobs. Used to select columns, do evaluations,
#' and override default parameters of evaluations. When configuration is
#' null, the profile job will run with default settings.
...
#'
#' See [https://paws-r-sdk.com/docs/update_recipe/](https://paws-r-sdk.com/docs/update_recipe/) for full documentation.
#'
...
#' Modifies the definition of an existing DataBrew recipe job.
#'
#' See [https://paws-r-sdk.com/docs/update_recipe_job/](https://paws-r-sdk.com/docs/update_recipe_job/) for full documentation.
#'
#' @param EncryptionKeyArn The Amazon Resource Name (ARN) of an encryption key that is used to
#' protect the job.
#' @param EncryptionMode The encryption mode for the job, which can be one of the following:
...
#' Updates specified ruleset.
#'
#' See [https://paws-r-sdk.com/docs/update_ruleset/](https://paws-r-sdk.com/docs/update_ruleset/) for full documentation.
#'
...
#' Modifies the definition of an existing DataBrew schedule.
#'
#' See [https://paws-r-sdk.com/docs/update_schedule/](https://paws-r-sdk.com/docs/update_schedule/) for full documentation.
#'
