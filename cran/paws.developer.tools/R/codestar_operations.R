...
#' Adds an IAM user to the team for an AWS CodeStar project.
#'
#' See [https://paws-r-sdk.com/docs/associate_team_member/](https://paws-r-sdk.com/docs/associate_team_member/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_team_member/](https://paws-r-sdk.com/docs/disassociate_team_member/) for full documentation.
#'
...
#' Gets the tags for a project.
#'
#' See [https://paws-r-sdk.com/docs/list_tags_for_project/](https://paws-r-sdk.com/docs/list_tags_for_project/) for full documentation.
#'
...
#' Lists all team members associated with a project.
#'
#' See [https://paws-r-sdk.com/docs/list_team_members/](https://paws-r-sdk.com/docs/list_team_members/) for full documentation.
#'
...
#' Adds tags to a project.
#'
#' See [https://paws-r-sdk.com/docs/tag_project/](https://paws-r-sdk.com/docs/tag_project/) for full documentation.
#'
...
#' Removes tags from a project.
#'
#' See [https://paws-r-sdk.com/docs/untag_project/](https://paws-r-sdk.com/docs/untag_project/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_team_member/](https://paws-r-sdk.com/docs/update_team_member/) for full documentation.
#'
#' @param projectId &#91;required&#93; The ID of the project.
