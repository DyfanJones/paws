...
.bedrockagent$service <- function(config = list(), op = NULL) {
  handlers <- new_handlers("restjson", "v4")
  new_service(.bedrockagent$metadata, handlers, config, op)
}
