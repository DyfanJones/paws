...
#' 
#' [`create_snapshot`][memorydb_create_snapshot] permission is required to create a final snapshot. Without this permission, the API call will fail with an `Access Denied` exception.
#'
#' @usage
