...
#'
#' See [https://paws-r-sdk.com/docs/list_outposts_with_s3/](https://paws-r-sdk.com/docs/list_outposts_with_s3/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_shared_endpoints/](https://paws-r-sdk.com/docs/list_shared_endpoints/) for full documentation.
#'
#' @param NextToken If a previous response from this operation included a `NextToken` value,
