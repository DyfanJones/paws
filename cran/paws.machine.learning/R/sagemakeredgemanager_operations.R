...
#' Use to check if a device is registered with SageMaker Edge Manager.
#'
#' See [https://paws-r-sdk.com/docs/get_device_registration/](https://paws-r-sdk.com/docs/get_device_registration/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/send_heartbeat/](https://paws-r-sdk.com/docs/send_heartbeat/) for full documentation.
#'
