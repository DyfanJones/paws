...
#'
#' See [https://paws-r-sdk.com/docs/create_identity_pool/](https://paws-r-sdk.com/docs/create_identity_pool/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_identities/](https://paws-r-sdk.com/docs/delete_identities/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_identity_pool/](https://paws-r-sdk.com/docs/delete_identity_pool/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_identity/](https://paws-r-sdk.com/docs/describe_identity/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_identity_pool/](https://paws-r-sdk.com/docs/describe_identity_pool/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_credentials_for_identity/](https://paws-r-sdk.com/docs/get_credentials_for_identity/) for full documentation.
#'
#' @param IdentityId &#91;required&#93; A unique identifier in the format REGION:GUID.
...
#'
#' See [https://paws-r-sdk.com/docs/get_id/](https://paws-r-sdk.com/docs/get_id/) for full documentation.
#'
...
#' Gets the roles for an identity pool.
#'
#' See [https://paws-r-sdk.com/docs/get_identity_pool_roles/](https://paws-r-sdk.com/docs/get_identity_pool_roles/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_open_id_token/](https://paws-r-sdk.com/docs/get_open_id_token/) for full documentation.
#'
#' @param IdentityId &#91;required&#93; A unique identifier in the format REGION:GUID.
#' @param Logins A set of optional name-value pairs that map provider names to provider
...
#'
#' See [https://paws-r-sdk.com/docs/get_open_id_token_for_developer_identity/](https://paws-r-sdk.com/docs/get_open_id_token_for_developer_identity/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
...
#'
#' See [https://paws-r-sdk.com/docs/get_principal_tag_attribute_map/](https://paws-r-sdk.com/docs/get_principal_tag_attribute_map/) for full documentation.
#'
...
#' Lists all of the Cognito identity pools registered for your account.
#'
#' See [https://paws-r-sdk.com/docs/list_identity_pools/](https://paws-r-sdk.com/docs/list_identity_pools/) for full documentation.
#'
#' @param MaxResults &#91;required&#93; The maximum number of identities to return.
#' @param NextToken A pagination token.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/lookup_developer_identity/](https://paws-r-sdk.com/docs/lookup_developer_identity/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
#' @param IdentityId A unique identifier in the format REGION:GUID.
...
#'
#' See [https://paws-r-sdk.com/docs/merge_developer_identities/](https://paws-r-sdk.com/docs/merge_developer_identities/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_identity_pool_roles/](https://paws-r-sdk.com/docs/set_identity_pool_roles/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
...
#'
#' See [https://paws-r-sdk.com/docs/set_principal_tag_attribute_map/](https://paws-r-sdk.com/docs/set_principal_tag_attribute_map/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/unlink_developer_identity/](https://paws-r-sdk.com/docs/unlink_developer_identity/) for full documentation.
#'
#' @param IdentityId &#91;required&#93; A unique identifier in the format REGION:GUID.
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
...
#'
#' See [https://paws-r-sdk.com/docs/unlink_identity/](https://paws-r-sdk.com/docs/unlink_identity/) for full documentation.
#'
#' @param IdentityId &#91;required&#93; A unique identifier in the format REGION:GUID.
#' @param Logins &#91;required&#93; A set of optional name-value pairs that map provider names to provider
#' tokens.
...
#' Updates an identity pool.
#'
#' See [https://paws-r-sdk.com/docs/update_identity_pool/](https://paws-r-sdk.com/docs/update_identity_pool/) for full documentation.
#'
#' @param IdentityPoolId &#91;required&#93; An identity pool ID in the format REGION:GUID.
#' @param IdentityPoolName &#91;required&#93; A string that you provide.
#' @param AllowUnauthenticatedIdentities &#91;required&#93; TRUE if the identity pool supports unauthenticated logins.
