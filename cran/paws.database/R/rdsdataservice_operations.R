...
#' Starts a SQL transaction.
#'
#' See [https://paws-r-sdk.com/docs/begin_transaction/](https://paws-r-sdk.com/docs/begin_transaction/) for full documentation.
#'
#' @param resourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the Aurora Serverless DB cluster.
...
#' Runs one or more SQL statements.
#'
#' See [https://paws-r-sdk.com/docs/execute_sql/](https://paws-r-sdk.com/docs/execute_sql/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/rollback_transaction/](https://paws-r-sdk.com/docs/rollback_transaction/) for full documentation.
#'
#' @param resourceArn &#91;required&#93; The Amazon Resource Name (ARN) of the Aurora Serverless DB cluster.
#' @param secretArn &#91;required&#93; The name or ARN of the secret that enables access to the DB cluster.
