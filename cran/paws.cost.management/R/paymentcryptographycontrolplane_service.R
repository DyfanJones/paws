...
#'  \link[=paymentcryptographycontrolplane_associate_mpa_team]{associate_mpa_team} \tab Associates a Multi-Party Approval (MPA) team with a protected operation\cr
...
#'  \link[=paymentcryptographycontrolplane_delete_resource_policy]{delete_resource_policy} \tab Removes the resource-based policy attached to an Amazon Web Services Payment Cryptography key\cr
...
#'  \link[=paymentcryptographycontrolplane_disassociate_mpa_team]{disassociate_mpa_team} \tab Removes the association between a Multi-Party Approval (MPA) team and a protected operation\cr
...
#'  \link[=paymentcryptographycontrolplane_get_mpa_team_association]{get_mpa_team_association} \tab Returns the Multi-Party Approval (MPA) team association for a protected operation\cr
...
#'  \link[=paymentcryptographycontrolplane_get_resource_policy]{get_resource_policy} \tab Returns the resource-based policy attached to an Amazon Web Services Payment Cryptography key\cr
...
#'  \link[=paymentcryptographycontrolplane_put_resource_policy]{put_resource_policy} \tab Attaches or replaces a resource-based policy on an Amazon Web Services Payment Cryptography key\cr
