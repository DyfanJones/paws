...
#' Deletes the draft configuration associated with the running environment.
#' 
#' Updating a running environment with any configuration changes creates a draft configuration set. You can get the draft configuration using [`describe_configuration_settings`][elasticbeanstalk_describe_configuration_settings] while the update is in progress or if the update fails. The `DeploymentStatus` for the draft configuration indicates whether the deployment is in process or has failed. The draft configuration remains in existence until it is deleted with this action.
#'
#' @usage
...
#' 
#' Use [`retrieve_environment_info`][elasticbeanstalk_retrieve_environment_info] to obtain the set of logs.
#' 
#' Related Topics
#' 
...
#' 
#' When updating the configuration settings to a new template or individual settings, a draft configuration is created and [`describe_configuration_settings`][elasticbeanstalk_describe_configuration_settings] for this environment returns two setting descriptions with different `DeploymentStatus` values.
#'
#' @usage
...
#' 
#' Controls permission to call [`update_tags_for_resource`][elasticbeanstalk_update_tags_for_resource] and pass a list of tags to add in the `TagsToAdd` parameter.
#' 
#' ### elasticbeanstalk:RemoveTags
#' 
#' Controls permission to call [`update_tags_for_resource`][elasticbeanstalk_update_tags_for_resource] and pass a list of tag keys to remove in the `TagsToRemove` parameter.
#' 
