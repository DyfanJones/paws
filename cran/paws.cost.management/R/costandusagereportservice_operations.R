...
#' Lists the AWS Cost and Usage reports available to this account.
#'
#' See [https://paws-r-sdk.com/docs/describe_report_definitions/](https://paws-r-sdk.com/docs/describe_report_definitions/) for full documentation.
#'
#' @param MaxResults 
#' @param NextToken 
#'
...
#' Allows you to programatically update your report preferences.
#'
#' See [https://paws-r-sdk.com/docs/modify_report_definition/](https://paws-r-sdk.com/docs/modify_report_definition/) for full documentation.
#'
