...
#' Activates an anomaly detector.
#'
#' See [https://paws-r-sdk.com/docs/activate_anomaly_detector/](https://paws-r-sdk.com/docs/activate_anomaly_detector/) for full documentation.
#'
...
#' Runs a backtest for anomaly detection for the specified resource.
#'
#' See [https://paws-r-sdk.com/docs/back_test_anomaly_detector/](https://paws-r-sdk.com/docs/back_test_anomaly_detector/) for full documentation.
#'
...
#' Creates an alert for an anomaly detector.
#'
#' See [https://paws-r-sdk.com/docs/create_alert/](https://paws-r-sdk.com/docs/create_alert/) for full documentation.
#'
...
#' Creates an anomaly detector.
#'
#' See [https://paws-r-sdk.com/docs/create_anomaly_detector/](https://paws-r-sdk.com/docs/create_anomaly_detector/) for full documentation.
#'
...
#' Creates a dataset.
#'
#' See [https://paws-r-sdk.com/docs/create_metric_set/](https://paws-r-sdk.com/docs/create_metric_set/) for full documentation.
#'
...
#' Deactivates an anomaly detector.
#'
#' See [https://paws-r-sdk.com/docs/deactivate_anomaly_detector/](https://paws-r-sdk.com/docs/deactivate_anomaly_detector/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
#'
#' @keywords internal
...
#' Deletes an alert.
#'
#' See [https://paws-r-sdk.com/docs/delete_alert/](https://paws-r-sdk.com/docs/delete_alert/) for full documentation.
#'
...
#' Describes an alert.
#'
#' See [https://paws-r-sdk.com/docs/describe_alert/](https://paws-r-sdk.com/docs/describe_alert/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_anomaly_detection_executions/](https://paws-r-sdk.com/docs/describe_anomaly_detection_executions/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
...
#' Describes a detector.
#'
#' See [https://paws-r-sdk.com/docs/describe_anomaly_detector/](https://paws-r-sdk.com/docs/describe_anomaly_detector/) for full documentation.
#'
...
#' Describes a dataset.
#'
#' See [https://paws-r-sdk.com/docs/describe_metric_set/](https://paws-r-sdk.com/docs/describe_metric_set/) for full documentation.
#'
...
#' Detects an Amazon S3 dataset's file format, interval, and offset.
#'
#' See [https://paws-r-sdk.com/docs/detect_metric_set_config/](https://paws-r-sdk.com/docs/detect_metric_set_config/) for full documentation.
#'
...
#' Returns details about a group of anomalous metrics.
#'
#' See [https://paws-r-sdk.com/docs/get_anomaly_group/](https://paws-r-sdk.com/docs/get_anomaly_group/) for full documentation.
#'
...
#' Returns details about the requested data quality metrics.
#'
#' See [https://paws-r-sdk.com/docs/get_data_quality_metrics/](https://paws-r-sdk.com/docs/get_data_quality_metrics/) for full documentation.
#'
...
#' Get feedback for an anomaly group.
#'
#' See [https://paws-r-sdk.com/docs/get_feedback/](https://paws-r-sdk.com/docs/get_feedback/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
...
#' Returns a selection of sample records from an Amazon S3 datasource.
#'
#' See [https://paws-r-sdk.com/docs/get_sample_data/](https://paws-r-sdk.com/docs/get_sample_data/) for full documentation.
#'
...
#' Lists the alerts attached to a detector.
#'
#' See [https://paws-r-sdk.com/docs/list_alerts/](https://paws-r-sdk.com/docs/list_alerts/) for full documentation.
#'
...
#' Lists the detectors in the current AWS Region.
#'
#' See [https://paws-r-sdk.com/docs/list_anomaly_detectors/](https://paws-r-sdk.com/docs/list_anomaly_detectors/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return.
...
#'
#' See [https://paws-r-sdk.com/docs/list_anomaly_group_related_metrics/](https://paws-r-sdk.com/docs/list_anomaly_group_related_metrics/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
#' @param AnomalyGroupId &#91;required&#93; The ID of the anomaly group.
...
#' Returns a list of anomaly groups.
#'
#' See [https://paws-r-sdk.com/docs/list_anomaly_group_summaries/](https://paws-r-sdk.com/docs/list_anomaly_group_summaries/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
...
#' Gets a list of anomalous metrics for a measure in an anomaly group.
#'
#' See [https://paws-r-sdk.com/docs/list_anomaly_group_time_series/](https://paws-r-sdk.com/docs/list_anomaly_group_time_series/) for full documentation.
#'
#' @param AnomalyDetectorArn &#91;required&#93; The Amazon Resource Name (ARN) of the anomaly detector.
#' @param AnomalyGroupId &#91;required&#93; The ID of the anomaly group.
...
#' Lists the datasets in the current AWS Region.
#'
#' See [https://paws-r-sdk.com/docs/list_metric_sets/](https://paws-r-sdk.com/docs/list_metric_sets/) for full documentation.
#'
...
#' Make changes to an existing alert.
#'
#' See [https://paws-r-sdk.com/docs/update_alert/](https://paws-r-sdk.com/docs/update_alert/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_anomaly_detector/](https://paws-r-sdk.com/docs/update_anomaly_detector/) for full documentation.
#'
...
#' Updates a dataset.
#'
#' See [https://paws-r-sdk.com/docs/update_metric_set/](https://paws-r-sdk.com/docs/update_metric_set/) for full documentation.
#'
