...
#'
#' See [https://paws-r-sdk.com/docs/send_ssh_public_key/](https://paws-r-sdk.com/docs/send_ssh_public_key/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/send_serial_console_ssh_public_key/](https://paws-r-sdk.com/docs/send_serial_console_ssh_public_key/) for full documentation.
#'
#' @param InstanceId &#91;required&#93; The ID of the EC2 instance.
