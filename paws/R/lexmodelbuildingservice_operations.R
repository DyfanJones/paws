...
#' 
#' You can update only the `$LATEST` version of the bot. You can't update the numbered versions that you create with the [`create_bot_version`][lexmodelbuildingservice_create_bot_version] operation.
#' 
...
#' 
#' You can update only the `$LATEST` version of the intent. You can't update the numbered versions that you create with the [`create_intent_version`][lexmodelbuildingservice_create_intent_version] operation.
#' 
...
#' 
#' You can update only the `$LATEST` version of a slot type. You can't update the numbered versions that you create with the [`create_slot_type_version`][lexmodelbuildingservice_create_slot_type_version] operation.
#' 
...
#' 
#' Amazon Lex stores utterances indefinitely for improving the ability of your bot to respond to user inputs. These utterances are not removed when the bot is deleted. To remove the utterances, use the [`delete_utterances`][lexmodelbuildingservice_delete_utterances] operation.
#' 
#' If a bot has an alias, you can't delete it. Instead, the [`delete_bot`][lexmodelbuildingservice_delete_bot] operation returns a `ResourceInUseException` exception that includes a reference to the alias that refers to the bot. To remove the reference to the bot, delete the alias. If you get the same exception again, delete the referring alias until the [`delete_bot`][lexmodelbuildingservice_delete_bot] operation is successful.
#' 
...
#' Deletes an alias for the specified bot.
#' 
#' You can't delete an alias that is used in the association between a bot and a messaging channel. If an alias is used in a channel association, the [`delete_bot`][lexmodelbuildingservice_delete_bot] operation returns a `ResourceInUseException` exception that includes a reference to the channel association that refers to the bot. You can remove the reference to the alias by deleting the channel association. If you get the same exception again, delete the referring association until the [`delete_bot_alias`][lexmodelbuildingservice_delete_bot_alias] operation is successful.
#'
#' @usage
...
#' @param version &#91;required&#93; The version of the bot to delete. You cannot delete the `$LATEST` version of the bot. To delete the `$LATEST` version, use the [`delete_bot`][lexmodelbuildingservice_delete_bot] operation.
#'
#' @return
#' An empty list.
#'
...
#' 
#' If you get the `ResourceInUseException` exception, it provides an example reference that shows where the intent is referenced. To remove the reference to the intent, either update the bot or delete it. If you get the same exception when you attempt to delete the intent again, repeat until the intent has no references and the call to [`delete_intent`][lexmodelbuildingservice_delete_intent] is successful.
#' 
...
#' @param version &#91;required&#93; The version of the intent to delete. You cannot delete the `$LATEST` version of the intent. To delete the `$LATEST` version, use the [`delete_intent`][lexmodelbuildingservice_delete_intent] operation.
#'
#' @return
#' An empty list.
#'
...
#' 
#' If you get the `ResourceInUseException` exception, the exception provides an example reference that shows the intent where the slot type is referenced. To remove the reference to the slot type, either update the intent or delete it. If you get the same exception when you attempt to delete the slot type again, repeat until the slot type has no references and the [`delete_slot_type`][lexmodelbuildingservice_delete_slot_type] call is successful.
#' 
...
#' @param version &#91;required&#93; The version of the slot type to delete. You cannot delete the `$LATEST` version of the slot type. To delete the `$LATEST` version, use the [`delete_slot_type`][lexmodelbuildingservice_delete_slot_type] operation.
#'
#' @return
#' An empty list.
#'
...
#' Deletes stored utterances.
#' 
#' Amazon Lex stores the utterances that users send to your bot. Utterances are stored for 15 days for use with the [`get_utterances_view`][lexmodelbuildingservice_get_utterances_view] operation, and then stored indefinitely for use in improving the ability of your bot to respond to user input.
#' 
#' Use the [`delete_utterances`][lexmodelbuildingservice_delete_utterances] operation to manually delete stored utterances for a specific user. When you use the [`delete_utterances`][lexmodelbuildingservice_delete_utterances] operation, utterances stored for improving your bot's ability to respond to user input are deleted immediately. Utterances stored for use with the [`get_utterances_view`][lexmodelbuildingservice_get_utterances_view] operation are deleted after 15 days.
#' 
...
#' @param userId &#91;required&#93; The unique identifier for the user that made the utterances. This is the user ID that was sent in the PostContent or PostText operation request that contained the utterance.
#'
#' @return
#' An empty list.
#'
...
#' Returns a list of all of the channels associated with the specified bot.
#' 
#' The [`get_bot_channel_associations`][lexmodelbuildingservice_get_bot_channel_associations] operation requires permissions for the `lex:GetBotChannelAssociations` action.
#'
#' @usage
...
#' Gets information about all of the versions of a bot.
#' 
#' The [`get_bot_versions`][lexmodelbuildingservice_get_bot_versions] operation returns a `BotMetadata` object for each version of a bot. For example, if a bot has three numbered versions, the [`get_bot_versions`][lexmodelbuildingservice_get_bot_versions] operation returns four `BotMetadata` objects in the response, one for each numbered version and one for the `$LATEST` version.
#' 
#' The [`get_bot_versions`][lexmodelbuildingservice_get_bot_versions] operation always returns at least one version, the `$LATEST` version.
#' 
...
#'
#' @param signature &#91;required&#93; The unique identifier for a built-in intent. To find the signature for an intent, see [Standard Built-in Intents](https://developer.amazon.com/en-US/docs/alexa/custom-skills/standard-built-in-intents.html) in the *Alexa Skills Kit*.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' Gets a list of built-in slot types that meet the specified criteria.
#' 
#' For a list of built-in slot types, see [Slot Type Reference](https://developer.amazon.com/en-US/docs/alexa/custom-skills/slot-type-reference.html) in the *Alexa Skills Kit*.
#' 
...
#' Gets information about all of the versions of an intent.
#' 
#' The [`get_intent_versions`][lexmodelbuildingservice_get_intent_versions] operation returns an `IntentMetadata` object for each version of an intent. For example, if an intent has three numbered versions, the [`get_intent_versions`][lexmodelbuildingservice_get_intent_versions] operation returns four `IntentMetadata` objects in the response, one for each numbered version and one for the `$LATEST` version.
#' 
#' The [`get_intent_versions`][lexmodelbuildingservice_get_intent_versions] operation always returns at least one version, the `$LATEST` version.
#' 
...
#'
#' @param migrationId &#91;required&#93; The unique identifier of the migration to view. The `migrationID` is returned by the operation.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param sortByAttribute The field to sort the list of migrations by. You can sort by the Amazon Lex V1 bot name or the date and time that the migration was started.
#' @param sortByOrder The order so sort the list.
#' @param v1BotNameContains Filters the list to contain only bots whose name contains the specified string. The string is matched anywhere in bot name.
#' @param migrationStatusEquals Filters the list to contain only migrations in the specified state.
#' @param maxResults The maximum number of migrations to return in the response. The default is 10.
#' @param nextToken A pagination token that fetches the next page of migrations. If the response to this operation is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of migrations, specify the pagination token in the request.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' Gets information about all versions of a slot type.
#' 
#' The [`get_slot_type_versions`][lexmodelbuildingservice_get_slot_type_versions] operation returns a `SlotTypeMetadata` object for each version of a slot type. For example, if a slot type has three numbered versions, the [`get_slot_type_versions`][lexmodelbuildingservice_get_slot_type_versions] operation returns four `SlotTypeMetadata` objects in the response, one for each numbered version and one for the `$LATEST` version.
#' 
#' The [`get_slot_type_versions`][lexmodelbuildingservice_get_slot_type_versions] operation always returns at least one version, the `$LATEST` version.
#' 
...
#' 
#' For example, say that you have created a bot to order flowers. After your users have used your bot for a while, use the [`get_utterances_view`][lexmodelbuildingservice_get_utterances_view] operation to see the requests that they have made and whether they have been successful. You might find that the utterance "I want flowers" is not being recognized. You could add this utterance to the `OrderFlowers` intent so that your bot recognizes that utterance.
#' 
...
#' @param createVersion When set to `true` a new numbered version of the bot is created. This is the same as calling the [`create_bot_version`][lexmodelbuildingservice_create_bot_version] operation. If you don't specify `createVersion`, the default is `false`.
#' @param tags A list of tags to add to the bot. You can only add tags when you create a bot, you can't use the [`put_bot`][lexmodelbuildingservice_put_bot] operation to update the tags on a bot. To update tags, use the [`tag_resource`][lexmodelbuildingservice_tag_resource] operation.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param tags A list of tags to add to the bot alias. You can only add tags when you create an alias, you can't use the [`put_bot_alias`][lexmodelbuildingservice_put_bot_alias] operation to update the tags on a bot alias. To update tags, use the [`tag_resource`][lexmodelbuildingservice_tag_resource] operation.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' 
#' For a list of built-in intents, see [Standard Built-in Intents](https://developer.amazon.com/en-US/docs/alexa/custom-skills/standard-built-in-intents.html) in the *Alexa Skills Kit*.
...
#' @param parentIntentSignature A unique identifier for the built-in intent to base this intent on. To find the signature for an intent, see [Standard Built-in Intents](https://developer.amazon.com/en-US/docs/alexa/custom-skills/standard-built-in-intents.html) in the *Alexa Skills Kit*.
#' @param checksum Identifies a specific revision of the `$LATEST` version.
#' 
#' When you create a new intent, leave the `checksum` field blank. If you specify a checksum you get a `BadRequestException` exception.
#' 
#' When you want to update a intent, set the `checksum` field to the checksum of the most recent revision of the `$LATEST` version. If you don't specify the ` checksum` field, or if the checksum does not match the `$LATEST` version, you get a `PreconditionFailedException` exception.
#' @param createVersion When set to `true` a new numbered version of the intent is created. This is the same as calling the [`create_intent_version`][lexmodelbuildingservice_create_intent_version] operation. If you do not specify `createVersion`, the default is `false`.
#' @param kendraConfiguration Configuration information required to use the `AMAZON.KendraSearchIntent` intent to connect to an Amazon Kendra index. For more information, see AMAZON.KendraSearchIntent.
#' @param inputContexts An array of `InputContext` objects that lists the contexts that must be active for Amazon Lex to choose the intent in a conversation with the user.
#' @param outputContexts An array of `OutputContext` objects that lists the contexts that the intent activates when the intent is fulfilled.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param createVersion When set to `true` a new numbered version of the slot type is created. This is the same as calling the [`create_slot_type_version`][lexmodelbuildingservice_create_slot_type_version] operation. If you do not specify `createVersion`, the default is `false`.
...
#' @param mergeStrategy &#91;required&#93; Specifies the action that the [`start_import`][lexmodelbuildingservice_start_import] operation should take when there is an existing resource with the same name.
#' 
#' -   FAIL_ON_CONFLICT - The import operation is stopped on the first conflict between a resource in the import file and an existing resource. The name of the resource causing the conflict is in the `failureReason` field of the response to the [`get_import`][lexmodelbuildingservice_get_import] operation.
#' 
...
#'
#' @param v1BotName &#91;required&#93; The name of the Amazon Lex V1 bot that you are migrating to Amazon Lex V2.
#' @param v1BotVersion &#91;required&#93; The version of the bot to migrate to Amazon Lex V2. You can migrate the `$LATEST` version as well as any numbered version.
#' @param v2BotName &#91;required&#93; The name of the Amazon Lex V2 bot that you are migrating the Amazon Lex V1 bot to.
#' 
