...
#'
#' See [https://paws-r-sdk.com/docs/apply_archive_rule/](https://paws-r-sdk.com/docs/apply_archive_rule/) for full documentation.
#'
...
#' Cancels the requested policy generation.
#'
#' See [https://paws-r-sdk.com/docs/cancel_policy_generation/](https://paws-r-sdk.com/docs/cancel_policy_generation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_access_preview/](https://paws-r-sdk.com/docs/create_access_preview/) for full documentation.
#'
...
#' Creates an analyzer for your account.
#'
#' See [https://paws-r-sdk.com/docs/create_analyzer/](https://paws-r-sdk.com/docs/create_analyzer/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_archive_rule/](https://paws-r-sdk.com/docs/create_archive_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_analyzer/](https://paws-r-sdk.com/docs/delete_analyzer/) for full documentation.
#'
...
#' Deletes the specified archive rule.
#'
#' See [https://paws-r-sdk.com/docs/delete_archive_rule/](https://paws-r-sdk.com/docs/delete_archive_rule/) for full documentation.
#'
...
#' Retrieves information about an access preview for the specified analyzer.
#'
#' See [https://paws-r-sdk.com/docs/get_access_preview/](https://paws-r-sdk.com/docs/get_access_preview/) for full documentation.
#'
...
#' Retrieves information about a resource that was analyzed.
#'
#' See [https://paws-r-sdk.com/docs/get_analyzed_resource/](https://paws-r-sdk.com/docs/get_analyzed_resource/) for full documentation.
#'
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
...
#' Retrieves information about the specified analyzer.
#'
#' See [https://paws-r-sdk.com/docs/get_analyzer/](https://paws-r-sdk.com/docs/get_analyzer/) for full documentation.
#'
...
#' Retrieves information about an archive rule.
#'
#' See [https://paws-r-sdk.com/docs/get_archive_rule/](https://paws-r-sdk.com/docs/get_archive_rule/) for full documentation.
#'
...
#' Retrieves information about the specified finding.
#'
#' See [https://paws-r-sdk.com/docs/get_finding/](https://paws-r-sdk.com/docs/get_finding/) for full documentation.
#'
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
...
#'
#' See [https://paws-r-sdk.com/docs/get_generated_policy/](https://paws-r-sdk.com/docs/get_generated_policy/) for full documentation.
#'
#' @param jobId &#91;required&#93; The `JobId` that is returned by the
#' [`start_policy_generation`][accessanalyzer_start_policy_generation]
#' operation. The `JobId` can be used with
...
#'
#' See [https://paws-r-sdk.com/docs/list_access_preview_findings/](https://paws-r-sdk.com/docs/list_access_preview_findings/) for full documentation.
#'
#' @param accessPreviewId &#91;required&#93; The unique ID for the access preview.
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
...
#' Retrieves a list of access previews for the specified analyzer.
#'
#' See [https://paws-r-sdk.com/docs/list_access_previews/](https://paws-r-sdk.com/docs/list_access_previews/) for full documentation.
#'
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
#' used to generate the access preview.
...
#'
#' See [https://paws-r-sdk.com/docs/list_analyzed_resources/](https://paws-r-sdk.com/docs/list_analyzed_resources/) for full documentation.
#'
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
...
#' Retrieves a list of analyzers.
#'
#' See [https://paws-r-sdk.com/docs/list_analyzers/](https://paws-r-sdk.com/docs/list_analyzers/) for full documentation.
#'
#' @param nextToken A token used for pagination of results returned.
#' @param maxResults The maximum number of results to return in the response.
...
#' Retrieves a list of archive rules created for the specified analyzer.
#'
#' See [https://paws-r-sdk.com/docs/list_archive_rules/](https://paws-r-sdk.com/docs/list_archive_rules/) for full documentation.
#'
#' @param analyzerName &#91;required&#93; The name of the analyzer to retrieve rules from.
#' @param nextToken A token used for pagination of results returned.
...
#' Lists all of the policy generations requested in the last seven days.
#'
#' See [https://paws-r-sdk.com/docs/list_policy_generations/](https://paws-r-sdk.com/docs/list_policy_generations/) for full documentation.
#'
...
#' Starts the policy generation request.
#'
#' See [https://paws-r-sdk.com/docs/start_policy_generation/](https://paws-r-sdk.com/docs/start_policy_generation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_resource_scan/](https://paws-r-sdk.com/docs/start_resource_scan/) for full documentation.
#'
#' @param analyzerArn &#91;required&#93; The [ARN of the
#' analyzer](https://docs.aws.amazon.com/IAM/latest/UserGuide/access-analyzer-getting-started.html#permission-resources)
...
#' Updates the criteria and values for the specified archive rule.
#'
#' See [https://paws-r-sdk.com/docs/update_archive_rule/](https://paws-r-sdk.com/docs/update_archive_rule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/validate_policy/](https://paws-r-sdk.com/docs/validate_policy/) for full documentation.
#'
