...
#'
#' See [https://paws-r-sdk.com/docs/create_cli_token/](https://paws-r-sdk.com/docs/create_cli_token/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_web_login_token/](https://paws-r-sdk.com/docs/create_web_login_token/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the Amazon MWAA environment. For example,
#' `MyMWAAEnvironment`.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/publish_metrics/](https://paws-r-sdk.com/docs/publish_metrics/) for full documentation.
#'
