...
#'
#' See [https://paws-r-sdk.com/docs/describe_affected_accounts_for_organization/](https://paws-r-sdk.com/docs/describe_affected_accounts_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_affected_entities/](https://paws-r-sdk.com/docs/describe_affected_entities/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_affected_entities_for_organization/](https://paws-r-sdk.com/docs/describe_affected_entities_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_entity_aggregates/](https://paws-r-sdk.com/docs/describe_entity_aggregates/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_event_aggregates/](https://paws-r-sdk.com/docs/describe_event_aggregates/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_event_details/](https://paws-r-sdk.com/docs/describe_event_details/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_event_details_for_organization/](https://paws-r-sdk.com/docs/describe_event_details_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_event_types/](https://paws-r-sdk.com/docs/describe_event_types/) for full documentation.
#'
#' @param filter Values to narrow the results returned.
#' @param locale The locale (language) to return information in. English (en) is the
#' default and the only supported value at this time.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_events_for_organization/](https://paws-r-sdk.com/docs/describe_events_for_organization/) for full documentation.
#'
#' @param filter Values to narrow the results returned.
#' @param nextToken If the results of a search are large, only a portion of the results are
#' returned, and a `nextToken` pagination token is returned in the
...
#'
#' See [https://paws-r-sdk.com/docs/describe_health_service_status_for_organization/](https://paws-r-sdk.com/docs/describe_health_service_status_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disable_health_service_access_for_organization/](https://paws-r-sdk.com/docs/disable_health_service_access_for_organization/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/enable_health_service_access_for_organization/](https://paws-r-sdk.com/docs/enable_health_service_access_for_organization/) for full documentation.
#'
