...
#' Creates an Amazon Forecast predictor.
#' 
#' Amazon Forecast creates predictors with AutoPredictor, which involves applying the optimal combination of algorithms to each time series in your datasets. You can use [`create_auto_predictor`][forecastservice_create_auto_predictor] to create new predictors or upgrade/retrain existing predictors.
#' 
...
#' 
#' To get a list of all your datasets, use the [`list_datasets`][forecastservice_list_datasets] operation.
#' 
...
#' 
#' The `Status` of a dataset must be `ACTIVE` before you can import training data. Use the [`describe_dataset`][forecastservice_describe_dataset] operation to get the status.
#'
#' @usage
...
#' 
#' To get a list of all your datasets groups, use the [`list_dataset_groups`][forecastservice_list_dataset_groups] operation.
#' 
#' The `Status` of a dataset group must be `ACTIVE` before you can use the dataset group to create a predictor. To get the status, use the [`describe_dataset_group`][forecastservice_describe_dataset_group] operation.
#'
#' @usage
...
#' 
#' To get a list of all your dataset import jobs, filtered by specified criteria, use the [`list_dataset_import_jobs`][forecastservice_list_dataset_import_jobs] operation.
#'
#' @usage
...
#' 
#' You can only have one Explainability resource per predictor. If you already enabled `ExplainPredictor` in [`create_auto_predictor`][forecastservice_create_auto_predictor], that predictor already has an Explainability resource.
#' 
...
#' 
#' The `Status` of the export job must be `ACTIVE` before you can access the export in your Amazon S3 bucket. To get the status, use the [`describe_explainability_export`][forecastservice_describe_explainability_export] operation.
#'
#' @usage
...
#' 
#' The range of the forecast is determined by the `ForecastHorizon` value, which you specify in the [`create_predictor`][forecastservice_create_predictor] request. When you query a forecast, you can request a specific date range within the forecast.
#' 
#' To get a list of all your forecasts, use the [`list_forecasts`][forecastservice_list_forecasts] operation.
#' 
#' The forecasts generated by Amazon Forecast are in the same time zone as the dataset that was used to create the predictor.
#' 
#' For more information, see howitworks-forecast.
#' 
#' The `Status` of the forecast must be `ACTIVE` before you can query or export the forecast. Use the [`describe_forecast`][forecastservice_describe_forecast] operation to get the status.
#' 
...
#' For more information, see howitworks-forecast.
#' 
#' To get a list of all your forecast export jobs, use the [`list_forecast_export_jobs`][forecastservice_list_forecast_export_jobs] operation.
#' 
#' The `Status` of the forecast export job must be `ACTIVE` before you can access the forecast in your Amazon S3 bucket. To get the status, use the [`describe_forecast_export_job`][forecastservice_describe_forecast_export_job] operation.
#'
#' @usage
...
#' 
#' Amazon Forecast uses the algorithm to train a predictor using the latest version of the datasets in the specified dataset group. You can then generate a forecast using the [`create_forecast`][forecastservice_create_forecast] operation.
#' 
#' To see the evaluation metrics, use the [`get_accuracy_metrics`][forecastservice_get_accuracy_metrics] operation.
#' 
...
#' 
#' For RELATED_TIME_SERIES datasets, [`create_predictor`][forecastservice_create_predictor] verifies that the `DataFrequency` specified when the dataset was created matches the `ForecastFrequency`. TARGET_TIME_SERIES datasets don't have this restriction. Amazon Forecast also verifies the delimiter and timestamp format. For more information, see howitworks-datasets-groups.
#' 
...
#' -   `TrainingParameters`
#' 
#' To get a list of all of your predictors, use the [`list_predictors`][forecastservice_list_predictors] operation.
#' 
#' Before you can use the predictor to create a forecast, the `Status` of the predictor must be `ACTIVE`, signifying that training has completed. To get the status, use the [`describe_predictor`][forecastservice_describe_predictor] operation.
#'
#' @usage
...
#' You must specify a DataDestination object that includes an Amazon S3 bucket and an Identity and Access Management (IAM) role that Amazon Forecast can assume to access the Amazon S3 bucket. For more information, see aws-forecast-iam-roles.
#' 
#' The `Status` of the export job must be `ACTIVE` before you can access the export in your Amazon S3 bucket. To get the status, use the [`describe_predictor_backtest_export_job`][forecastservice_describe_predictor_backtest_export_job] operation.
#'
#' @usage
...
#' For more information, see howitworks-forecast.
#' 
#' To get a list of all your what-if forecast export jobs, use the [`list_what_if_forecast_exports`][forecastservice_list_what_if_forecast_exports] operation.
#' 
#' The `Status` of the forecast export job must be `ACTIVE` before you can access the forecast in your Amazon S3 bucket. To get the status, use the [`describe_what_if_forecast_export`][forecastservice_describe_what_if_forecast_export] operation.
#'
#' @usage
...
#' 
#' Forecast does not automatically update any dataset groups that contain the deleted dataset. In order to update the dataset group, use the [`update_dataset_group`][forecastservice_update_dataset_group] operation, omitting the deleted dataset's ARN.
#'
#' @usage
...
#' Deletes an Explainability resource.
#' 
#' You can delete only predictor that have a status of `ACTIVE` or `CREATE_FAILED`. To get the status, use the [`describe_explainability`][forecastservice_describe_explainability] operation.
#'
#' @usage
...
#' 
#' [`delete_resource_tree`][forecastservice_delete_resource_tree] will only delete Amazon Forecast resources, and will not delete datasets or exported files stored in Amazon S3.
#'
#' @usage
...
#' 
#' In addition to listing the parameters specified in the [`create_dataset`][forecastservice_create_dataset] request, this operation includes the following dataset properties:
#' 
#' -   `CreationTime`
#' 
...
#' 
#' In addition to listing the parameters provided in the [`create_dataset_group`][forecastservice_create_dataset_group] request, this operation includes the following properties:
#' 
...
#' 
#' In addition to listing the parameters provided in the [`create_dataset_import_job`][forecastservice_create_dataset_import_job] request, this operation includes the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' In addition to listing the properties provided in the [`create_forecast`][forecastservice_create_forecast] request, this operation lists the following properties:
#' 
...
#' 
#' In addition to listing the properties provided by the user in the [`create_forecast_export_job`][forecastservice_create_forecast_export_job] request, this operation lists the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' Describes a predictor created using the [`create_predictor`][forecastservice_create_predictor] operation.
#' 
#' In addition to listing the properties provided in the [`create_predictor`][forecastservice_create_predictor] request, this operation lists the following properties:
#' 
...
#' 
#' In addition to listing the properties provided by the user in the [`create_predictor_backtest_export_job`][forecastservice_create_predictor_backtest_export_job] request, this operation lists the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' In addition to listing the properties provided in the [`create_what_if_analysis`][forecastservice_create_what_if_analysis] request, this operation lists the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' In addition to listing the properties provided in the [`create_what_if_forecast`][forecastservice_create_what_if_forecast] request, this operation lists the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' In addition to listing the properties provided in the [`create_what_if_forecast_export`][forecastservice_create_what_if_forecast_export] request, this operation lists the following properties:
#' 
#' -   `CreationTime`
#' 
#' -   `LastModificationTime`
...
#' 
#' This operation generates metrics for each backtest window that was evaluated. The number of backtest windows (`NumberOfBacktestWindows`) is specified using the EvaluationParameters object, which is optionally included in the [`create_predictor`][forecastservice_create_predictor] request. If `NumberOfBacktestWindows` isn't specified, the number defaults to one.
#' 
...
#' 
#' Before you can get accuracy metrics, the `Status` of the predictor must be `ACTIVE`, signifying that training has completed. To get the status, use the [`describe_predictor`][forecastservice_describe_predictor] operation.
#'
#' @usage
...
#' 
#' To retrieve the complete set of properties for a particular Explainability resource, use the ARN with the [`describe_explainability`][forecastservice_describe_explainability] operation.
#'
#' @usage
...
#' 
#' To retrieve the complete set of properties for a particular Explainability export, use the ARN with the [`describe_explainability`][forecastservice_describe_explainability] operation.
#'
#' @usage
...
#' 
#' To retrieve the complete set of properties for a particular backtest export job, use the ARN with the [`describe_predictor_backtest_export_job`][forecastservice_describe_predictor_backtest_export_job] operation.
#'
#' @usage
...
#' 
#' You can retrieve the complete set of properties by using the ARN with the [`describe_auto_predictor`][forecastservice_describe_auto_predictor] and [`describe_predictor`][forecastservice_describe_predictor] operations. You can filter the list using an array of Filter objects.
#'
#' @usage
...
#' Replaces the datasets in a dataset group with the specified datasets.
#' 
#' The `Status` of the dataset group must be `ACTIVE` before you can use the dataset group to create a predictor. Use the [`describe_dataset_group`][forecastservice_describe_dataset_group] operation to get the status.
#'
#' @usage
