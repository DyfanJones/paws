...
#' @section Operations:
#' \tabular{ll}{
#'  \link[=organizations_accept_handshake]{accept_handshake} \tab Accepts a handshake by sending an ACCEPTED response to the sender\cr
...
#'  \link[=organizations_decline_handshake]{decline_handshake} \tab Declines a Handshake\cr
...
#'  \link[=organizations_describe_handshake]{describe_handshake} \tab Returns details for a handshake\cr
...
#'  \link[=organizations_describe_responsibility_transfer]{describe_responsibility_transfer} \tab Returns details for a transfer\cr
...
#'  \link[=organizations_invite_organization_to_transfer_responsibility]{invite_organization_to_transfer_responsibility} \tab Sends an invitation to another organization's management account to designate your account with the specified responsibilities for their organization\cr
...
#'  \link[=organizations_list_accounts_with_invalid_effective_policy]{list_accounts_with_invalid_effective_policy} \tab Lists all the accounts in an organization that have invalid effective policies\cr
...
#'  \link[=organizations_list_effective_policy_validation_errors]{list_effective_policy_validation_errors} \tab Lists all the validation errors on an effective policy for a specified account and policy type\cr
#'  \link[=organizations_list_handshakes_for_account]{list_handshakes_for_account} \tab Lists the recent handshakes that you have received\cr
#'  \link[=organizations_list_handshakes_for_organization]{list_handshakes_for_organization} \tab Lists the recent handshakes that you have sent\cr
#'  \link[=organizations_list_inbound_responsibility_transfers]{list_inbound_responsibility_transfers} \tab Lists transfers that allow you to manage the specified responsibilities for another organization\cr
...
#'  \link[=organizations_list_outbound_responsibility_transfers]{list_outbound_responsibility_transfers} \tab Lists transfers that allow an account outside your organization to manage the specified responsibilities for your organization\cr
...
#'  \link[=organizations_terminate_responsibility_transfer]{terminate_responsibility_transfer} \tab Ends a transfer\cr
...
#'  \link[=organizations_update_policy]{update_policy} \tab Updates an existing policy with a new name, description, or content\cr
#'  \link[=organizations_update_responsibility_transfer]{update_responsibility_transfer} \tab Updates a transfer
#' }
#'
#' @return
...
.organizations$metadata <- list(
  ...
  endpoints = list("aws-global" = list(endpoint = "organizations.us-east-1.amazonaws.com", global = TRUE, signing_region = "us-east-1"), "us-east-1" = list(endpoint = "organizations.us-east-1.amazonaws.com", global = TRUE), "aws-cn-global" = list(endpoint = "organizations.cn-northwest-1.amazonaws.com.cn", global = TRUE, signing_region = "cn-northwest-1"), "cn-northwest-1" = list(endpoint = "organizations.cn-northwest-1.amazonaws.com.cn", global = TRUE), "aws-us-gov-global" = list(endpoint = "organizations.us-gov-west-1.amazonaws.com", global = TRUE, signing_region = "us-gov-west-1"), "us-gov-west-1" = list(endpoint = "organizations.us-gov-west-1.amazonaws.com", global = TRUE), "aws-iso-global" = list(endpoint = "organizations.us-iso-east-1.c2s.ic.gov", global = TRUE, signing_region = "us-iso-east-1"), "us-iso-east-1" = list(endpoint = "organizations.us-iso-east-1.c2s.ic.gov", global = TRUE), "aws-iso-b-global" = list(endpoint = "organizations.us-isob-east-1.sc2s.sgov.gov", global = TRUE, signing_region = "us-isob-east-1"), "us-isob-east-1" = list(endpoint = "organizations.us-isob-east-1.sc2s.sgov.gov", global = TRUE), "aws-iso-e-global" = list(endpoint = "organizations.eu-isoe-west-1.cloud.adc-e.uk", global = TRUE, signing_region = "eu-isoe-west-1"), "eu-isoe-west-1" = list(endpoint = "organizations.eu-isoe-west-1.cloud.adc-e.uk", global = TRUE), "aws-iso-f-global" = list(endpoint = "organizations.us-isof-south-1.csp.hci.ic.gov", global = TRUE, signing_region = "us-isof-south-1"), "us-isof-south-1" = list(endpoint = "organizations.us-isof-south-1.csp.hci.ic.gov", global = TRUE), "^(us|eu|ap|sa|ca|me|af|il|mx)\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-east-1.amazonaws.com", global = FALSE, signing_region = "us-east-1"), "^cn\\-\\w+\\-\\d+$" = list(endpoint = "organizations.cn-northwest-1.amazonaws.com.cn", global = FALSE, signing_region = "cn-northwest-1"), "^us\\-gov\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-gov-west-1.amazonaws.com", global = FALSE, signing_region = "us-gov-west-1"), "^us\\-iso\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-iso-east-1.c2s.ic.gov", global = FALSE, signing_region = "us-iso-east-1"), "^us\\-isob\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-isob-east-1.sc2s.sgov.gov", global = FALSE, signing_region = "us-isob-east-1"), "^eu\\-isoe\\-\\w+\\-\\d+$" = list(endpoint = "organizations.eu-isoe-west-1.cloud.adc-e.uk", global = FALSE, signing_region = "eu-isoe-west-1"), "^us\\-isof\\-\\w+\\-\\d+$" = list(endpoint = "organizations.us-isof-south-1.csp.hci.ic.gov", global = FALSE, signing_region = "us-isof-south-1"), "^eusc\\-(de)\\-\\w+\\-\\d+$" = list(endpoint = "organizations.{region}.amazonaws.eu", global = FALSE)),
