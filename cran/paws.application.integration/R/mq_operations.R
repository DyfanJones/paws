...
#'
#' See [https://paws-r-sdk.com/docs/create_broker/](https://paws-r-sdk.com/docs/create_broker/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_broker/](https://paws-r-sdk.com/docs/delete_broker/) for full documentation.
#'
#' @param BrokerId &#91;required&#93; The unique ID that Amazon MQ generates for the broker.
#'
#' @keywords internal
...
#' Returns information about the specified broker.
#'
#' See [https://paws-r-sdk.com/docs/describe_broker/](https://paws-r-sdk.com/docs/describe_broker/) for full documentation.
#'
#' @param BrokerId &#91;required&#93; The unique ID that Amazon MQ generates for the broker.
#'
#' @keywords internal
...
#' Describe available engine types and versions.
#'
#' See [https://paws-r-sdk.com/docs/describe_broker_engine_types/](https://paws-r-sdk.com/docs/describe_broker_engine_types/) for full documentation.
#'
...
#' Describe available broker instance options.
#'
#' See [https://paws-r-sdk.com/docs/describe_broker_instance_options/](https://paws-r-sdk.com/docs/describe_broker_instance_options/) for full documentation.
#'
#' @param EngineType Filter response by engine type.
...
#' Returns a list of all brokers.
#'
#' See [https://paws-r-sdk.com/docs/list_brokers/](https://paws-r-sdk.com/docs/list_brokers/) for full documentation.
#'
#' @param MaxResults The maximum number of brokers that Amazon MQ can return per page (20 by
#' default). This value must be an integer from 5 to 100.
#' @param NextToken The token that specifies the next page of results Amazon MQ should
...
#' Adds a pending configuration change to a broker.
#'
#' See [https://paws-r-sdk.com/docs/update_broker/](https://paws-r-sdk.com/docs/update_broker/) for full documentation.
#'
#' @param AuthenticationStrategy Optional. The authentication strategy used to secure the broker. The
#' default is SIMPLE.
