...
#' 
#' For an example of using the [`create_rescore_execution_plan`][kendraranking_create_rescore_execution_plan] API, including using the Python and Java SDKs, see [Semantically ranking a search service's results](https://docs.aws.amazon.com/kendra/latest/dg/search-service-rerank.html).
#'
#' @usage
