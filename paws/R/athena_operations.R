...
#' 
#' To stream query results successfully, the IAM principal with permission to call [`get_query_results`][athena_get_query_results] also must have permissions to the Amazon S3 `GetObject` action for the Athena query results location.
#' 
#' IAM principals with permission to the Amazon S3 `GetObject` action for the query results location are able to retrieve query results from Amazon S3 even if permission to the [`get_query_results`][athena_get_query_results] action is denied. To restrict user or role access, ensure that Amazon S3 permissions to the Athena query location are denied.
#'
#' @usage
