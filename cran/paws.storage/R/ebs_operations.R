...
#'
#' See [https://paws-r-sdk.com/docs/complete_snapshot/](https://paws-r-sdk.com/docs/complete_snapshot/) for full documentation.
#'
...
#' Returns the data in a block in an Amazon Elastic Block Store snapshot.
#'
#' See [https://paws-r-sdk.com/docs/get_snapshot_block/](https://paws-r-sdk.com/docs/get_snapshot_block/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_changed_blocks/](https://paws-r-sdk.com/docs/list_changed_blocks/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_snapshot_blocks/](https://paws-r-sdk.com/docs/list_snapshot_blocks/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_snapshot_block/](https://paws-r-sdk.com/docs/put_snapshot_block/) for full documentation.
#'
#' @param SnapshotId &#91;required&#93; The ID of the snapshot.
#' 
#' If the specified snapshot is encrypted, you must have permission to use
...
#'
#' See [https://paws-r-sdk.com/docs/start_snapshot/](https://paws-r-sdk.com/docs/start_snapshot/) for full documentation.
#'
