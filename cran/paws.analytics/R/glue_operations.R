...
#' Creates one or more partitions in a batch operation.
#'
#' See [https://paws-r-sdk.com/docs/batch_create_partition/](https://paws-r-sdk.com/docs/batch_create_partition/) for full documentation.
#'
...
#' Deletes a list of connection definitions from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_connection/](https://paws-r-sdk.com/docs/batch_delete_connection/) for full documentation.
#'
...
#' Deletes one or more partitions in a batch operation.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_partition/](https://paws-r-sdk.com/docs/batch_delete_partition/) for full documentation.
#'
...
#' Deletes multiple tables at once.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_table/](https://paws-r-sdk.com/docs/batch_delete_table/) for full documentation.
#'
...
#' Deletes a specified batch of versions of a table.
#'
#' See [https://paws-r-sdk.com/docs/batch_delete_table_version/](https://paws-r-sdk.com/docs/batch_delete_table_version/) for full documentation.
#'
...
#' Retrieves information about a list of blueprints.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_blueprints/](https://paws-r-sdk.com/docs/batch_get_blueprints/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_crawlers/](https://paws-r-sdk.com/docs/batch_get_crawlers/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_custom_entity_types/](https://paws-r-sdk.com/docs/batch_get_custom_entity_types/) for full documentation.
#'
...
#' Retrieves a list of data quality results for the specified result IDs.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_data_quality_result/](https://paws-r-sdk.com/docs/batch_get_data_quality_result/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_dev_endpoints/](https://paws-r-sdk.com/docs/batch_get_dev_endpoints/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_jobs/](https://paws-r-sdk.com/docs/batch_get_jobs/) for full documentation.
#'
...
#' Retrieves partitions in a batch request.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_partition/](https://paws-r-sdk.com/docs/batch_get_partition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_triggers/](https://paws-r-sdk.com/docs/batch_get_triggers/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/batch_get_workflows/](https://paws-r-sdk.com/docs/batch_get_workflows/) for full documentation.
#'
...
#' Stops one or more job runs for a specified job definition.
#'
#' See [https://paws-r-sdk.com/docs/batch_stop_job_run/](https://paws-r-sdk.com/docs/batch_stop_job_run/) for full documentation.
#'
...
#' Updates one or more partitions in a batch operation.
#'
#' See [https://paws-r-sdk.com/docs/batch_update_partition/](https://paws-r-sdk.com/docs/batch_update_partition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/cancel_data_quality_rule_recommendation_run/](https://paws-r-sdk.com/docs/cancel_data_quality_rule_recommendation_run/) for full documentation.
#'
...
#' Cancels a run where a ruleset is being evaluated against a data source.
#'
#' See [https://paws-r-sdk.com/docs/cancel_data_quality_ruleset_evaluation_run/](https://paws-r-sdk.com/docs/cancel_data_quality_ruleset_evaluation_run/) for full documentation.
#'
#' @param RunId &#91;required&#93; The unique run identifier associated with this run.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/cancel_ml_task_run/](https://paws-r-sdk.com/docs/cancel_ml_task_run/) for full documentation.
#'
...
#' Cancels the statement.
#'
#' See [https://paws-r-sdk.com/docs/cancel_statement/](https://paws-r-sdk.com/docs/cancel_statement/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/check_schema_version_validity/](https://paws-r-sdk.com/docs/check_schema_version_validity/) for full documentation.
#'
...
#' Registers a blueprint with Glue.
#'
#' See [https://paws-r-sdk.com/docs/create_blueprint/](https://paws-r-sdk.com/docs/create_blueprint/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_classifier/](https://paws-r-sdk.com/docs/create_classifier/) for full documentation.
#'
...
#' Creates a connection definition in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/create_connection/](https://paws-r-sdk.com/docs/create_connection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_crawler/](https://paws-r-sdk.com/docs/create_crawler/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_custom_entity_type/](https://paws-r-sdk.com/docs/create_custom_entity_type/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_data_quality_ruleset/](https://paws-r-sdk.com/docs/create_data_quality_ruleset/) for full documentation.
#'
...
#' Creates a new database in a Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/create_database/](https://paws-r-sdk.com/docs/create_database/) for full documentation.
#'
...
#' Creates a new development endpoint.
#'
#' See [https://paws-r-sdk.com/docs/create_dev_endpoint/](https://paws-r-sdk.com/docs/create_dev_endpoint/) for full documentation.
#'
...
#' Creates a new job definition.
#'
#' See [https://paws-r-sdk.com/docs/create_job/](https://paws-r-sdk.com/docs/create_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_ml_transform/](https://paws-r-sdk.com/docs/create_ml_transform/) for full documentation.
#'
...
#' Creates a new partition.
#'
#' See [https://paws-r-sdk.com/docs/create_partition/](https://paws-r-sdk.com/docs/create_partition/) for full documentation.
#'
...
#' Creates a specified partition index in an existing table.
#'
#' See [https://paws-r-sdk.com/docs/create_partition_index/](https://paws-r-sdk.com/docs/create_partition_index/) for full documentation.
#'
...
#' Creates a new registry which may be used to hold a collection of schemas.
#'
#' See [https://paws-r-sdk.com/docs/create_registry/](https://paws-r-sdk.com/docs/create_registry/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_schema/](https://paws-r-sdk.com/docs/create_schema/) for full documentation.
#'
...
#' Transforms a directed acyclic graph (DAG) into code.
#'
#' See [https://paws-r-sdk.com/docs/create_script/](https://paws-r-sdk.com/docs/create_script/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_security_configuration/](https://paws-r-sdk.com/docs/create_security_configuration/) for full documentation.
#'
...
#' Creates a new session.
#'
#' See [https://paws-r-sdk.com/docs/create_session/](https://paws-r-sdk.com/docs/create_session/) for full documentation.
#'
...
#' Creates a new table definition in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/create_table/](https://paws-r-sdk.com/docs/create_table/) for full documentation.
#'
...
#' Creates a new trigger.
#'
#' See [https://paws-r-sdk.com/docs/create_trigger/](https://paws-r-sdk.com/docs/create_trigger/) for full documentation.
#'
...
#' Creates a new function definition in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/create_user_defined_function/](https://paws-r-sdk.com/docs/create_user_defined_function/) for full documentation.
#'
...
#' Creates a new workflow.
#'
#' See [https://paws-r-sdk.com/docs/create_workflow/](https://paws-r-sdk.com/docs/create_workflow/) for full documentation.
#'
...
#' Deletes an existing blueprint.
#'
#' See [https://paws-r-sdk.com/docs/delete_blueprint/](https://paws-r-sdk.com/docs/delete_blueprint/) for full documentation.
#'
...
#' Removes a classifier from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/delete_classifier/](https://paws-r-sdk.com/docs/delete_classifier/) for full documentation.
#'
...
#' Delete the partition column statistics of a column.
#'
#' See [https://paws-r-sdk.com/docs/delete_column_statistics_for_partition/](https://paws-r-sdk.com/docs/delete_column_statistics_for_partition/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Retrieves table statistics of columns.
#'
#' See [https://paws-r-sdk.com/docs/delete_column_statistics_for_table/](https://paws-r-sdk.com/docs/delete_column_statistics_for_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Deletes a connection from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/delete_connection/](https://paws-r-sdk.com/docs/delete_connection/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_crawler/](https://paws-r-sdk.com/docs/delete_crawler/) for full documentation.
#'
...
#' Deletes a custom pattern by specifying its name.
#'
#' See [https://paws-r-sdk.com/docs/delete_custom_entity_type/](https://paws-r-sdk.com/docs/delete_custom_entity_type/) for full documentation.
#'
...
#' Deletes a data quality ruleset.
#'
#' See [https://paws-r-sdk.com/docs/delete_data_quality_ruleset/](https://paws-r-sdk.com/docs/delete_data_quality_ruleset/) for full documentation.
#'
...
#' Removes a specified database from a Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/delete_database/](https://paws-r-sdk.com/docs/delete_database/) for full documentation.
#'
...
#' Deletes a specified development endpoint.
#'
#' See [https://paws-r-sdk.com/docs/delete_dev_endpoint/](https://paws-r-sdk.com/docs/delete_dev_endpoint/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_job/](https://paws-r-sdk.com/docs/delete_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_ml_transform/](https://paws-r-sdk.com/docs/delete_ml_transform/) for full documentation.
#'
...
#' Deletes a specified partition.
#'
#' See [https://paws-r-sdk.com/docs/delete_partition/](https://paws-r-sdk.com/docs/delete_partition/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partition to be deleted resides. If
#' none is provided, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database in which the table in question resides.
...
#' Deletes a specified partition index from an existing table.
#'
#' See [https://paws-r-sdk.com/docs/delete_partition_index/](https://paws-r-sdk.com/docs/delete_partition_index/) for full documentation.
#'
#' @param CatalogId The catalog ID where the table resides.
...
#'
#' See [https://paws-r-sdk.com/docs/delete_registry/](https://paws-r-sdk.com/docs/delete_registry/) for full documentation.
#'
...
#' Deletes a specified policy.
#'
#' See [https://paws-r-sdk.com/docs/delete_resource_policy/](https://paws-r-sdk.com/docs/delete_resource_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_schema/](https://paws-r-sdk.com/docs/delete_schema/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_schema_versions/](https://paws-r-sdk.com/docs/delete_schema_versions/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure that may contain the schema name and Amazon
#' Resource Name (ARN).
...
#' Deletes a specified security configuration.
#'
#' See [https://paws-r-sdk.com/docs/delete_security_configuration/](https://paws-r-sdk.com/docs/delete_security_configuration/) for full documentation.
#'
...
#' Deletes the session.
#'
#' See [https://paws-r-sdk.com/docs/delete_session/](https://paws-r-sdk.com/docs/delete_session/) for full documentation.
#'
...
#' Removes a table definition from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/delete_table/](https://paws-r-sdk.com/docs/delete_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the table resides. If none is provided,
#' the Amazon Web Services account ID is used by default.
...
#' Deletes a specified version of a table.
#'
#' See [https://paws-r-sdk.com/docs/delete_table_version/](https://paws-r-sdk.com/docs/delete_table_version/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the tables reside. If none is provided,
#' the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The database in the catalog in which the table resides. For Hive
...
#'
#' See [https://paws-r-sdk.com/docs/delete_trigger/](https://paws-r-sdk.com/docs/delete_trigger/) for full documentation.
#'
...
#' Deletes an existing function definition from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/delete_user_defined_function/](https://paws-r-sdk.com/docs/delete_user_defined_function/) for full documentation.
#'
...
#' Deletes a workflow.
#'
#' See [https://paws-r-sdk.com/docs/delete_workflow/](https://paws-r-sdk.com/docs/delete_workflow/) for full documentation.
#'
...
#' Retrieves the details of a blueprint.
#'
#' See [https://paws-r-sdk.com/docs/get_blueprint/](https://paws-r-sdk.com/docs/get_blueprint/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the blueprint.
#' @param IncludeBlueprint Specifies whether or not to include the blueprint in the response.
...
#' Retrieves the details of a blueprint run.
#'
#' See [https://paws-r-sdk.com/docs/get_blueprint_run/](https://paws-r-sdk.com/docs/get_blueprint_run/) for full documentation.
#'
...
#' Retrieves the details of blueprint runs for a specified blueprint.
#'
#' See [https://paws-r-sdk.com/docs/get_blueprint_runs/](https://paws-r-sdk.com/docs/get_blueprint_runs/) for full documentation.
#'
#' @param BlueprintName &#91;required&#93; The name of the blueprint.
...
#' Retrieves the status of a migration operation.
#'
#' See [https://paws-r-sdk.com/docs/get_catalog_import_status/](https://paws-r-sdk.com/docs/get_catalog_import_status/) for full documentation.
#'
...
#' Retrieve a classifier by name.
#'
#' See [https://paws-r-sdk.com/docs/get_classifier/](https://paws-r-sdk.com/docs/get_classifier/) for full documentation.
#'
...
#' Lists all classifier objects in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_classifiers/](https://paws-r-sdk.com/docs/get_classifiers/) for full documentation.
#'
...
#' Retrieves partition statistics of columns.
#'
#' See [https://paws-r-sdk.com/docs/get_column_statistics_for_partition/](https://paws-r-sdk.com/docs/get_column_statistics_for_partition/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Retrieves table statistics of columns.
#'
#' See [https://paws-r-sdk.com/docs/get_column_statistics_for_table/](https://paws-r-sdk.com/docs/get_column_statistics_for_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Retrieves a connection definition from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_connection/](https://paws-r-sdk.com/docs/get_connection/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog in which the connection resides. If none is
#' provided, the Amazon Web Services account ID is used by default.
...
#' Retrieves a list of connection definitions from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_connections/](https://paws-r-sdk.com/docs/get_connections/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog in which the connections reside. If none is
#' provided, the Amazon Web Services account ID is used by default.
...
#' Retrieves metadata for a specified crawler.
#'
#' See [https://paws-r-sdk.com/docs/get_crawler/](https://paws-r-sdk.com/docs/get_crawler/) for full documentation.
#'
...
#' Retrieves metrics about specified crawlers.
#'
#' See [https://paws-r-sdk.com/docs/get_crawler_metrics/](https://paws-r-sdk.com/docs/get_crawler_metrics/) for full documentation.
#'
...
#' Retrieves metadata for all crawlers defined in the customer account.
#'
#' See [https://paws-r-sdk.com/docs/get_crawlers/](https://paws-r-sdk.com/docs/get_crawlers/) for full documentation.
#'
...
#' Retrieves the details of a custom pattern by specifying its name.
#'
#' See [https://paws-r-sdk.com/docs/get_custom_entity_type/](https://paws-r-sdk.com/docs/get_custom_entity_type/) for full documentation.
#'
...
#' Retrieves the security configuration for a specified catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_data_catalog_encryption_settings/](https://paws-r-sdk.com/docs/get_data_catalog_encryption_settings/) for full documentation.
#'
...
#' Retrieves the result of a data quality rule evaluation.
#'
#' See [https://paws-r-sdk.com/docs/get_data_quality_result/](https://paws-r-sdk.com/docs/get_data_quality_result/) for full documentation.
#'
...
#' Gets the specified recommendation run that was used to generate rules.
#'
#' See [https://paws-r-sdk.com/docs/get_data_quality_rule_recommendation_run/](https://paws-r-sdk.com/docs/get_data_quality_rule_recommendation_run/) for full documentation.
#'
#' @param RunId &#91;required&#93; The unique run identifier associated with this run.
#'
#' @keywords internal
...
#' Returns an existing ruleset by identifier or name.
#'
#' See [https://paws-r-sdk.com/docs/get_data_quality_ruleset/](https://paws-r-sdk.com/docs/get_data_quality_ruleset/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_data_quality_ruleset_evaluation_run/](https://paws-r-sdk.com/docs/get_data_quality_ruleset_evaluation_run/) for full documentation.
#'
#' @param RunId &#91;required&#93; The unique run identifier associated with this run.
#'
#' @keywords internal
...
#' Retrieves the definition of a specified database.
#'
#' See [https://paws-r-sdk.com/docs/get_database/](https://paws-r-sdk.com/docs/get_database/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog in which the database resides. If none is
#' provided, the Amazon Web Services account ID is used by default.
...
#' Retrieves all databases defined in a given Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_databases/](https://paws-r-sdk.com/docs/get_databases/) for full documentation.
#'
...
#' Transforms a Python script into a directed acyclic graph (DAG).
#'
#' See [https://paws-r-sdk.com/docs/get_dataflow_graph/](https://paws-r-sdk.com/docs/get_dataflow_graph/) for full documentation.
#'
...
#' Retrieves information about a specified development endpoint.
#'
#' See [https://paws-r-sdk.com/docs/get_dev_endpoint/](https://paws-r-sdk.com/docs/get_dev_endpoint/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_dev_endpoints/](https://paws-r-sdk.com/docs/get_dev_endpoints/) for full documentation.
#'
...
#' Retrieves an existing job definition.
#'
#' See [https://paws-r-sdk.com/docs/get_job/](https://paws-r-sdk.com/docs/get_job/) for full documentation.
#'
...
#' Returns information on a job bookmark entry.
#'
#' See [https://paws-r-sdk.com/docs/get_job_bookmark/](https://paws-r-sdk.com/docs/get_job_bookmark/) for full documentation.
#'
...
#' Retrieves the metadata for a given job run.
#'
#' See [https://paws-r-sdk.com/docs/get_job_run/](https://paws-r-sdk.com/docs/get_job_run/) for full documentation.
#'
...
#' Retrieves metadata for all runs of a given job definition.
#'
#' See [https://paws-r-sdk.com/docs/get_job_runs/](https://paws-r-sdk.com/docs/get_job_runs/) for full documentation.
#'
...
#' Retrieves all current job definitions.
#'
#' See [https://paws-r-sdk.com/docs/get_jobs/](https://paws-r-sdk.com/docs/get_jobs/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation call.
#' @param MaxResults The maximum size of the response.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_ml_task_run/](https://paws-r-sdk.com/docs/get_ml_task_run/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
...
#'
#' See [https://paws-r-sdk.com/docs/get_ml_task_runs/](https://paws-r-sdk.com/docs/get_ml_task_runs/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
...
#'
#' See [https://paws-r-sdk.com/docs/get_ml_transform/](https://paws-r-sdk.com/docs/get_ml_transform/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_ml_transforms/](https://paws-r-sdk.com/docs/get_ml_transforms/) for full documentation.
#'
...
#' Creates mappings.
#'
#' See [https://paws-r-sdk.com/docs/get_mapping/](https://paws-r-sdk.com/docs/get_mapping/) for full documentation.
#'
...
#' Retrieves information about a specified partition.
#'
#' See [https://paws-r-sdk.com/docs/get_partition/](https://paws-r-sdk.com/docs/get_partition/) for full documentation.
#'
...
#' Retrieves the partition indexes associated with a table.
#'
#' See [https://paws-r-sdk.com/docs/get_partition_indexes/](https://paws-r-sdk.com/docs/get_partition_indexes/) for full documentation.
#'
#' @param CatalogId The catalog ID where the table resides.
...
#' Retrieves information about the partitions in a table.
#'
#' See [https://paws-r-sdk.com/docs/get_partitions/](https://paws-r-sdk.com/docs/get_partitions/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is provided, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Gets code to perform a specified mapping.
#'
#' See [https://paws-r-sdk.com/docs/get_plan/](https://paws-r-sdk.com/docs/get_plan/) for full documentation.
#'
...
#' Describes the specified registry in detail.
#'
#' See [https://paws-r-sdk.com/docs/get_registry/](https://paws-r-sdk.com/docs/get_registry/) for full documentation.
#'
#' @param RegistryId &#91;required&#93; This is a wrapper structure that may contain the registry name and
#' Amazon Resource Name (ARN).
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_resource_policies/](https://paws-r-sdk.com/docs/get_resource_policies/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
#'
...
#' Retrieves a specified resource policy.
#'
#' See [https://paws-r-sdk.com/docs/get_resource_policy/](https://paws-r-sdk.com/docs/get_resource_policy/) for full documentation.
#'
...
#' Describes the specified schema in detail.
#'
#' See [https://paws-r-sdk.com/docs/get_schema/](https://paws-r-sdk.com/docs/get_schema/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_schema_by_definition/](https://paws-r-sdk.com/docs/get_schema_by_definition/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure to contain schema identity fields. The
#' structure contains:
#' 
...
#'
#' See [https://paws-r-sdk.com/docs/get_schema_version/](https://paws-r-sdk.com/docs/get_schema_version/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_schema_versions_diff/](https://paws-r-sdk.com/docs/get_schema_versions_diff/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure to contain schema identity fields. The
#' structure contains:
#' 
...
#' Retrieves a specified security configuration.
#'
#' See [https://paws-r-sdk.com/docs/get_security_configuration/](https://paws-r-sdk.com/docs/get_security_configuration/) for full documentation.
#'
...
#' Retrieves a list of all security configurations.
#'
#' See [https://paws-r-sdk.com/docs/get_security_configurations/](https://paws-r-sdk.com/docs/get_security_configurations/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return.
#' @param NextToken A continuation token, if this is a continuation call.
#'
...
#' Retrieves the session.
#'
#' See [https://paws-r-sdk.com/docs/get_session/](https://paws-r-sdk.com/docs/get_session/) for full documentation.
#'
...
#' Retrieves the statement.
#'
#' See [https://paws-r-sdk.com/docs/get_statement/](https://paws-r-sdk.com/docs/get_statement/) for full documentation.
#'
...
#' Retrieves the `Table` definition in a Data Catalog for a specified table.
#'
#' See [https://paws-r-sdk.com/docs/get_table/](https://paws-r-sdk.com/docs/get_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the table resides. If none is provided,
#' the Amazon Web Services account ID is used by default.
...
#' Retrieves a specified version of a table.
#'
#' See [https://paws-r-sdk.com/docs/get_table_version/](https://paws-r-sdk.com/docs/get_table_version/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the tables reside. If none is provided,
#' the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The database in the catalog in which the table resides. For Hive
...
#'
#' See [https://paws-r-sdk.com/docs/get_table_versions/](https://paws-r-sdk.com/docs/get_table_versions/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the tables reside. If none is provided,
#' the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The database in the catalog in which the table resides. For Hive
...
#'
#' See [https://paws-r-sdk.com/docs/get_tables/](https://paws-r-sdk.com/docs/get_tables/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the tables reside. If none is provided,
#' the Amazon Web Services account ID is used by default.
...
#' Retrieves a list of tags associated with a resource.
#'
#' See [https://paws-r-sdk.com/docs/get_tags/](https://paws-r-sdk.com/docs/get_tags/) for full documentation.
#'
...
#' Retrieves the definition of a trigger.
#'
#' See [https://paws-r-sdk.com/docs/get_trigger/](https://paws-r-sdk.com/docs/get_trigger/) for full documentation.
#'
...
#' Gets all the triggers associated with a job.
#'
#' See [https://paws-r-sdk.com/docs/get_triggers/](https://paws-r-sdk.com/docs/get_triggers/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation call.
...
#'
#' See [https://paws-r-sdk.com/docs/get_unfiltered_partition_metadata/](https://paws-r-sdk.com/docs/get_unfiltered_partition_metadata/) for full documentation.
#'
...
#' Retrieves partition metadata from the Data Catalog that contains unfiltered metadata.
#'
#' See [https://paws-r-sdk.com/docs/get_unfiltered_partitions_metadata/](https://paws-r-sdk.com/docs/get_unfiltered_partitions_metadata/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_unfiltered_table_metadata/](https://paws-r-sdk.com/docs/get_unfiltered_table_metadata/) for full documentation.
#'
...
#' Retrieves a specified function definition from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_user_defined_function/](https://paws-r-sdk.com/docs/get_user_defined_function/) for full documentation.
#'
...
#' Retrieves multiple function definitions from the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/get_user_defined_functions/](https://paws-r-sdk.com/docs/get_user_defined_functions/) for full documentation.
#'
...
#' Retrieves resource metadata for a workflow.
#'
#' See [https://paws-r-sdk.com/docs/get_workflow/](https://paws-r-sdk.com/docs/get_workflow/) for full documentation.
#'
...
#' Retrieves the metadata for a given workflow run.
#'
#' See [https://paws-r-sdk.com/docs/get_workflow_run/](https://paws-r-sdk.com/docs/get_workflow_run/) for full documentation.
#'
...
#' Retrieves the workflow run properties which were set during the run.
#'
#' See [https://paws-r-sdk.com/docs/get_workflow_run_properties/](https://paws-r-sdk.com/docs/get_workflow_run_properties/) for full documentation.
#'
...
#' Retrieves metadata for all runs of a given workflow.
#'
#' See [https://paws-r-sdk.com/docs/get_workflow_runs/](https://paws-r-sdk.com/docs/get_workflow_runs/) for full documentation.
#'
...
#' Imports an existing Amazon Athena Data Catalog to Glue.
#'
#' See [https://paws-r-sdk.com/docs/import_catalog_to_glue/](https://paws-r-sdk.com/docs/import_catalog_to_glue/) for full documentation.
#'
...
#' Lists all the blueprint names in an account.
#'
#' See [https://paws-r-sdk.com/docs/list_blueprints/](https://paws-r-sdk.com/docs/list_blueprints/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
...
#'
#' See [https://paws-r-sdk.com/docs/list_crawlers/](https://paws-r-sdk.com/docs/list_crawlers/) for full documentation.
#'
#' @param MaxResults The maximum size of a list to return.
#' @param NextToken A continuation token, if this is a continuation request.
...
#'
#' See [https://paws-r-sdk.com/docs/list_crawls/](https://paws-r-sdk.com/docs/list_crawls/) for full documentation.
#'
...
#' Lists all the custom patterns that have been created.
#'
#' See [https://paws-r-sdk.com/docs/list_custom_entity_types/](https://paws-r-sdk.com/docs/list_custom_entity_types/) for full documentation.
#'
#' @param NextToken A paginated token to offset the results.
#' @param MaxResults The maximum number of results to return.
...
#' Returns all data quality execution results for your account.
#'
#' See [https://paws-r-sdk.com/docs/list_data_quality_results/](https://paws-r-sdk.com/docs/list_data_quality_results/) for full documentation.
#'
...
#' Lists the recommendation runs meeting the filter criteria.
#'
#' See [https://paws-r-sdk.com/docs/list_data_quality_rule_recommendation_runs/](https://paws-r-sdk.com/docs/list_data_quality_rule_recommendation_runs/) for full documentation.
#'
#' @param Filter The filter criteria.
#' @param NextToken A paginated token to offset the results.
#' @param MaxResults The maximum number of results to return.
...
#'
#' See [https://paws-r-sdk.com/docs/list_data_quality_ruleset_evaluation_runs/](https://paws-r-sdk.com/docs/list_data_quality_ruleset_evaluation_runs/) for full documentation.
#'
#' @param Filter The filter criteria.
#' @param NextToken A paginated token to offset the results.
#' @param MaxResults The maximum number of results to return.
...
#'
#' See [https://paws-r-sdk.com/docs/list_data_quality_rulesets/](https://paws-r-sdk.com/docs/list_data_quality_rulesets/) for full documentation.
#'
#' @param NextToken A paginated token to offset the results.
#' @param MaxResults The maximum number of results to return.
#' @param Filter The filter criteria.
...
#'
#' See [https://paws-r-sdk.com/docs/list_dev_endpoints/](https://paws-r-sdk.com/docs/list_dev_endpoints/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
#' @param Tags Specifies to return only these tagged resources.
...
#'
#' See [https://paws-r-sdk.com/docs/list_jobs/](https://paws-r-sdk.com/docs/list_jobs/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
#' @param Tags Specifies to return only these tagged resources.
...
#'
#' See [https://paws-r-sdk.com/docs/list_ml_transforms/](https://paws-r-sdk.com/docs/list_ml_transforms/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
...
#'
#' See [https://paws-r-sdk.com/docs/list_registries/](https://paws-r-sdk.com/docs/list_registries/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_schema_versions/](https://paws-r-sdk.com/docs/list_schema_versions/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure to contain schema identity fields. The
#' structure contains:
#' 
...
#'
#' See [https://paws-r-sdk.com/docs/list_schemas/](https://paws-r-sdk.com/docs/list_schemas/) for full documentation.
#'
...
#' Retrieve a list of sessions.
#'
#' See [https://paws-r-sdk.com/docs/list_sessions/](https://paws-r-sdk.com/docs/list_sessions/) for full documentation.
#'
...
#' Lists statements for the session.
#'
#' See [https://paws-r-sdk.com/docs/list_statements/](https://paws-r-sdk.com/docs/list_statements/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_triggers/](https://paws-r-sdk.com/docs/list_triggers/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
...
#' Lists names of workflows created in the account.
#'
#' See [https://paws-r-sdk.com/docs/list_workflows/](https://paws-r-sdk.com/docs/list_workflows/) for full documentation.
#'
#' @param NextToken A continuation token, if this is a continuation request.
#' @param MaxResults The maximum size of a list to return.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_data_catalog_encryption_settings/](https://paws-r-sdk.com/docs/put_data_catalog_encryption_settings/) for full documentation.
#'
...
#' Sets the Data Catalog resource policy for access control.
#'
#' See [https://paws-r-sdk.com/docs/put_resource_policy/](https://paws-r-sdk.com/docs/put_resource_policy/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_schema_version_metadata/](https://paws-r-sdk.com/docs/put_schema_version_metadata/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/put_workflow_run_properties/](https://paws-r-sdk.com/docs/put_workflow_run_properties/) for full documentation.
#'
#' @param Name &#91;required&#93; Name of the workflow which was run.
...
#' Queries for the schema version metadata information.
#'
#' See [https://paws-r-sdk.com/docs/query_schema_version_metadata/](https://paws-r-sdk.com/docs/query_schema_version_metadata/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/register_schema_version/](https://paws-r-sdk.com/docs/register_schema_version/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure to contain schema identity fields. The
#' structure contains:
#' 
...
#'
#' See [https://paws-r-sdk.com/docs/remove_schema_version_metadata/](https://paws-r-sdk.com/docs/remove_schema_version_metadata/) for full documentation.
#'
#' @param SchemaId A wrapper structure that may contain the schema name and Amazon Resource
#' Name (ARN).
#' @param SchemaVersionNumber The version number of the schema.
...
#' Resets a bookmark entry.
#'
#' See [https://paws-r-sdk.com/docs/reset_job_bookmark/](https://paws-r-sdk.com/docs/reset_job_bookmark/) for full documentation.
#'
#' @param JobName &#91;required&#93; The name of the job in question.
#' @param RunId The unique run identifier associated with this job run.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/resume_workflow_run/](https://paws-r-sdk.com/docs/resume_workflow_run/) for full documentation.
#'
...
#' Executes the statement.
#'
#' See [https://paws-r-sdk.com/docs/run_statement/](https://paws-r-sdk.com/docs/run_statement/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/search_tables/](https://paws-r-sdk.com/docs/search_tables/) for full documentation.
#'
...
#' Starts a new run of the specified blueprint.
#'
#' See [https://paws-r-sdk.com/docs/start_blueprint_run/](https://paws-r-sdk.com/docs/start_blueprint_run/) for full documentation.
#'
#' @param BlueprintName &#91;required&#93; The name of the blueprint.
...
#'
#' See [https://paws-r-sdk.com/docs/start_crawler/](https://paws-r-sdk.com/docs/start_crawler/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_crawler_schedule/](https://paws-r-sdk.com/docs/start_crawler_schedule/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_data_quality_rule_recommendation_run/](https://paws-r-sdk.com/docs/start_data_quality_rule_recommendation_run/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_data_quality_ruleset_evaluation_run/](https://paws-r-sdk.com/docs/start_data_quality_ruleset_evaluation_run/) for full documentation.
#'
#' @param DataSource &#91;required&#93; The data source (Glue table) associated with this run.
#' @param Role &#91;required&#93; An IAM role supplied to encrypt the results of the run.
#' @param NumberOfWorkers The number of `G.1X` workers to be used in the run. The default is 5.
...
#'
#' See [https://paws-r-sdk.com/docs/start_export_labels_task_run/](https://paws-r-sdk.com/docs/start_export_labels_task_run/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
...
#'
#' See [https://paws-r-sdk.com/docs/start_import_labels_task_run/](https://paws-r-sdk.com/docs/start_import_labels_task_run/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
...
#' Starts a job run using a job definition.
#'
#' See [https://paws-r-sdk.com/docs/start_job_run/](https://paws-r-sdk.com/docs/start_job_run/) for full documentation.
#'
...
#' Starts a task to estimate the quality of the transform.
#'
#' See [https://paws-r-sdk.com/docs/start_ml_evaluation_task_run/](https://paws-r-sdk.com/docs/start_ml_evaluation_task_run/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/start_ml_labeling_set_generation_task_run/](https://paws-r-sdk.com/docs/start_ml_labeling_set_generation_task_run/) for full documentation.
#'
#' @param TransformId &#91;required&#93; The unique identifier of the machine learning transform.
...
#'
#' See [https://paws-r-sdk.com/docs/start_trigger/](https://paws-r-sdk.com/docs/start_trigger/) for full documentation.
#'
...
#' Starts a new run of the specified workflow.
#'
#' See [https://paws-r-sdk.com/docs/start_workflow_run/](https://paws-r-sdk.com/docs/start_workflow_run/) for full documentation.
#'
...
#' If the specified crawler is running, stops the crawl.
#'
#' See [https://paws-r-sdk.com/docs/stop_crawler/](https://paws-r-sdk.com/docs/stop_crawler/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/stop_crawler_schedule/](https://paws-r-sdk.com/docs/stop_crawler_schedule/) for full documentation.
#'
...
#' Stops the session.
#'
#' See [https://paws-r-sdk.com/docs/stop_session/](https://paws-r-sdk.com/docs/stop_session/) for full documentation.
#'
...
#' Stops a specified trigger.
#'
#' See [https://paws-r-sdk.com/docs/stop_trigger/](https://paws-r-sdk.com/docs/stop_trigger/) for full documentation.
#'
...
#' Stops the execution of the specified workflow run.
#'
#' See [https://paws-r-sdk.com/docs/stop_workflow_run/](https://paws-r-sdk.com/docs/stop_workflow_run/) for full documentation.
#'
...
#' Updates a registered blueprint.
#'
#' See [https://paws-r-sdk.com/docs/update_blueprint/](https://paws-r-sdk.com/docs/update_blueprint/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the blueprint.
#' @param Description A description of the blueprint.
#' @param BlueprintLocation &#91;required&#93; Specifies a path in Amazon S3 where the blueprint is published.
...
#'
#' See [https://paws-r-sdk.com/docs/update_classifier/](https://paws-r-sdk.com/docs/update_classifier/) for full documentation.
#'
...
#' Creates or updates partition statistics of columns.
#'
#' See [https://paws-r-sdk.com/docs/update_column_statistics_for_partition/](https://paws-r-sdk.com/docs/update_column_statistics_for_partition/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Creates or updates table statistics of columns.
#'
#' See [https://paws-r-sdk.com/docs/update_column_statistics_for_table/](https://paws-r-sdk.com/docs/update_column_statistics_for_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the partitions in question reside. If
#' none is supplied, the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database where the partitions reside.
...
#' Updates a connection definition in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/update_connection/](https://paws-r-sdk.com/docs/update_connection/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog in which the connection resides. If none is
#' provided, the Amazon Web Services account ID is used by default.
...
#'
#' See [https://paws-r-sdk.com/docs/update_crawler/](https://paws-r-sdk.com/docs/update_crawler/) for full documentation.
#'
#' @param Name &#91;required&#93; Name of the new crawler.
...
#' Updates the schedule of a crawler using a `cron` expression.
#'
#' See [https://paws-r-sdk.com/docs/update_crawler_schedule/](https://paws-r-sdk.com/docs/update_crawler_schedule/) for full documentation.
#'
...
#' Updates the specified data quality ruleset.
#'
#' See [https://paws-r-sdk.com/docs/update_data_quality_ruleset/](https://paws-r-sdk.com/docs/update_data_quality_ruleset/) for full documentation.
#'
...
#' Updates an existing database definition in a Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/update_database/](https://paws-r-sdk.com/docs/update_database/) for full documentation.
#'
...
#' Updates a specified development endpoint.
#'
#' See [https://paws-r-sdk.com/docs/update_dev_endpoint/](https://paws-r-sdk.com/docs/update_dev_endpoint/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_job/](https://paws-r-sdk.com/docs/update_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_job_from_source_control/](https://paws-r-sdk.com/docs/update_job_from_source_control/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_ml_transform/](https://paws-r-sdk.com/docs/update_ml_transform/) for full documentation.
#'
...
#' Updates a partition.
#'
#' See [https://paws-r-sdk.com/docs/update_partition/](https://paws-r-sdk.com/docs/update_partition/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_registry/](https://paws-r-sdk.com/docs/update_registry/) for full documentation.
#'
#' @param RegistryId &#91;required&#93; This is a wrapper structure that may contain the registry name and
#' Amazon Resource Name (ARN).
...
#'
#' See [https://paws-r-sdk.com/docs/update_schema/](https://paws-r-sdk.com/docs/update_schema/) for full documentation.
#'
#' @param SchemaId &#91;required&#93; This is a wrapper structure to contain schema identity fields. The
#' structure contains:
#' 
...
#'
#' See [https://paws-r-sdk.com/docs/update_source_control_from_job/](https://paws-r-sdk.com/docs/update_source_control_from_job/) for full documentation.
#'
#' @param JobName The name of the Glue job to be synchronized to or from the remote
#' repository.
#' @param Provider The provider for the remote repository.
...
#' Updates a metadata table in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/update_table/](https://paws-r-sdk.com/docs/update_table/) for full documentation.
#'
#' @param CatalogId The ID of the Data Catalog where the table resides. If none is provided,
#' the Amazon Web Services account ID is used by default.
#' @param DatabaseName &#91;required&#93; The name of the catalog database in which the table resides. For Hive
...
#' Updates a trigger definition.
#'
#' See [https://paws-r-sdk.com/docs/update_trigger/](https://paws-r-sdk.com/docs/update_trigger/) for full documentation.
#'
...
#' Updates an existing function definition in the Data Catalog.
#'
#' See [https://paws-r-sdk.com/docs/update_user_defined_function/](https://paws-r-sdk.com/docs/update_user_defined_function/) for full documentation.
#'
...
#' Updates an existing workflow.
#'
#' See [https://paws-r-sdk.com/docs/update_workflow/](https://paws-r-sdk.com/docs/update_workflow/) for full documentation.
#'
