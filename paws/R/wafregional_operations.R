...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `ByteMatchSet`. You then use [`update_byte_match_set`][wafregional_update_byte_match_set] to identify the part of a web request that you want AWS WAF to inspect, such as the values of the `User-Agent` header or the query string. For example, you can create a `ByteMatchSet` that matches any requests with `User-Agent` headers that contain the string `BadBot`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_byte_match_set`][wafregional_create_byte_match_set] request.
#' 
#' 2.  Submit a [`create_byte_match_set`][wafregional_create_byte_match_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_byte_match_set`][wafregional_update_byte_match_set] request.
#' 
#' 4.  Submit an [`update_byte_match_set`][wafregional_update_byte_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
...
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
...
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_geo_match_set`][wafregional_create_geo_match_set] request.
#' 
#' 2.  Submit a [`create_geo_match_set`][wafregional_create_geo_match_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_geo_match_set`][wafregional_update_geo_match_set] request.
#' 
...
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_ip_set`][wafregional_create_ip_set] request.
#' 
#' 2.  Submit a [`create_ip_set`][wafregional_create_ip_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][wafregional_update_ip_set] request.
#' 
#' 4.  Submit an [`update_ip_set`][wafregional_update_ip_set] request to specify the IP addresses that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 
#' 1.  Create and update the predicates that you want to include in the rule. For more information, see [`create_byte_match_set`][wafregional_create_byte_match_set], [`create_ip_set`][wafregional_create_ip_set], and [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_rule`][wafregional_create_rule] request.
#' 
#' 3.  Submit a [`create_rate_based_rule`][wafregional_create_rate_based_rule] request.
#' 
#' 4.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][wafregional_update_rule] request.
#' 
#' 5.  Submit an [`update_rate_based_rule`][wafregional_update_rate_based_rule] request to specify the predicates that you want to include in the rule.
#' 
#' 6.  Create and update a `WebACL` that contains the `RateBasedRule`. For more information, see [`create_web_acl`][wafregional_create_web_acl].
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' @param ChangeToken &#91;required&#93; The `ChangeToken` that you used to submit the [`create_rate_based_rule`][wafregional_create_rate_based_rule] request. You can also use this value to query the status of the request. For more information, see [`get_change_token_status`][wafregional_get_change_token_status].
#' @param Tags 
#'
#' @return
#' A list with the following syntax:
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a RegexMatchSet. You then use [`update_regex_match_set`][wafregional_update_regex_match_set] to identify the part of a web request that you want AWS WAF to inspect, such as the values of the `User-Agent` header or the query string. For example, you can create a `RegexMatchSet` that contains a `RegexMatchTuple` that looks for any requests with `User-Agent` headers that match a `RegexPatternSet` with pattern `B[a@@]dB[o0]t`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_regex_match_set`][wafregional_create_regex_match_set] request.
#' 
#' 2.  Submit a [`create_regex_match_set`][wafregional_create_regex_match_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_match_set`][wafregional_update_regex_match_set] request.
#' 
#' 4.  Submit an [`update_regex_match_set`][wafregional_update_regex_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value, using a `RegexPatternSet`, that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `RegexPatternSet`. You then use [`update_regex_pattern_set`][wafregional_update_regex_pattern_set] to specify the regular expression (regex) pattern that you want AWS WAF to search for, such as `B[a@@]dB[o0]t`. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `RegexPatternSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_regex_pattern_set`][wafregional_create_regex_pattern_set] request.
#' 
#' 2.  Submit a [`create_regex_pattern_set`][wafregional_create_regex_pattern_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_pattern_set`][wafregional_update_regex_pattern_set] request.
#' 
#' 4.  Submit an [`update_regex_pattern_set`][wafregional_update_regex_pattern_set] request to specify the string that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 4.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][wafregional_update_rule] request.
#' 
#' 5.  Submit an [`update_rule`][wafregional_update_rule] request to specify the predicates that you want to include in the `Rule`.
#' 
#' 6.  Create and update a `WebACL` that contains the `Rule`. For more information, see [`create_web_acl`][wafregional_create_web_acl].
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `RuleGroup`. A rule group is a collection of predefined rules that you add to a web ACL. You use [`update_rule_group`][wafregional_update_rule_group] to add rules to the rule group.
#' 
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Creates a `SizeConstraintSet`. You then use [`update_size_constraint_set`][wafregional_update_size_constraint_set] to identify the part of a web request that you want AWS WAF to check for length, such as the length of the `User-Agent` header or the length of the query string. For example, you can create a `SizeConstraintSet` that matches any requests that have a query string that is longer than 100 bytes. You can then configure AWS WAF to reject those requests.
#' 
#' To create and configure a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_size_constraint_set`][wafregional_create_size_constraint_set] request.
#' 
#' 2.  Submit a [`create_size_constraint_set`][wafregional_create_size_constraint_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_size_constraint_set`][wafregional_update_size_constraint_set] request.
#' 
#' 4.  Submit an [`update_size_constraint_set`][wafregional_update_size_constraint_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] request.
#' 
#' 2.  Submit a [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set] request.
#' 
#' 4.  Submit an [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set] request to specify the parts of web requests in which you want to allow, block, or count malicious SQL code.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 
#' 1.  Create and update the `ByteMatchSet` objects and other predicates that you want to include in `Rules`. For more information, see [`create_byte_match_set`][wafregional_create_byte_match_set], [`update_byte_match_set`][wafregional_update_byte_match_set], [`create_ip_set`][wafregional_create_ip_set], [`update_ip_set`][wafregional_update_ip_set], [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set], and [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set].
#' 
#' 2.  Create and update the `Rules` that you want to include in the `WebACL`. For more information, see [`create_rule`][wafregional_create_rule] and [`update_rule`][wafregional_update_rule].
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_web_acl`][wafregional_create_web_acl] request.
#' 
#' 4.  Submit a [`create_web_acl`][wafregional_create_web_acl] request.
#' 
#' 5.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_web_acl`][wafregional_update_web_acl] request.
#' 
#' 6.  Submit an [`update_web_acl`][wafregional_update_web_acl] request to specify the `Rules` that you want to include in the `WebACL`, to specify the default action, and to associate the `WebACL` with a CloudFront distribution.
#' 
...
#' 
#' 1.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`create_xss_match_set`][wafregional_create_xss_match_set] request.
#' 
#' 2.  Submit a [`create_xss_match_set`][wafregional_create_xss_match_set] request.
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_xss_match_set`][wafregional_update_xss_match_set] request.
#' 
#' 4.  Submit an [`update_xss_match_set`][wafregional_update_xss_match_set] request to specify the parts of web requests in which you want to allow, block, or count cross-site scripting attacks.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#' 
#' If you just want to remove a `ByteMatchSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Update the `ByteMatchSet` to remove filters, if any. For more information, see [`update_byte_match_set`][wafregional_update_byte_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_byte_match_set`][wafregional_delete_byte_match_set] request.
#' 
#' 3.  Submit a [`delete_byte_match_set`][wafregional_delete_byte_match_set] request.
#'
#' @usage
#' wafregional_delete_byte_match_set(ByteMatchSetId, ChangeToken)
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to delete. `ByteMatchSetId` is returned by [`create_byte_match_set`][wafregional_create_byte_match_set] and by [`list_byte_match_sets`][wafregional_list_byte_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a `GeoMatchSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete a `GeoMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `GeoMatchSet` to remove any countries. For more information, see [`update_geo_match_set`][wafregional_update_geo_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_geo_match_set`][wafregional_delete_geo_match_set] request.
#' 
#' 3.  Submit a [`delete_geo_match_set`][wafregional_delete_geo_match_set] request.
#'
#' @usage
#' wafregional_delete_geo_match_set(GeoMatchSetId, ChangeToken)
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetID` of the GeoMatchSet that you want to delete. `GeoMatchSetId` is returned by [`create_geo_match_set`][wafregional_create_geo_match_set] and by [`list_geo_match_sets`][wafregional_list_geo_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove an `IPSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete an `IPSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `IPSet` to remove IP address ranges, if any. For more information, see [`update_ip_set`][wafregional_update_ip_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_ip_set`][wafregional_delete_ip_set] request.
#' 
...
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to delete. `IPSetId` is returned by [`create_ip_set`][wafregional_create_ip_set] and by [`list_ip_sets`][wafregional_list_ip_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a rule from a `WebACL`, use [`update_web_acl`][wafregional_update_web_acl].
#' 
#' To permanently delete a `RateBasedRule` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `RateBasedRule` to remove predicates, if any. For more information, see [`update_rate_based_rule`][wafregional_update_rate_based_rule].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rate_based_rule`][wafregional_delete_rate_based_rule] request.
#' 
#' 3.  Submit a [`delete_rate_based_rule`][wafregional_delete_rate_based_rule] request.
#'
#' @usage
#' wafregional_delete_rate_based_rule(RuleId, ChangeToken)
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule that you want to delete. `RuleId` is returned by [`create_rate_based_rule`][wafregional_create_rate_based_rule] and by [`list_rate_based_rules`][wafregional_list_rate_based_rules].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a `RegexMatchSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Update the `RegexMatchSet` to remove filters, if any. For more information, see [`update_regex_match_set`][wafregional_update_regex_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_regex_match_set`][wafregional_delete_regex_match_set] request.
#' 
#' 3.  Submit a [`delete_regex_match_set`][wafregional_delete_regex_match_set] request.
#'
#' @usage
#' wafregional_delete_regex_match_set(RegexMatchSetId, ChangeToken)
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to delete. `RegexMatchSetId` is returned by [`create_regex_match_set`][wafregional_create_regex_match_set] and by [`list_regex_match_sets`][wafregional_list_regex_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to delete. `RegexPatternSetId` is returned by [`create_regex_pattern_set`][wafregional_create_regex_pattern_set] and by [`list_regex_pattern_sets`][wafregional_list_regex_pattern_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' 1.  Update the `Rule` to remove predicates, if any. For more information, see [`update_rule`][wafregional_update_rule].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rule`][wafregional_delete_rule] request.
#' 
...
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the Rule that you want to delete. `RuleId` is returned by [`create_rule`][wafregional_create_rule] and by [`list_rules`][wafregional_list_rules].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a `RuleGroup` from a `WebACL`, use [`update_web_acl`][wafregional_update_web_acl].
#' 
#' To permanently delete a `RuleGroup` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `RuleGroup` to remove rules, if any. For more information, see [`update_rule_group`][wafregional_update_rule_group].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_rule_group`][wafregional_delete_rule_group] request.
#' 
#' 3.  Submit a [`delete_rule_group`][wafregional_delete_rule_group] request.
#'
#' @usage
#' wafregional_delete_rule_group(RuleGroupId, ChangeToken)
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to delete. `RuleGroupId` is returned by [`create_rule_group`][wafregional_create_rule_group] and by [`list_rule_groups`][wafregional_list_rule_groups].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a `SizeConstraintSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Update the `SizeConstraintSet` to remove filters, if any. For more information, see [`update_size_constraint_set`][wafregional_update_size_constraint_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_size_constraint_set`][wafregional_delete_size_constraint_set] request.
#' 
#' 3.  Submit a [`delete_size_constraint_set`][wafregional_delete_size_constraint_set] request.
#'
#' @usage
#' wafregional_delete_size_constraint_set(SizeConstraintSetId, ChangeToken)
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to delete. `SizeConstraintSetId` is returned by [`create_size_constraint_set`][wafregional_create_size_constraint_set] and by [`list_size_constraint_sets`][wafregional_list_size_constraint_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove a `SqlInjectionMatchSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete a `SqlInjectionMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `SqlInjectionMatchSet` to remove filters, if any. For more information, see [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_sql_injection_match_set`][wafregional_delete_sql_injection_match_set] request.
#' 
#' 3.  Submit a [`delete_sql_injection_match_set`][wafregional_delete_sql_injection_match_set] request.
#'
#' @usage
#' wafregional_delete_sql_injection_match_set(SqlInjectionMatchSetId,
#'   ChangeToken)
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the SqlInjectionMatchSet that you want to delete. `SqlInjectionMatchSetId` is returned by [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] and by [`list_sql_injection_match_sets`][wafregional_list_sql_injection_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' 1.  Update the `WebACL` to remove `Rules`, if any. For more information, see [`update_web_acl`][wafregional_update_web_acl].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_web_acl`][wafregional_delete_web_acl] request.
#' 
...
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to delete. `WebACLId` is returned by [`create_web_acl`][wafregional_create_web_acl] and by [`list_web_ac_ls`][wafregional_list_web_ac_ls].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#' 
#' If you just want to remove an `XssMatchSet` from a `Rule`, use [`update_rule`][wafregional_update_rule].
#' 
#' To permanently delete an `XssMatchSet` from AWS WAF, perform the following steps:
#' 
#' 1.  Update the `XssMatchSet` to remove filters, if any. For more information, see [`update_xss_match_set`][wafregional_update_xss_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of a [`delete_xss_match_set`][wafregional_delete_xss_match_set] request.
#' 
#' 3.  Submit a [`delete_xss_match_set`][wafregional_delete_xss_match_set] request.
#'
#' @usage
#' wafregional_delete_xss_match_set(XssMatchSetId, ChangeToken)
#'
#' @param XssMatchSetId &#91;required&#93; The `XssMatchSetId` of the XssMatchSet that you want to delete. `XssMatchSetId` is returned by [`create_xss_match_set`][wafregional_create_xss_match_set] and by [`list_xss_match_sets`][wafregional_list_xss_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
#'
#' @return
#' A list with the following syntax:
...
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to get. `ByteMatchSetId` is returned by [`create_byte_match_set`][wafregional_create_byte_match_set] and by [`list_byte_match_sets`][wafregional_list_byte_match_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' 
#' Each create, update, or delete request must use a unique change token. If your application submits a [`get_change_token`][wafregional_get_change_token] request and then submits a second [`get_change_token`][wafregional_get_change_token] request before submitting a create, update, or delete request, the second [`get_change_token`][wafregional_get_change_token] request returns the same value as the first [`get_change_token`][wafregional_get_change_token] request.
#' 
#' When you use a change token in a create, update, or delete request, the status of the change token changes to `PENDING`, which indicates that AWS WAF is propagating the change to all AWS WAF servers. Use [`get_change_token_status`][wafregional_get_change_token_status] to determine the status of your change token.
#'
#' @usage
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the status of a `ChangeToken` that you got by calling [`get_change_token`][wafregional_get_change_token]. `ChangeTokenStatus` is one of the following values:
#' 
#' -   `PROVISIONED`: You requested the change token by calling [`get_change_token`][wafregional_get_change_token], but you haven't used it yet in a call to create, update, or delete an AWS WAF object.
#' 
...
#'
#' @param ChangeToken &#91;required&#93; The change token for which you want to get the status. This change token was previously returned in the [`get_change_token`][wafregional_get_change_token] response.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetId` of the GeoMatchSet that you want to get. `GeoMatchSetId` is returned by [`create_geo_match_set`][wafregional_create_geo_match_set] and by [`list_geo_match_sets`][wafregional_list_geo_match_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to get. `IPSetId` is returned by [`create_ip_set`][wafregional_create_ip_set] and by [`list_ip_sets`][wafregional_list_ip_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the RateBasedRule that is specified by the `RuleId` that you included in the [`get_rate_based_rule`][wafregional_get_rate_based_rule] request.
#'
#' @usage
#' wafregional_get_rate_based_rule(RuleId)
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule that you want to get. `RuleId` is returned by [`create_rate_based_rule`][wafregional_create_rate_based_rule] and by [`list_rate_based_rules`][wafregional_list_rate_based_rules].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the RateBasedRule for which you want to get a list of `ManagedKeys`. `RuleId` is returned by [`create_rate_based_rule`][wafregional_create_rate_based_rule] and by [`list_rate_based_rules`][wafregional_list_rate_based_rules].
...
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to get. `RegexMatchSetId` is returned by [`create_regex_match_set`][wafregional_create_regex_match_set] and by [`list_regex_match_sets`][wafregional_list_regex_match_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to get. `RegexPatternSetId` is returned by [`create_regex_pattern_set`][wafregional_create_regex_pattern_set] and by [`list_regex_pattern_sets`][wafregional_list_regex_pattern_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the Rule that is specified by the `RuleId` that you included in the [`get_rule`][wafregional_get_rule] request.
#'
#' @usage
#' wafregional_get_rule(RuleId)
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the Rule that you want to get. `RuleId` is returned by [`create_rule`][wafregional_create_rule] and by [`list_rules`][wafregional_list_rules].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' **For the latest version of AWS WAF**, use the AWS WAFV2 API and see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html). With the latest version, AWS WAF has a single set of endpoints for regional and global use.
#' 
#' Returns the RuleGroup that is specified by the `RuleGroupId` that you included in the [`get_rule_group`][wafregional_get_rule_group] request.
#' 
#' To view the rules in a rule group, use [`list_activated_rules_in_rule_group`][wafregional_list_activated_rules_in_rule_group].
#'
#' @usage
#' wafregional_get_rule_group(RuleGroupId)
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to get. `RuleGroupId` is returned by [`create_rule_group`][wafregional_create_rule_group] and by [`list_rule_groups`][wafregional_list_rule_groups].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' 
#' [`get_sampled_requests`][wafregional_get_sampled_requests] returns a time range, which is usually the time range that you specified. However, if your resource (such as a CloudFront distribution) received 5,000 requests before the specified time range elapsed, [`get_sampled_requests`][wafregional_get_sampled_requests] returns an updated time range. This new time range indicates the actual period during which AWS WAF selected the requests in the sample.
#'
#' @usage
#' wafregional_get_sampled_requests(WebAclId, RuleId, TimeWindow, MaxItems)
#'
#' @param WebAclId &#91;required&#93; The `WebACLId` of the `WebACL` for which you want [`get_sampled_requests`][wafregional_get_sampled_requests] to return a sample of requests.
#' @param RuleId &#91;required&#93; `RuleId` is one of three values:
#' 
#' -   The `RuleId` of the `Rule` or the `RuleGroupId` of the `RuleGroup` for which you want [`get_sampled_requests`][wafregional_get_sampled_requests] to return a sample of requests.
#' 
#' -   `Default_Action`, which causes [`get_sampled_requests`][wafregional_get_sampled_requests] to return a sample of the requests that didn't match any of the rules in the specified `WebACL`.
#' @param TimeWindow &#91;required&#93; The start date and time and the end date and time of the range for which you want [`get_sampled_requests`][wafregional_get_sampled_requests] to return a sample of requests. You must specify the times in Coordinated Universal Time (UTC) format. UTC format includes the special designator, `Z`. For example, `"2016-09-27T14:50Z"`. You can specify any time range in the previous three hours.
#' @param MaxItems &#91;required&#93; The number of requests that you want AWS WAF to return from among the first 5,000 requests that your AWS resource received during the time range. If your resource received fewer requests than the value of `MaxItems`, [`get_sampled_requests`][wafregional_get_sampled_requests] returns information about all of them.
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to get. `SizeConstraintSetId` is returned by [`create_size_constraint_set`][wafregional_create_size_constraint_set] and by [`list_size_constraint_sets`][wafregional_list_size_constraint_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the SqlInjectionMatchSet that you want to get. `SqlInjectionMatchSetId` is returned by [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] and by [`list_sql_injection_match_sets`][wafregional_list_sql_injection_match_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to get. `WebACLId` is returned by [`create_web_acl`][wafregional_create_web_acl] and by [`list_web_ac_ls`][wafregional_list_web_ac_ls].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#'
#' @param XssMatchSetId &#91;required&#93; The `XssMatchSetId` of the XssMatchSet that you want to get. `XssMatchSetId` is returned by [`create_xss_match_set`][wafregional_create_xss_match_set] and by [`list_xss_match_sets`][wafregional_list_xss_match_sets].
#'
#' @return
#' A list with the following syntax:
#' ```
...
#' @param NextMarker If you specify a value for `Limit` and you have more `ActivatedRules` than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `ActivatedRules`. For the second and subsequent [`list_activated_rules_in_rule_group`][wafregional_list_activated_rules_in_rule_group] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `ActivatedRules`.
...
#'
#' @param NextMarker AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `IPSets`. For the second and subsequent [`list_ip_sets`][wafregional_list_ip_sets] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `IPSets`.
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more `LoggingConfigurations` than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `LoggingConfigurations`. For the second and subsequent [`list_logging_configurations`][wafregional_list_logging_configurations] requests, specify the value of `NextMarker` from the previous response to get information about another batch of [`list_logging_configurations`][wafregional_list_logging_configurations].
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more `Rules` than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `Rules`. For the second and subsequent [`list_rate_based_rules`][wafregional_list_rate_based_rules] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `Rules`.
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more `RegexPatternSet` objects than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `RegexPatternSet` objects. For the second and subsequent [`list_regex_pattern_sets`][wafregional_list_regex_pattern_sets] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `RegexPatternSet` objects.
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more `Rules` than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `Rules`. For the second and subsequent [`list_rules`][wafregional_list_rules] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `Rules`.
#' @param Limit Specifies the number of `Rules` that you want AWS WAF to return for this request. If you have more `Rules` than the number that you specify for `Limit`, the response includes a `NextMarker` value that you can use to get another batch of `Rules`.
#'
#' @return
#' A list with the following syntax:
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more `SizeConstraintSets` than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `SizeConstraintSets`. For the second and subsequent [`list_size_constraint_sets`][wafregional_list_size_constraint_sets] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `SizeConstraintSets`.
...
#'
#' @param NextMarker If you specify a value for `Limit` and you have more XssMatchSet objects than the value of `Limit`, AWS WAF returns a `NextMarker` value in the response that allows you to list another group of `XssMatchSets`. For the second and subsequent [`list_xss_match_sets`][wafregional_list_xss_match_sets] requests, specify the value of `NextMarker` from the previous response to get information about another batch of `XssMatchSets`.
...
#' 
#' 2.  Associate that firehose to your web ACL using a [`put_logging_configuration`][wafregional_put_logging_configuration] request.
#' 
#' When you successfully enable logging using a [`put_logging_configuration`][wafregional_put_logging_configuration] request, AWS WAF will create a service linked role with the necessary permissions to write logs to the Amazon Kinesis Data Firehose. For more information, see [Logging Web ACL Traffic Information](https://docs.aws.amazon.com/waf/latest/developerguide/logging.html) in the *AWS WAF Developer Guide*.
#'
#' @usage
...
#' 
#' The [`put_permission_policy`][wafregional_put_permission_policy] is subject to the following restrictions:
#' 
#' -   You can attach only one policy with each [`put_permission_policy`][wafregional_put_permission_policy] request.
#' 
...
#' To create and configure a `ByteMatchSet`, perform the following steps:
#' 
#' 1.  Create a `ByteMatchSet.` For more information, see [`create_byte_match_set`][wafregional_create_byte_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_byte_match_set`][wafregional_update_byte_match_set] request.
#' 
#' 3.  Submit an [`update_byte_match_set`][wafregional_update_byte_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @param ByteMatchSetId &#91;required&#93; The `ByteMatchSetId` of the ByteMatchSet that you want to update. `ByteMatchSetId` is returned by [`create_byte_match_set`][wafregional_create_byte_match_set] and by [`list_byte_match_sets`][wafregional_list_byte_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' 
#' 1.  Submit a [`create_geo_match_set`][wafregional_create_geo_match_set] request.
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_geo_match_set`][wafregional_update_geo_match_set] request.
#' 
#' 3.  Submit an [`update_geo_match_set`][wafregional_update_geo_match_set] request to specify the country that you want AWS WAF to watch for.
#' 
...
#'
#' @param GeoMatchSetId &#91;required&#93; The `GeoMatchSetId` of the GeoMatchSet that you want to update. `GeoMatchSetId` is returned by [`create_geo_match_set`][wafregional_create_geo_match_set] and by [`list_geo_match_sets`][wafregional_list_geo_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][wafregional_update_ip_set] request.
#' 
#' 3.  Submit an [`update_ip_set`][wafregional_update_ip_set] request to specify the IP addresses that you want AWS WAF to watch for.
#' 
...
#'
#' @param IPSetId &#91;required&#93; The `IPSetId` of the IPSet that you want to update. `IPSetId` is returned by [`create_ip_set`][wafregional_create_ip_set] and by [`list_ip_sets`][wafregional_list_ip_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#'   RateLimit)
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the `RateBasedRule` that you want to update. `RuleId` is returned by [`create_rate_based_rule`][wafregional_create_rate_based_rule] and by [`list_rate_based_rules`][wafregional_list_rate_based_rules].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' To create and configure a `RegexMatchSet`, perform the following steps:
#' 
#' 1.  Create a `RegexMatchSet.` For more information, see [`create_regex_match_set`][wafregional_create_regex_match_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_match_set`][wafregional_update_regex_match_set] request.
#' 
#' 3.  Submit an [`update_regex_match_set`][wafregional_update_regex_match_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the identifier of the `RegexPatternSet` that contain the regular expression patters you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'   ChangeToken)
#'
#' @param RegexMatchSetId &#91;required&#93; The `RegexMatchSetId` of the RegexMatchSet that you want to update. `RegexMatchSetId` is returned by [`create_regex_match_set`][wafregional_create_regex_match_set] and by [`list_regex_match_sets`][wafregional_list_regex_match_sets].
...
#' To create and configure a `RegexPatternSet`, perform the following steps:
#' 
#' 1.  Create a `RegexPatternSet.` For more information, see [`create_regex_pattern_set`][wafregional_create_regex_pattern_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_regex_pattern_set`][wafregional_update_regex_pattern_set] request.
#' 
#' 3.  Submit an [`update_regex_pattern_set`][wafregional_update_regex_pattern_set] request to specify the regular expression pattern that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'   ChangeToken)
#'
#' @param RegexPatternSetId &#91;required&#93; The `RegexPatternSetId` of the RegexPatternSet that you want to update. `RegexPatternSetId` is returned by [`create_regex_pattern_set`][wafregional_create_regex_pattern_set] and by [`list_regex_pattern_sets`][wafregional_list_regex_pattern_sets].
...
#' 
#' 3.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule`][wafregional_update_rule] request.
#' 
#' 4.  Submit an [`update_rule`][wafregional_update_rule] request to add predicates to the `Rule`.
#' 
#' 5.  Create and update a `WebACL` that contains the `Rule`. See [`create_web_acl`][wafregional_create_web_acl].
#' 
...
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the `Rule` that you want to update. `RuleId` is returned by [`create_rule`][wafregional_create_rule] and by [`list_rules`][wafregional_list_rules].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' 
#' 1.  Create and update the `Rules` that you want to include in the `RuleGroup`. See [`create_rule`][wafregional_create_rule].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_rule_group`][wafregional_update_rule_group] request.
#' 
#' 3.  Submit an [`update_rule_group`][wafregional_update_rule_group] request to add `Rules` to the `RuleGroup`.
#' 
#' 4.  Create and update a `WebACL` that contains the `RuleGroup`. See [`create_web_acl`][wafregional_create_web_acl].
#' 
...
#'
#' @param RuleGroupId &#91;required&#93; The `RuleGroupId` of the RuleGroup that you want to update. `RuleGroupId` is returned by [`create_rule_group`][wafregional_create_rule_group] and by [`list_rule_groups`][wafregional_list_rule_groups].
...
#' To create and configure a `SizeConstraintSet`, perform the following steps:
#' 
#' 1.  Create a `SizeConstraintSet.` For more information, see [`create_size_constraint_set`][wafregional_create_size_constraint_set].
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_size_constraint_set`][wafregional_update_size_constraint_set] request.
#' 
#' 3.  Submit an [`update_size_constraint_set`][wafregional_update_size_constraint_set] request to specify the part of the request that you want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch for.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'   Updates)
#'
#' @param SizeConstraintSetId &#91;required&#93; The `SizeConstraintSetId` of the SizeConstraintSet that you want to update. `SizeConstraintSetId` is returned by [`create_size_constraint_set`][wafregional_create_size_constraint_set] and by [`list_size_constraint_sets`][wafregional_list_size_constraint_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' To create and configure a `SqlInjectionMatchSet`, perform the following steps:
#' 
#' 1.  Submit a [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] request.
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][wafregional_update_ip_set] request.
#' 
#' 3.  Submit an [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set] request to specify the parts of web requests that you want AWS WAF to inspect for snippets of SQL code.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'   ChangeToken, Updates)
#'
#' @param SqlInjectionMatchSetId &#91;required&#93; The `SqlInjectionMatchSetId` of the `SqlInjectionMatchSet` that you want to update. `SqlInjectionMatchSetId` is returned by [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set] and by [`list_sql_injection_match_sets`][wafregional_list_sql_injection_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' To create and configure a `WebACL`, perform the following steps:
#' 
#' 1.  Create and update the predicates that you want to include in `Rules`. For more information, see [`create_byte_match_set`][wafregional_create_byte_match_set], [`update_byte_match_set`][wafregional_update_byte_match_set], [`create_ip_set`][wafregional_create_ip_set], [`update_ip_set`][wafregional_update_ip_set], [`create_sql_injection_match_set`][wafregional_create_sql_injection_match_set], and [`update_sql_injection_match_set`][wafregional_update_sql_injection_match_set].
#' 
#' 2.  Create and update the `Rules` that you want to include in the `WebACL`. For more information, see [`create_rule`][wafregional_create_rule] and [`update_rule`][wafregional_update_rule].
#' 
#' 3.  Create a `WebACL`. See [`create_web_acl`][wafregional_create_web_acl].
#' 
#' 4.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_web_acl`][wafregional_update_web_acl] request.
#' 
#' 5.  Submit an [`update_web_acl`][wafregional_update_web_acl] request to specify the `Rules` that you want to include in the `WebACL`, to specify the default action, and to associate the `WebACL` with a CloudFront distribution.
#' 
...
#' 
#'     If you already have a rule group associated with a web ACL and want to submit an [`update_web_acl`][wafregional_update_web_acl] request to exclude certain rules from that rule group, you must first remove the rule group from the web ACL, the re-insert it again, specifying the excluded rules. For details, see ActivatedRule$ExcludedRules .
#' 
#' Be aware that if you try to add a RATE_BASED rule to a web ACL without setting the rule type when first creating the rule, the [`update_web_acl`][wafregional_update_web_acl] request will fail because the request tries to add a REGULAR rule (the default rule type) with the specified ID, which does not exist.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'   DefaultAction)
#'
#' @param WebACLId &#91;required&#93; The `WebACLId` of the WebACL that you want to update. `WebACLId` is returned by [`create_web_acl`][wafregional_create_web_acl] and by [`list_web_ac_ls`][wafregional_list_web_ac_ls].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
...
#' To create and configure an `XssMatchSet`, perform the following steps:
#' 
#' 1.  Submit a [`create_xss_match_set`][wafregional_create_xss_match_set] request.
#' 
#' 2.  Use [`get_change_token`][wafregional_get_change_token] to get the change token that you provide in the `ChangeToken` parameter of an [`update_ip_set`][wafregional_update_ip_set] request.
#' 
#' 3.  Submit an [`update_xss_match_set`][wafregional_update_xss_match_set] request to specify the parts of web requests that you want AWS WAF to inspect for cross-site scripting attacks.
#' 
#' For more information about how to use the AWS WAF API to allow or block HTTP requests, see the [AWS WAF Developer Guide](https://docs.aws.amazon.com/waf/latest/developerguide/).
#'
#' @usage
...
#'
#' @param XssMatchSetId &#91;required&#93; The `XssMatchSetId` of the `XssMatchSet` that you want to update. `XssMatchSetId` is returned by [`create_xss_match_set`][wafregional_create_xss_match_set] and by [`list_xss_match_sets`][wafregional_list_xss_match_sets].
#' @param ChangeToken &#91;required&#93; The value returned by the most recent call to [`get_change_token`][wafregional_get_change_token].
