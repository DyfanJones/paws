...
#'  \link[=rds_describe_serverless_v2_platform_versions]{describe_serverless_v2_platform_versions} \tab Describes the properties of specific platform versions for Aurora Serverless v2\cr
