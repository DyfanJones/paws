...
#' Gets data source package information for the behavior graph.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_graph_member_datasources/](https://paws-r-sdk.com/docs/batch_get_graph_member_datasources/) for full documentation.
#'
...
#' Gets information on the data source package history for an account.
#'
#' See [https://paws-r-sdk.com/docs/batch_get_membership_datasources/](https://paws-r-sdk.com/docs/batch_get_membership_datasources/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_graph/](https://paws-r-sdk.com/docs/create_graph/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_graph/](https://paws-r-sdk.com/docs/delete_graph/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_membership/](https://paws-r-sdk.com/docs/disassociate_membership/) for full documentation.
#'
...
#' Lists data source packages in the behavior graph.
#'
#' See [https://paws-r-sdk.com/docs/list_datasource_packages/](https://paws-r-sdk.com/docs/list_datasource_packages/) for full documentation.
#'
#' @param GraphArn &#91;required&#93; The ARN of the behavior graph.
...
#'
#' See [https://paws-r-sdk.com/docs/list_graphs/](https://paws-r-sdk.com/docs/list_graphs/) for full documentation.
#'
#' @param NextToken For requests to get the next page of results, the pagination token that
#' was returned with the previous set of results. The initial request does
#' not include a pagination token.
...
#'
#' See [https://paws-r-sdk.com/docs/reject_invitation/](https://paws-r-sdk.com/docs/reject_invitation/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_monitoring_member/](https://paws-r-sdk.com/docs/start_monitoring_member/) for full documentation.
#'
#' @param GraphArn &#91;required&#93; The ARN of the behavior graph.
...
#' Starts a data source packages for the behavior graph.
#'
#' See [https://paws-r-sdk.com/docs/update_datasource_packages/](https://paws-r-sdk.com/docs/update_datasource_packages/) for full documentation.
#'
#' @param GraphArn &#91;required&#93; The ARN of the behavior graph.
