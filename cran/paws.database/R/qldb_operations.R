...
#'
#' See [https://paws-r-sdk.com/docs/cancel_journal_kinesis_stream/](https://paws-r-sdk.com/docs/cancel_journal_kinesis_stream/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_ledger/](https://paws-r-sdk.com/docs/create_ledger/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_ledger/](https://paws-r-sdk.com/docs/delete_ledger/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_journal_kinesis_stream/](https://paws-r-sdk.com/docs/describe_journal_kinesis_stream/) for full documentation.
#'
#' @param LedgerName &#91;required&#93; The name of the ledger.
#' @param StreamId &#91;required&#93; The UUID (represented in Base62-encoded text) of the QLDB journal stream
#' to describe.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_journal_s3_export/](https://paws-r-sdk.com/docs/describe_journal_s3_export/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_ledger/](https://paws-r-sdk.com/docs/describe_ledger/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/export_journal_to_s3/](https://paws-r-sdk.com/docs/export_journal_to_s3/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
...
#'
#' See [https://paws-r-sdk.com/docs/get_block/](https://paws-r-sdk.com/docs/get_block/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
...
#'
#' See [https://paws-r-sdk.com/docs/get_digest/](https://paws-r-sdk.com/docs/get_digest/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_revision/](https://paws-r-sdk.com/docs/get_revision/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
...
#' Returns all Amazon QLDB journal streams for a given ledger.
#'
#' See [https://paws-r-sdk.com/docs/list_journal_kinesis_streams_for_ledger/](https://paws-r-sdk.com/docs/list_journal_kinesis_streams_for_ledger/) for full documentation.
#'
#' @param LedgerName &#91;required&#93; The name of the ledger.
...
#'
#' See [https://paws-r-sdk.com/docs/list_journal_s3_exports/](https://paws-r-sdk.com/docs/list_journal_s3_exports/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in a single
...
#' Returns all journal export jobs for a specified ledger.
#'
#' See [https://paws-r-sdk.com/docs/list_journal_s3_exports_for_ledger/](https://paws-r-sdk.com/docs/list_journal_s3_exports_for_ledger/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
#' @param MaxResults The maximum number of results to return in a single
...
#'
#' See [https://paws-r-sdk.com/docs/list_ledgers/](https://paws-r-sdk.com/docs/list_ledgers/) for full documentation.
#'
#' @param MaxResults The maximum number of results to return in a single
...
#'
#' See [https://paws-r-sdk.com/docs/stream_journal_to_kinesis/](https://paws-r-sdk.com/docs/stream_journal_to_kinesis/) for full documentation.
#'
#' @param LedgerName &#91;required&#93; The name of the ledger.
#' @param RoleArn &#91;required&#93; The Amazon Resource Name (ARN) of the IAM role that grants QLDB
...
#' Updates properties on a ledger.
#'
#' See [https://paws-r-sdk.com/docs/update_ledger/](https://paws-r-sdk.com/docs/update_ledger/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
#' @param DeletionProtection Specifies whether the ledger is protected from being deleted by any
#' user. If not defined during ledger creation, this feature is enabled
...
#' Updates the permissions mode of a ledger.
#'
#' See [https://paws-r-sdk.com/docs/update_ledger_permissions_mode/](https://paws-r-sdk.com/docs/update_ledger_permissions_mode/) for full documentation.
#'
#' @param Name &#91;required&#93; The name of the ledger.
