...
#' Adds additional user attributes to the user pool schema.
#'
#' See [https://paws-r-sdk.com/docs/add_custom_attributes/](https://paws-r-sdk.com/docs/add_custom_attributes/) for full documentation.
#'
...
#' Adds the specified user to the specified group.
#'
#' See [https://paws-r-sdk.com/docs/admin_add_user_to_group/](https://paws-r-sdk.com/docs/admin_add_user_to_group/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_confirm_sign_up/](https://paws-r-sdk.com/docs/admin_confirm_sign_up/) for full documentation.
#'
...
#' Creates a new user in the specified user pool.
#'
#' See [https://paws-r-sdk.com/docs/admin_create_user/](https://paws-r-sdk.com/docs/admin_create_user/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_delete_user/](https://paws-r-sdk.com/docs/admin_delete_user/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_delete_user_attributes/](https://paws-r-sdk.com/docs/admin_delete_user_attributes/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_disable_provider_for_user/](https://paws-r-sdk.com/docs/admin_disable_provider_for_user/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_disable_user/](https://paws-r-sdk.com/docs/admin_disable_user/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_enable_user/](https://paws-r-sdk.com/docs/admin_enable_user/) for full documentation.
#'
...
#' Forgets the device, as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_forget_device/](https://paws-r-sdk.com/docs/admin_forget_device/) for full documentation.
#'
...
#' Gets the device, as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_get_device/](https://paws-r-sdk.com/docs/admin_get_device/) for full documentation.
#'
#' @param DeviceKey &#91;required&#93; The device key.
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param Username &#91;required&#93; The user name.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_get_user/](https://paws-r-sdk.com/docs/admin_get_user/) for full documentation.
#'
...
#' Initiates the authentication flow, as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_initiate_auth/](https://paws-r-sdk.com/docs/admin_initiate_auth/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_link_provider_for_user/](https://paws-r-sdk.com/docs/admin_link_provider_for_user/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#' Lists devices, as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_list_devices/](https://paws-r-sdk.com/docs/admin_list_devices/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param Username &#91;required&#93; The user name.
...
#' Lists the groups that the user belongs to.
#'
#' See [https://paws-r-sdk.com/docs/admin_list_groups_for_user/](https://paws-r-sdk.com/docs/admin_list_groups_for_user/) for full documentation.
#'
#' @param Username &#91;required&#93; The username for the user.
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_list_user_auth_events/](https://paws-r-sdk.com/docs/admin_list_user_auth_events/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#' Removes the specified user from the specified group.
#'
#' See [https://paws-r-sdk.com/docs/admin_remove_user_from_group/](https://paws-r-sdk.com/docs/admin_remove_user_from_group/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
#' @param Username &#91;required&#93; The username for the user.
#' @param GroupName &#91;required&#93; The group name.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_reset_user_password/](https://paws-r-sdk.com/docs/admin_reset_user_password/) for full documentation.
#'
...
#' Responds to an authentication challenge, as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_respond_to_auth_challenge/](https://paws-r-sdk.com/docs/admin_respond_to_auth_challenge/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The ID of the Amazon Cognito user pool.
#' @param ClientId &#91;required&#93; The app client ID.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_set_user_mfa_preference/](https://paws-r-sdk.com/docs/admin_set_user_mfa_preference/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_set_user_password/](https://paws-r-sdk.com/docs/admin_set_user_password/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_set_user_settings/](https://paws-r-sdk.com/docs/admin_set_user_settings/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_update_auth_event_feedback/](https://paws-r-sdk.com/docs/admin_update_auth_event_feedback/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#' Updates the device status as an administrator.
#'
#' See [https://paws-r-sdk.com/docs/admin_update_device_status/](https://paws-r-sdk.com/docs/admin_update_device_status/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param Username &#91;required&#93; The user name.
#' @param DeviceKey &#91;required&#93; The device key.
...
#'
#' See [https://paws-r-sdk.com/docs/admin_update_user_attributes/](https://paws-r-sdk.com/docs/admin_update_user_attributes/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/admin_user_global_sign_out/](https://paws-r-sdk.com/docs/admin_user_global_sign_out/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param Username &#91;required&#93; The user name.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/associate_software_token/](https://paws-r-sdk.com/docs/associate_software_token/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/confirm_device/](https://paws-r-sdk.com/docs/confirm_device/) for full documentation.
#'
...
#' Allows a user to enter a confirmation code to reset a forgotten password.
#'
#' See [https://paws-r-sdk.com/docs/confirm_forgot_password/](https://paws-r-sdk.com/docs/confirm_forgot_password/) for full documentation.
#'
...
#' Confirms registration of a new user.
#'
#' See [https://paws-r-sdk.com/docs/confirm_sign_up/](https://paws-r-sdk.com/docs/confirm_sign_up/) for full documentation.
#'
...
#' Creates an IdP for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/create_identity_provider/](https://paws-r-sdk.com/docs/create_identity_provider/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#'
#' See [https://paws-r-sdk.com/docs/create_resource_server/](https://paws-r-sdk.com/docs/create_resource_server/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#' Creates the user import job.
#'
#' See [https://paws-r-sdk.com/docs/create_user_import_job/](https://paws-r-sdk.com/docs/create_user_import_job/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_user_pool/](https://paws-r-sdk.com/docs/create_user_pool/) for full documentation.
#'
...
#' Creates the user pool client.
#'
#' See [https://paws-r-sdk.com/docs/create_user_pool_client/](https://paws-r-sdk.com/docs/create_user_pool_client/) for full documentation.
#'
...
#' Creates a new domain for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/create_user_pool_domain/](https://paws-r-sdk.com/docs/create_user_pool_domain/) for full documentation.
#'
...
#' Deletes an IdP for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/delete_identity_provider/](https://paws-r-sdk.com/docs/delete_identity_provider/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param ProviderName &#91;required&#93; The IdP name.
#'
...
#' Deletes a resource server.
#'
#' See [https://paws-r-sdk.com/docs/delete_resource_server/](https://paws-r-sdk.com/docs/delete_resource_server/) for full documentation.
#'
...
#' Deletes the attributes for a user.
#'
#' See [https://paws-r-sdk.com/docs/delete_user_attributes/](https://paws-r-sdk.com/docs/delete_user_attributes/) for full documentation.
#'
#' @param UserAttributeNames &#91;required&#93; An array of strings representing the user attribute names you want to
#' delete.
#' 
...
#' Deletes the specified Amazon Cognito user pool.
#'
#' See [https://paws-r-sdk.com/docs/delete_user_pool/](https://paws-r-sdk.com/docs/delete_user_pool/) for full documentation.
#'
...
#' Allows the developer to delete the user pool client.
#'
#' See [https://paws-r-sdk.com/docs/delete_user_pool_client/](https://paws-r-sdk.com/docs/delete_user_pool_client/) for full documentation.
#'
...
#' Deletes a domain for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/delete_user_pool_domain/](https://paws-r-sdk.com/docs/delete_user_pool_domain/) for full documentation.
#'
#' @param Domain &#91;required&#93; The domain string. For custom domains, this is the fully-qualified
#' domain name, such as `auth.example.com`. For Amazon Cognito prefix
#' domains, this is the prefix alone, such as `auth`.
...
#' Gets information about a specific IdP.
#'
#' See [https://paws-r-sdk.com/docs/describe_identity_provider/](https://paws-r-sdk.com/docs/describe_identity_provider/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param ProviderName &#91;required&#93; The IdP name.
#'
...
#' Describes a resource server.
#'
#' See [https://paws-r-sdk.com/docs/describe_resource_server/](https://paws-r-sdk.com/docs/describe_resource_server/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool that hosts the resource server.
#' @param Identifier &#91;required&#93; The identifier for the resource server
#'
...
#' Describes the risk configuration.
#'
#' See [https://paws-r-sdk.com/docs/describe_risk_configuration/](https://paws-r-sdk.com/docs/describe_risk_configuration/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#' Describes the user import job.
#'
#' See [https://paws-r-sdk.com/docs/describe_user_import_job/](https://paws-r-sdk.com/docs/describe_user_import_job/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool that the users are being imported
#' into.
...
#'
#' See [https://paws-r-sdk.com/docs/describe_user_pool/](https://paws-r-sdk.com/docs/describe_user_pool/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_user_pool_client/](https://paws-r-sdk.com/docs/describe_user_pool_client/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool you want to describe.
#' @param ClientId &#91;required&#93; The app client ID of the app associated with the user pool.
#'
...
#' Gets information about a domain.
#'
#' See [https://paws-r-sdk.com/docs/describe_user_pool_domain/](https://paws-r-sdk.com/docs/describe_user_pool_domain/) for full documentation.
#'
#' @param Domain &#91;required&#93; The domain string. For custom domains, this is the fully-qualified
#' domain name, such as `auth.example.com`. For Amazon Cognito prefix
#' domains, this is the prefix alone, such as `auth`.
...
#' Forgets the specified device.
#'
#' See [https://paws-r-sdk.com/docs/forget_device/](https://paws-r-sdk.com/docs/forget_device/) for full documentation.
#'
#' @param AccessToken A valid access token that Amazon Cognito issued to the user whose
...
#'
#' See [https://paws-r-sdk.com/docs/forgot_password/](https://paws-r-sdk.com/docs/forgot_password/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_csv_header/](https://paws-r-sdk.com/docs/get_csv_header/) for full documentation.
#'
...
#' Gets the device.
#'
#' See [https://paws-r-sdk.com/docs/get_device/](https://paws-r-sdk.com/docs/get_device/) for full documentation.
#'
#' @param DeviceKey &#91;required&#93; The device key.
...
#' Gets the specified IdP.
#'
#' See [https://paws-r-sdk.com/docs/get_identity_provider_by_identifier/](https://paws-r-sdk.com/docs/get_identity_provider_by_identifier/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#'
#' See [https://paws-r-sdk.com/docs/get_signing_certificate/](https://paws-r-sdk.com/docs/get_signing_certificate/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/get_ui_customization/](https://paws-r-sdk.com/docs/get_ui_customization/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#'
#' See [https://paws-r-sdk.com/docs/get_user_attribute_verification_code/](https://paws-r-sdk.com/docs/get_user_attribute_verification_code/) for full documentation.
#'
...
#' Gets the user pool multi-factor authentication (MFA) configuration.
#'
#' See [https://paws-r-sdk.com/docs/get_user_pool_mfa_config/](https://paws-r-sdk.com/docs/get_user_pool_mfa_config/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#'
#' @keywords internal
...
#'
#' See [https://paws-r-sdk.com/docs/global_sign_out/](https://paws-r-sdk.com/docs/global_sign_out/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/initiate_auth/](https://paws-r-sdk.com/docs/initiate_auth/) for full documentation.
#'
#' @param AuthFlow &#91;required&#93; The authentication flow for this call to run. The API action will depend
#' on this value. For example:
#' 
...
#' Lists information about all IdPs for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/list_identity_providers/](https://paws-r-sdk.com/docs/list_identity_providers/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#' Lists the resource servers for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/list_resource_servers/](https://paws-r-sdk.com/docs/list_resource_servers/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
...
#' Lists the user import jobs.
#'
#' See [https://paws-r-sdk.com/docs/list_user_import_jobs/](https://paws-r-sdk.com/docs/list_user_import_jobs/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool that the users are being imported
#' into.
...
#' Lists the clients that have been created for the specified user pool.
#'
#' See [https://paws-r-sdk.com/docs/list_user_pool_clients/](https://paws-r-sdk.com/docs/list_user_pool_clients/) for full documentation.
#'
...
#' Lists the user pools associated with an Amazon Web Services account.
#'
#' See [https://paws-r-sdk.com/docs/list_user_pools/](https://paws-r-sdk.com/docs/list_user_pools/) for full documentation.
#'
#' @param NextToken An identifier that was returned from the previous call to this
#' operation, which can be used to return the next set of items in the
#' list.
...
#' Lists the users in the specified group.
#'
#' See [https://paws-r-sdk.com/docs/list_users_in_group/](https://paws-r-sdk.com/docs/list_users_in_group/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
#' @param GroupName &#91;required&#93; The name of the group.
...
#'
#' See [https://paws-r-sdk.com/docs/resend_confirmation_code/](https://paws-r-sdk.com/docs/resend_confirmation_code/) for full documentation.
#'
#' @param ClientId &#91;required&#93; The ID of the client associated with the user pool.
#' @param SecretHash A keyed-hash message authentication code (HMAC) calculated using the
#' secret key of a user pool client and username plus the client ID in the
...
#' Responds to the authentication challenge.
#'
#' See [https://paws-r-sdk.com/docs/respond_to_auth_challenge/](https://paws-r-sdk.com/docs/respond_to_auth_challenge/) for full documentation.
#'
#' @param ClientId &#91;required&#93; The app client ID.
#' @param ChallengeName &#91;required&#93; The challenge name. For more information, see
...
#'
#' See [https://paws-r-sdk.com/docs/revoke_token/](https://paws-r-sdk.com/docs/revoke_token/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/set_risk_configuration/](https://paws-r-sdk.com/docs/set_risk_configuration/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#'
#' See [https://paws-r-sdk.com/docs/set_ui_customization/](https://paws-r-sdk.com/docs/set_ui_customization/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
#' @param ClientId The client ID for the client app.
...
#'
#' See [https://paws-r-sdk.com/docs/set_user_mfa_preference/](https://paws-r-sdk.com/docs/set_user_mfa_preference/) for full documentation.
#'
...
#' Sets the user pool multi-factor authentication (MFA) configuration.
#'
#' See [https://paws-r-sdk.com/docs/set_user_pool_mfa_config/](https://paws-r-sdk.com/docs/set_user_pool_mfa_config/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
...
#'
#' See [https://paws-r-sdk.com/docs/set_user_settings/](https://paws-r-sdk.com/docs/set_user_settings/) for full documentation.
#'
#' @param AccessToken &#91;required&#93; A valid access token that Amazon Cognito issued to the user whose user
...
#'
#' See [https://paws-r-sdk.com/docs/sign_up/](https://paws-r-sdk.com/docs/sign_up/) for full documentation.
#'
#' @param ClientId &#91;required&#93; The ID of the client associated with the user pool.
#' @param SecretHash A keyed-hash message authentication code (HMAC) calculated using the
#' secret key of a user pool client and username plus the client ID in the
...
#' Starts the user import.
#'
#' See [https://paws-r-sdk.com/docs/start_user_import_job/](https://paws-r-sdk.com/docs/start_user_import_job/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool that the users are being imported
#' into.
#' @param JobId &#91;required&#93; The job ID for the user import job.
...
#' Stops the user import job.
#'
#' See [https://paws-r-sdk.com/docs/stop_user_import_job/](https://paws-r-sdk.com/docs/stop_user_import_job/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool that the users are being imported
#' into.
#' @param JobId &#91;required&#93; The job ID for the user import job.
...
#'
#' See [https://paws-r-sdk.com/docs/update_auth_event_feedback/](https://paws-r-sdk.com/docs/update_auth_event_feedback/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param Username &#91;required&#93; The user pool username.
...
#' Updates the device status.
#'
#' See [https://paws-r-sdk.com/docs/update_device_status/](https://paws-r-sdk.com/docs/update_device_status/) for full documentation.
#'
#' @param AccessToken &#91;required&#93; A valid access token that Amazon Cognito issued to the user whose device
...
#' Updates IdP information for a user pool.
#'
#' See [https://paws-r-sdk.com/docs/update_identity_provider/](https://paws-r-sdk.com/docs/update_identity_provider/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID.
#' @param ProviderName &#91;required&#93; The IdP name.
...
#'
#' See [https://paws-r-sdk.com/docs/update_resource_server/](https://paws-r-sdk.com/docs/update_resource_server/) for full documentation.
#'
#' @param UserPoolId &#91;required&#93; The user pool ID for the user pool.
#' @param Identifier &#91;required&#93; The identifier for the resource server.
...
#' Allows a user to update a specific attribute (one at a time).
#'
#' See [https://paws-r-sdk.com/docs/update_user_attributes/](https://paws-r-sdk.com/docs/update_user_attributes/) for full documentation.
#'
#' @param UserAttributes &#91;required&#93; An array of name-value pairs representing user attributes.
#' 
#' For custom attributes, you must prepend the `custom:` prefix to the
...
#'
#' See [https://paws-r-sdk.com/docs/update_user_pool/](https://paws-r-sdk.com/docs/update_user_pool/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_user_pool_client/](https://paws-r-sdk.com/docs/update_user_pool_client/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_user_pool_domain/](https://paws-r-sdk.com/docs/update_user_pool_domain/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/verify_software_token/](https://paws-r-sdk.com/docs/verify_software_token/) for full documentation.
#'
#' @param AccessToken A valid access token that Amazon Cognito issued to the user whose
...
#' Verifies the specified user attributes in the user pool.
#'
#' See [https://paws-r-sdk.com/docs/verify_user_attribute/](https://paws-r-sdk.com/docs/verify_user_attribute/) for full documentation.
#'
#' @param AccessToken &#91;required&#93; A valid access token that Amazon Cognito issued to the user whose user
