...
#'
#' See [https://paws-r-sdk.com/docs/create_activity/](https://paws-r-sdk.com/docs/create_activity/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/create_state_machine/](https://paws-r-sdk.com/docs/create_state_machine/) for full documentation.
#'
...
#' Deletes an activity.
#'
#' See [https://paws-r-sdk.com/docs/delete_activity/](https://paws-r-sdk.com/docs/delete_activity/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/delete_state_machine/](https://paws-r-sdk.com/docs/delete_state_machine/) for full documentation.
#'
...
#' Describes an activity.
#'
#' See [https://paws-r-sdk.com/docs/describe_activity/](https://paws-r-sdk.com/docs/describe_activity/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_execution/](https://paws-r-sdk.com/docs/describe_execution/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_map_run/](https://paws-r-sdk.com/docs/describe_map_run/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_state_machine/](https://paws-r-sdk.com/docs/describe_state_machine/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/describe_state_machine_for_execution/](https://paws-r-sdk.com/docs/describe_state_machine_for_execution/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_activity_task/](https://paws-r-sdk.com/docs/get_activity_task/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/get_execution_history/](https://paws-r-sdk.com/docs/get_execution_history/) for full documentation.
#'
...
#' Lists the existing activities.
#'
#' See [https://paws-r-sdk.com/docs/list_activities/](https://paws-r-sdk.com/docs/list_activities/) for full documentation.
#'
#' @param maxResults The maximum number of results that are returned per call. You can use
#' `nextToken` to obtain further pages of results. The default is 100 and
#' the maximum allowed page size is 1000. A value of 0 uses the default.
...
#'
#' See [https://paws-r-sdk.com/docs/list_executions/](https://paws-r-sdk.com/docs/list_executions/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/list_map_runs/](https://paws-r-sdk.com/docs/list_map_runs/) for full documentation.
#'
...
#' Lists the existing state machines.
#'
#' See [https://paws-r-sdk.com/docs/list_state_machines/](https://paws-r-sdk.com/docs/list_state_machines/) for full documentation.
#'
#' @param maxResults The maximum number of results that are returned per call. You can use
#' `nextToken` to obtain further pages of results. The default is 100 and
#' the maximum allowed page size is 1000. A value of 0 uses the default.
...
#'
#' See [https://paws-r-sdk.com/docs/send_task_failure/](https://paws-r-sdk.com/docs/send_task_failure/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/send_task_heartbeat/](https://paws-r-sdk.com/docs/send_task_heartbeat/) for full documentation.
#'
#' @param taskToken &#91;required&#93; The token that represents this task. Task tokens are generated by Step
#' Functions when tasks are assigned to a worker, or in the [context
#' object](https://docs.aws.amazon.com/step-functions/latest/dg/input-output-contextobject.html)
...
#'
#' See [https://paws-r-sdk.com/docs/send_task_success/](https://paws-r-sdk.com/docs/send_task_success/) for full documentation.
#'
#' @param taskToken &#91;required&#93; The token that represents this task. Task tokens are generated by Step
#' Functions when tasks are assigned to a worker, or in the [context
#' object](https://docs.aws.amazon.com/step-functions/latest/dg/input-output-contextobject.html)
...
#'
#' See [https://paws-r-sdk.com/docs/start_execution/](https://paws-r-sdk.com/docs/start_execution/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/start_sync_execution/](https://paws-r-sdk.com/docs/start_sync_execution/) for full documentation.
#'
#' @param stateMachineArn &#91;required&#93; The Amazon Resource Name (ARN) of the state machine to execute.
...
#' Stops an execution.
#'
#' See [https://paws-r-sdk.com/docs/stop_execution/](https://paws-r-sdk.com/docs/stop_execution/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_map_run/](https://paws-r-sdk.com/docs/update_map_run/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/update_state_machine/](https://paws-r-sdk.com/docs/update_state_machine/) for full documentation.
#'
