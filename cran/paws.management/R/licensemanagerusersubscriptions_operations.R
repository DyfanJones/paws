...
#'
#' See [https://paws-r-sdk.com/docs/associate_user/](https://paws-r-sdk.com/docs/associate_user/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/deregister_identity_provider/](https://paws-r-sdk.com/docs/deregister_identity_provider/) for full documentation.
#'
...
#'
#' See [https://paws-r-sdk.com/docs/disassociate_user/](https://paws-r-sdk.com/docs/disassociate_user/) for full documentation.
#'
#' @param Domain The domain name of the user.
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
#' @param InstanceId &#91;required&#93; The ID of the EC2 instance, which provides user-based subscriptions.
...
#'
#' See [https://paws-r-sdk.com/docs/list_product_subscriptions/](https://paws-r-sdk.com/docs/list_product_subscriptions/) for full documentation.
#'
#' @param Filters An array of structures that you can use to filter the results to those
#' that match one or more sets of key-value pairs that you specify.
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
...
#' Lists user associations for an identity provider.
#'
#' See [https://paws-r-sdk.com/docs/list_user_associations/](https://paws-r-sdk.com/docs/list_user_associations/) for full documentation.
#'
#' @param Filters An array of structures that you can use to filter the results to those
#' that match one or more sets of key-value pairs that you specify.
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
...
#' Registers an identity provider for user-based subscriptions.
#'
#' See [https://paws-r-sdk.com/docs/register_identity_provider/](https://paws-r-sdk.com/docs/register_identity_provider/) for full documentation.
#'
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
#' @param Product &#91;required&#93; The name of the user-based subscription product.
...
#'
#' See [https://paws-r-sdk.com/docs/start_product_subscription/](https://paws-r-sdk.com/docs/start_product_subscription/) for full documentation.
#'
#' @param Domain The domain name of the user.
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
#' @param Product &#91;required&#93; The name of the user-based subscription product.
...
#'
#' See [https://paws-r-sdk.com/docs/stop_product_subscription/](https://paws-r-sdk.com/docs/stop_product_subscription/) for full documentation.
#'
#' @param Domain The domain name of the user.
#' @param IdentityProvider &#91;required&#93; An object that specifies details for the identity provider.
#' @param Product &#91;required&#93; The name of the user-based subscription product.
...
#'
#' See [https://paws-r-sdk.com/docs/update_identity_provider_settings/](https://paws-r-sdk.com/docs/update_identity_provider_settings/) for full documentation.
#'
