...
#'     use the
#'     [`delete_global_replication_group`][elasticache_delete_global_replication_group]
...
#' operation which tests automatic failover on a specified node group
...
#'     to 15 shards (called node groups in the ElastiCache API and
